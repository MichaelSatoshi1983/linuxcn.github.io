...
pubDatetime: 2018-01-21 19:34:07
description: "配置远程主机上的file_repl bash别名，通过ssh登录后正常使用。但别名在ssh环境下执行失败。"
tags: ["ssh", "别名"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201801/21/193337r4ufopgmuf6oomk6.png)
...
[![Running bash aliases over ssh based session when using Unix or Linux ssh cli](https://linuxcn.img.undefined.today/data/attachment/album/201801/21/193409r4mfvaqbgv9q4xww.jpg)](https://www.cyberciti.biz/media/new/faq/2017/12/Bash-shell-aliase-not-found-when-run-over-ssh-on-linux-unix.jpg)
