...
pubDatetime: 2022-02-01 00:56:58
description: "利用这五个工具，快速追踪并解决用户IT问题根源，简化运维挑战。"
tags: ["排错", "系统管理"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005623l3v5lm73vzv755nn.jpg "Wratchet set tools")
...
![用 Telnet 获得网络服务器的响应](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005659e4u0xdx0ukeme6k7.png "Getting a response from a webserver with Telnet")
...
![用 tcpdump 实时检查数据包](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005700ym5z1z10f5q9dl51.png "Inspecting packets in real time with tcpdump")


这张截图显示了在现实世界中使用 Wireshark 查看 iSCSI 协议的情况；在这种情况下，我能够确定我们的 QNAP 网络附加存储的配置方式有问题。


![使用 Wireshark 检查 TCP 会话](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005700mzr8m59c082j2t96.png "Using Wireshark to inspect a TCP session")
...
![find 命令输出](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005701y973jmt6jg6g6t96.png "find command output")
...
![查找命令输出](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005701t2sptl2ksbb2at8p.png "find command output")
...
![grep 命令输出](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005701cvwhw9vd9v88xkxx.png "grep command output")
...
![grep 命令输出](https://linuxcn.img.undefined.today/data/attachment/album/202202/01/005702qt54z1uz8u1p66n8.png "grep command output")
