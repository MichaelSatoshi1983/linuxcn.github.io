...
pubDatetime: 2019-03-12 10:42:00
description: "通过统一的跨平台shell（如Bash或zsh），简化多平台环境下的脚本与语法使用，轻松在Windows等系统上部署，享受高效、一致的开发体验。"
tags: ["zsh", "shell"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201903/12/104236yuzuuurhp8zr1h13.jpg)


运行跨平台 shell（例如 Bash 或 zsh）的最大优势在于你能在多平台上使用同样的语法和脚本。在 Windows 上设置（替换）shell 挺麻烦的，但所获得的回报远远超出这小小的付出。


![zsh shell inside Emacs on Windows](https://linuxcn.img.undefined.today/data/attachment/album/201903/12/104246ofgp099aw0f06z1p.png)
