...
![](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133531wcs1iy4luihr3beg.jpg)
...
![GPG 加密](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133645b1i73az322l66l57.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133646o30ren9lnfnn6jyn.png)
...
![生成 GPG 密钥](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133646o4vmvoddrpo4mm4b.png)
...
![列出 GPG 密钥](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133646hkm9czc4wl3l19zk.png)
...
![文本文件样本](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133647pd2yesr9y9kdqynm.png)
...
![用 GPG 加密文件](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133647gsnxq3nsgnsq3s3y.png)


如果你尝试阅读该文件，你会看到它看起来像乱码。这是预料之中的，因为该文件现在已经被加密了。


![读取加密文件会产生乱码](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133647tjsiiijpfwpujiz1.png)


现在让我们删除未加密的 `message.txt` 文件，这样你就可以看到 `message.txt.gpg` 文件实际上在没有原始文件的情况下也能正常解密。


![](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133647rjkcbjc5byj79cky.png)
...
![用GPG解密文件](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133647z7tv3726ko9to9oq.png)
...
![导出 GPG 公钥](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133648q99nhi98a9ib8c91.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133648g7dubcrr3yfcocmu.png)
...
![GPG 编辑密钥](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133648vt6ucccq3tjdceuv.png)


接下来，使用 `—fpr` 参数，它将显示密钥的指纹。这个命令的输出应该与你自己机器上的输出进行验证，这可以通过在你的系统上运行同样的 `--edit-key` 参数来找到。


![GPG 密钥的指纹](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133648bxss6p16zbssppg6.png)


如果一切吻合，只需使用 `—sign` 参数，一切就可以开始了。


![签署 GPG 密钥](https://linuxcn.static.byte.beer/data/attachment/album/202112/15/133649hi1pv42s2iv2avsj.png)
