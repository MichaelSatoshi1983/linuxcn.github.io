...
pubDatetime: 2019-11-17 07:05:00
description: "便捷图形界面使得软件安装及日常管理操作简单直观，提升用户体验效率。"
tags: ["用户"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232237po6ntnrnj40jjtk4.jpg)
...
![Fedora Anaconda Installer - Add a user](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232336uau0bmaggjngbmne.png "Fedora Anaconda Installer - Add a user")


在用户创建页面上，输入用户的详细信息：全名、用户名和密码。你还可以选择是否使用户成为管理员。


![Create a user during installation](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232349lry0z80y1y4zqna1.png "Create a user during installation")


点击“高级”按钮打开“高级用户配置”页面。如果需要除默认设置以外的其他设置，那么可以在此处指定主目录的路径以及用户和组 ID。你也可以输入用户所属的其他组。


![Advanced user configuration](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232412kq2ypbygqzytsstq.png "Advanced user configuration")
...
![GNOME user settings](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232418ygjm2x1hxh3h318h.png "GNOME user settings")
...
![GNOME settings - add user](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232429v23c019992vvn0nz.png "GNOME settings - add user")
...
![GNOME new user](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232445b49wfffvooffdo79.png "GNOME new user")
...
![KDE settings - add user](https://linuxcn.img.undefined.today/data/attachment/album/201911/16/232521vg5vv551nqvqcg5c.png "KDE settings - add user")
