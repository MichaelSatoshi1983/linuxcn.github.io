...
pubDatetime: 2015-08-04 22:31:37
description: "逻辑分区管理（LVM）是Linux磁盘管理利器，实现存储池设置与动态分区创建，提供统一抽象层管理磁盘与分区，简化存储资源操作与扩展，适用于多个主流Linux发行版。"
tags: ["LVM"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223138ibttfw8bplbftv23.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223138ozb08du22221e1ii.png)


选择你想用的主磁盘，最典型的是使用你最大的磁盘，接着进入下一步。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223139ljcdtj17us1cz70m.png)


你马上会将改变写入磁盘所以确保此时你选择的是正确的磁盘接着才写入设置。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223139q6gl8ga47algaatb.png)


选择第一个逻辑卷的大小并继续。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223140pxbiemo8krnox8or.png)


确认你的磁盘分区并继续安装。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223141dbv55dbzxfvf59mm.png)


最后一步将GRUB的bootloader写到磁盘中。重点注意的是GRUB不能作为一个LVM分区因为计算机BIOS不能直接从逻辑卷中读取数据。Ubuntu将自动创建一个255MB的ext2分区用于bootloder。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223141kz18z93nh4l75918.png)


安装完成之后。重启电脑并如往常一样进入Ubuntu。使用这种方式安装之后应该就感受不到LVM和传统磁盘管理之间的区别了。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/04/223141m39ok9q9qmqsq9dd.png)
