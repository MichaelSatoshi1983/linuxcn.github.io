...
pubDatetime: 2015-09-26 08:54:23
description: "QGit是Qt+C++编写的开源Git图形客户端，提供直观界面，简化版本管理。功能覆盖版本浏览、对比、历史追踪与文件补丁操作。内置命令生成器，支持自定义操作。适用于Ubuntu 14.04 LTS系统环境。"
tags: ["git", "qgit"]
---
...
![QGit Viewer](https://linuxcn.img.undefined.today/data/attachment/album/201509/26/085428iwnwsshipuluu6us.png)
