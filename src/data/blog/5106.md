...
pubDatetime: 2015-03-24 10:52:00
description: "发现一款python编写的linux AP信号强度检测工具wifi-linux，实验效果佳，期待作者添加单元测试以解决命令plot在部分电脑上无法使用的问题。该工具能收集周围AP的RSSI信息并绘制RSSI活动图。"
tags: ["wifi"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201503/22/125525r0zi9g0cipsaxicb.png)
...
![wifi-linux to monitor wifi signal strength](https://linuxcn.img.undefined.today/data/attachment/album/201503/22/125530lwrvv6vw0e9ez01j.png)


命令**bp**用于像下面那样添加一个断点。


![the bp command in wifi-linux](https://linuxcn.img.undefined.today/data/attachment/album/201503/22/125540ls3y4wop84x43l1u.png)


命令**print**可以用于在终端上显示你机器的状态。下面就是一个例子。


![the print command](https://linuxcn.img.undefined.today/data/attachment/album/201503/22/125543uzb40h41fw42hjw7.png)
