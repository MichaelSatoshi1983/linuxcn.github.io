...
![](https://linuxcn.static.byte.beer/data/attachment/album/201503/22/125525r0zi9g0cipsaxicb.png)
...
![wifi-linux to monitor wifi signal strength](https://linuxcn.static.byte.beer/data/attachment/album/201503/22/125530lwrvv6vw0e9ez01j.png)


命令**bp**用于像下面那样添加一个断点。


![the bp command in wifi-linux](https://linuxcn.static.byte.beer/data/attachment/album/201503/22/125540ls3y4wop84x43l1u.png)


命令**print**可以用于在终端上显示你机器的状态。下面就是一个例子。


![the print command](https://linuxcn.static.byte.beer/data/attachment/album/201503/22/125543uzb40h41fw42hjw7.png)
