...
pubDatetime: 2014-08-25 09:20:59
description: "badblocks扫描硬盘与外部设备，找出并标记损坏扇区，生成文件以便后续e2fsck修复，确保数据安全。"
tags: ["badblocks", "硬盘", "扇区"]
---

**badblocks**是linux及其类似的操作系统中，扫描检查硬盘和外部设备损坏扇区的命令工具。损坏的扇区或者损坏的区块是硬盘中因为永久损坏或者是操作系统不能读取的空间。


![](https://linuxcn.img.undefined.today/data/attachment/album/201408/25/091940ulcoy5ny0t4ve4yz.jpg)
