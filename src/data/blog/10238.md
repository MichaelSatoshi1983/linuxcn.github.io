...
pubDatetime: 2018-11-16 22:15:53
description: "Calcurse 创新软件，整合日历与待办事项，高效管理个人时间与任务。"
tags: ["日历", "行事历"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221558u8pfoqt65tf5iolo.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221601lui77meiu769u8um.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221603sdrlglhwfzhc5bfn.png)


一天的预约看起来像这样：


![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221607jtmpm7x3f6xcfe75.png)


待办事项列表独立运作。选中待办面板并（再次）按下 `a`。输入任务的描述，然后设置优先级（1 表示最高，9 表示最低）。Calcurse 会在待办事项面板中列出未完成的任务。


![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221609yieaekmzhez4mrfh.png)


如果你的任务有很长的描述，那么 Calcurse 会截断它。你可以使用键盘上的向上或向下箭头键浏览任务，然后按下 `v` 查看描述。


![](https://linuxcn.img.undefined.today/data/attachment/album/201811/16/221610r54qakqquqfdo4v5.png)
