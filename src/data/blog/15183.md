...
![](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104215te6xpq2e2vvxprjs.jpg "Person programming on a laptop on a building")
...
![VirtualBox New VM](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104336yvl6az48k1avzrk4.png "VirtualBox New VM")


接下来，配置客体操作系统允许使用多少内存：


![Set VM memory size](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104336tkb66990m9o94ebc.png "Set VM memory size")
...
![Create virtual hard disk](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104337royye5r4e7nw65yw.png "Create virtual hard disk")


虚拟磁盘的格式选择默认的选项 “VDI（VirtualBox 磁盘镜像）” 就可以了：


![Selecting hard disk file type](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104337ohzsh9as93zsxqlx.png "Selecting hard disk file type")
...
![Dynamically allocating hard disk](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104338wbq8mr4ocqqqlbb5.png "Dynamically allocating hard disk")
...
![Setting hard disk size](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104338bms2azh5efa0kh0z.png "Setting hard disk size")
...
![Assigning cores to guest system](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104338czsasuu8fjfjjjaj.png "Assigning cores to guest system")
...
![Network settings](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104339seme990ero5wjc55.png "Network settings")
...
![Assigning OS image](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104340kcbooc2cofjicmrf.png "Assigning OS image")
...
![VirtualBox Fedora installer](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104341deieys6c5i5sqs1g.png "VirtualBox Fedora installer")
...
![Selecting Custom partition configuration](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104342dpppm0prnxnjnnrb.png "Selecting Custom partition configuration")
...
![Adding mount points](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104342cf5lkghd7effl71z.png "Adding mount points")
...
![Selecting Guest Additions CD image](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104342scdlwctftfwq77fa.png "Selecting Guest Additions CD image")


在大多数 Linux 发行版上，带有增强功能的 CD 镜像会自动挂载，并且能够在文件管理器中找到。Fedora 会问你是否要运行安装脚本。单击“<ruby> 运行 <rt>  Run </rt></ruby>”，并授予该安装进程 root 权限：


![Enabling Guest Additions autorun](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104343yxpywypuju5cewx3.png "Enabling Guest Additions autorun")
...
![Fedora hard disk running out of space](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104344a42trk568n4att6v.png "Fedora hard disk running out of space")
...
![Free space before adding](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104345zm148cae1bvz8448.png "Free space before adding")


现在，创建一个新的分区。选择你要使用的可用空间的大小：


![Creating a new partition and setting size](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104345b9h8mylhym8jgnnn.png "Creating a new partition and setting size")


如果你不想在新分区上创建文件系统或任何其他内容，请选择“<ruby> 其他 <rt>  Other </rt></ruby>”：


![Selecting "other" for partition volume type](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104345nld3i66gylizy8lv.png "Selecting \"other\" for partition volume type")


选择“<ruby> 无文件系统 <rt>  No Filesystem </rt></ruby>”：


![Setting "No filesystem" on new partition](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104346stb7etvqnwe5rqbq.png "Setting \"No filesystem\" on new partition")


现在，磁盘空间应该如下图所示：


![VirtualBox after adding new partition](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104346zu2wfqpzfupqlfwb.png "VirtualBox after adding new partition")


虚拟机有了一个新的分区设备：`/dev/sda3`。通过输入 `vgscan` ，来检查你的 LVM 卷组，找到 `fedora_localhost_live` 这一 LVM 卷组 ：


![Checking LVM volume group by typing vgscan:](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104347cug8umvvu88zkge8.png "Checking LVM volume group by typing vgscan:")
...
![vgextend command output](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104347pf2og1zfpe1voxvt.png "vgextend command output")


由于卷组比逻辑卷大，你可以增加逻辑卷的大小。命令 `vgdisplay` 显示了共有 951 个可用的物理扩展（PE）：


![vgdisplay command output](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104348bi42r2wiiwvwuvfv.png "vgdisplay command output")
...
![lvextend command output](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104348twf4nwnpydw4zyll.png "lvextend command output")
...
![resize2fs command output](https://linuxcn.static.byte.beer/data/attachment/album/202210/27/104349vj089s8jb11giaiy.png "resize2fs command output")
