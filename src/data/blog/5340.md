...
pubDatetime: 2015-04-27 14:16:11
description: "Picty：免费、强大照片管理工具，元数据管理、图像无损处理，支持在线/离线收藏，本地文件夹存储，数据库加速查询，网页浏览器上传分享，多收藏集、用户权限灵活，简易界面便于操作。"
tags: ["Picty", "图片管理"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201504/27/141615z9ch5kddkefuto8d.png)
...
![picty_001](https://linuxcn.img.undefined.today/data/attachment/album/201504/27/141617yz92390tr2zmggms.png)


你可以选择已存在的收藏集、设备或目录。这里让我们创建一个**新收藏集** ，请先点击新收藏集（New Collection）按钮。进入收藏集，然后浏览到你保存图片的地方。最后，点击**创建（Create）**按钮。


![Create a Collection_001](https://linuxcn.img.undefined.today/data/attachment/album/201504/27/141618whbnn6e606q9v20h.png)


![picty_002](https://linuxcn.img.undefined.today/data/attachment/album/201504/27/141631ctqqtqo3dqmii3aa.png)
