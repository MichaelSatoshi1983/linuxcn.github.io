...
pubDatetime: 2014-03-14 13:44:00
description: "使用Linux系统，cp命令简便高效地实现文件与目录备份与复制，满足基本指令需求。"
tags: ["Linux", "命令", "cp", "文件", "拷贝", "教程"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134411r8in1vzsuppvz1wd.png)
...
![Copy without options](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134414fiaifrwr4flalre4.png)
...
![Copying multiple files](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134415md7h9gpspp7s57j8.png)
...
![Copy directory](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134416fouc0zol27d9t2cp.png)


需要注意的一件事，你需要**移除在目录名尾部的斜杠**。否则你会收到类似的错误信息**cp: omitting directory‘directory\_1/**’


![Copy directory error](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134418w2jv15zcrlr8ylr5.png)
...
![Copy hardlinks](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134419j7czcuuzccudlqc4.png)
...
![Inode number of original directory](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134420gcacjiohnoo6vlco.png)


*原文件 file\_5.txt 的 inode 值是 279231*


![Original inode number of file](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134421s3uyd2avtdtnn5tu.png)


*对 directory\_1 执行 cp 命令*


![Copy using -rl options](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134422i2whiwjo77m2jwm2.png)


*拷贝的 directory\_1副本的 inode 值是 274800*


![Inode number of copied directory](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134423eciyssioumejxicu.png)


*拷贝的 file\_5.txt副本的 inode 值是 279231。跟它的原文件一样*


![Inode number of copied file](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134424f2dojxncj090s0l2.png)
...
![Symbolic links](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134426jleo1t1qilcir9co.png)
...
![Copy using -P option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134427vj45yokyzpomouml.png)
...
![Copy using -L option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134429if2uljlmfhiu22hv.png)
...
![Copy using -a option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134431ci32ucq23jq7xuuk.png)
...
![Verbose option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134432exttmzqqtuj3suuj.png)
...
![Copy only if newer](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134434kevx0xjxzxghvhvj.png)
...
![Interactive mode](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134435aehpen99bb2h9n2t.png)
...
![Backup option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134437v8in6agvggvj5g5a.png)
...
![Copy attributes only](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134438ogs0axr0dmm3mmrs.png)
...
![Copy with force](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134439t0vfjz7f6d6rdz6n.png)
...
![Remove destination option](https://linuxcn.img.undefined.today/data/attachment/album/201403/14/134441l48hle33tf1f4z26.png)
