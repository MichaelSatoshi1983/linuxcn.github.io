...
pubDatetime: 2015-07-15 07:59:00
description: "遇到tar命令执行失败报错Exiting with failure status due to previous errors时，通常是权限问题导致无法读取目标文件。需检查文件读权限，确保执行tar命令的当前用户对此文件具有读取权限。使用-t参数测试文件压缩，进一步诊断问题。"
tags: ["tar"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/14/220027rbdrgnd2oyzbtxz8.jpg)
