...
description: "SLAY，Chris Ausbrooks制作的命令行工具，高效安全地终结指定用户所有进程，协助系统管理员排查异常行为。适用于Ubuntu、Arch Linux、Fedora等发行版，通过官方仓库轻松安装。需管理员权限执行，命令格式：sudo slay username，简便完成指定用户进程管理。"
tags: ["slay", "kill"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201503/22/123309z6mg9gtcsq9a9e6a.png)
