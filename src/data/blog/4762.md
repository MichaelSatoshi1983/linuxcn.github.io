...
pubDatetime: 2015-01-27 20:51:27
description: "作为网络管理员，你需要处理libpcap格式（pcap）的捕包文件，用于离线分析与入侵测试。掌握工具如Editcap与Mergecap与Wireshark，能高效处理、注入与分析pcap文件数据。"
tags: ["pcap", "libpcap", "Wireshark"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/205133e4ljijo38locijc2.jpg)
