...
pubDatetime: 2018-03-18 00:10:00
description: "使用R项目&RStudio IDE高效分析数据，提供强大统计工具与直观界面。"
tags: ["统计", "RStudio"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001053d33ctww9o8o3bw9c.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001054dmz20iaz3sbbsv5m.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001054d50vqz1dqd4mfc1f.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001055dtqtuwtauuuqwppu.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001055rqpvppdjv5qqrvlh.png)


我从摘要统计信息中知道航空乘客样本的均值为 280.3。在命令行中输入 `sd(AirPassengers)` 会得到标准偏差，在 RStudio 控制台中可以看到：


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001056hww8g0ap0q88p0q5.png)


接下来，我生成了一个数据直方图，通过输入 `hist(AirPassengers);` 得到，这会以图形的方式显示此数据集；RStudio 可以将数据导出为 PNG、PDF、JPEG、TIFF、SVG、EPS 或 BMP。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001056eakyyhzy111k15of.png)


除了生成统计数据和图形数据外，R 还记录了我所有的历史操作。这使得我能够返回先前的操作，并且我可以保存此历史记录以供将来参考。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001057sodfy3rcf3vhny7v.png)


在 RStudio 的脚本编辑器中，我可以编写我发出的所有命令的脚本，然后保存该脚本以便在我的数据更改后能再次运行，或者想重新访问它。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/18/001057evy2y4zv3x343ivo.png)
