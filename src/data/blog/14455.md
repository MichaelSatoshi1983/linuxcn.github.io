...
pubDatetime: 2022-04-10 17:05:43
description: "Firefox最新版优化针对桌面Linux用户，显著提升性能与用户体验。"
tags: ["Firefox"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202204/10/170543osozbtvwuticusaj.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202204/10/170544nnl00tt7qjijijad.png)


但在稳定版中这个特性默认没有启用。开启这个特性，转到 `about:config`，搜索 `widget.gtk.overlay-scrollbars.enabled`。这个值默认是 `false`，双击它将设置为 `true`，这将启用新的滚动条。


![](https://linuxcn.img.undefined.today/data/attachment/album/202204/10/170545aav8qb22nzq1pxka.png)
