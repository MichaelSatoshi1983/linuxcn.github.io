...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/10/170543osozbtvwuticusaj.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/10/170544nnl00tt7qjijijad.png)


但在稳定版中这个特性默认没有启用。开启这个特性，转到 `about:config`，搜索 `widget.gtk.overlay-scrollbars.enabled`。这个值默认是 `false`，双击它将设置为 `true`，这将启用新的滚动条。


![](https://linuxcn.static.byte.beer/data/attachment/album/202204/10/170545aav8qb22nzq1pxka.png)
