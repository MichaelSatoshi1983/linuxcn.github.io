...
![](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203136yyyc7986ys6osyo9.jpg)
...
![在 Linux Mint 中添加网页应用程序](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203217rvzl1g9bprrmkzrr.png)


例如，将 YouTube 添加为网页应用程序：


![Linux Mint 中的网页应用程序](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203218c5qxfudq5sqtdfux.png)


运行 YouTube 程序将通过你所使用的浏览器打开一个独立的页面。


![YouTube 网页应用程序](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203226wbvjb6b3vgi1ge1g.jpg)


网页应用程序拥有常规桌面应用程序有的大多数功能特点，如使用 `Alt+Tab` 切换。


![使用 Alt+Tab 切换网页应用](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203228bxy6x7b56o7m66hc.jpg)


甚至还能将应用固定到面板/任务栏方便打开。


![添加到面板的 YouTube 网页应用](https://linuxcn.static.byte.beer/data/attachment/album/202009/04/203230cmuklqmtnctkqs6r.jpg)
