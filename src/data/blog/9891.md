...
pubDatetime: 2018-08-03 00:00:28
description: "利用bash-complete-partial-path扩展Bash路径补全功能，享有Zsh的不完整路径支持，适用于Linux、macOS (gnu-sed)与Windows (MSYS)环境。无需转用Zsh，提升效率与用户体验。"
tags: ["补全", "命令行"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201808/03/000019iesyr8zs68xrqkyj.jpg)
