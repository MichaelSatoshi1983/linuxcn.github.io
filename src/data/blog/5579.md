...
pubDatetime: 2015-06-08 07:49:00
description: "运行在Docker容器中提升效率与灵活性的桌面软件，为不同平台提供通用、轻量级应用运行环境，适合部署、扩展Web应用、数据库及后端服务，支持跨平台、技术栈的统一管理，由开发、运维人员广泛使用，亦可应用于桌面环境，简化多应用协同与管理。"
tags: ["Docker", "桌面应用"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/06/095537p350tprvtidvfgq3.jpg)
