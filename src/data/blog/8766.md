...
pubDatetime: 2017-08-10 13:45:29
description: "在Linux环境下，利用强大的cp命令与rsync工具，实现高效、安全的文件备份与数据迁移，简化管理流程，保障数据安全。"
tags: ["cp"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201708/10/134421aa0ht46dtviz6dz4.jpg)
...
![Image of the new copy of Misc on the USB drive](https://linuxcn.img.undefined.today/data/attachment/album/201708/10/134531no1jwmcw8mfmw4k4.png "Image of the new copy of Misc on the USB drive")


假设我要在原始拷贝路径下 `~/Pictures/Misc` 下添加一些新文件，就像这样：


![New files added to the master directory](https://linuxcn.img.undefined.today/data/attachment/album/201708/10/134531uhe4siy48m1t4goo.png "New files added to the master directory")
