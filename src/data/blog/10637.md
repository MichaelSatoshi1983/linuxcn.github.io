...
pubDatetime: 2019-03-20 22:46:00
description: "Linux用户在寻找Google云端硬盘官方客户端时需转而使用非官方应用。众多集成解决方案提供不同功能，供用户根据需求选择。"
tags: ["Google", "云端硬盘"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/224606letwoxtwpr7z0axe.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225039njkja9g4y9k7uilc.png)


点击“连接”链接添加 Google 云端硬盘帐户。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225052e606q56992b86k81.png)


输入你要设置 Google 云端硬盘帐户的电子邮箱。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225105hjwwj40rslysgjww.png)


输入邮箱密码。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225116pic4thudc66oiu6q.png)


允许 ODrive 访问你的 Google 帐户。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225126th355hn3p5lshvhd.png)


默认情况下，它将选择文件夹位置。如果你要选择特定文件夹，则可以更改。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225144hzcozodd6ol66f33.png)


最后点击“同步”按钮开始将文件从 Google 下载到本地系统。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225200vkc8pm8bpeun7nzj.png)


同步正在进行中。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225216tgo7suo02zofo2uf.png)


同步完成后。它会显示所有已下载的文件。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225226l6od616bg757zh57.png)


我看到所有文件都下载到上述目录中。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225238xyz8er22qpya8y8h.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225252v4hfze9sh4h4f9bk.png)


将新文件添加到 Google文件夹后，它会自动开始同步。从通知菜单中也可以看到。是的，我看到一个文件已同步到 Google 中。


![](https://linuxcn.img.undefined.today/data/attachment/album/201903/20/225303ghfjhkfrvjvvzjcq.png)
