...
pubDatetime: 2014-01-27 15:12:00
description: "无需编辑fstab文件，使用GNOME Disk Utility轻松在Ubuntu下挂载磁盘分区，简化系统管理。"
tags: ["Linux", "Ubuntu", "桌面", "图形界面", "挂载", "分区"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201401/27/151129c7c6xysmscz12x6k.png)


最后，关闭自动挂载选项并手动指定你的挂载选项。磁盘会自动的将这些选项写入到 fstab 文件中，这样 mount 命令才可以读取挂载的分区。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/27/151131i9z1xtmktg7kt7m1.png)
