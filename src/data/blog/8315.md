...
pubDatetime: 2017-03-18 10:04:00
description: "只需一分钟，借助AWS平台轻松搭建专属服务器，高效便捷的云端解决方案。"
tags: ["AWS"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060857cr3nm8dzf0mq2zz2.png)
...
![Amazon AWS console](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060916wft6mhapp6azzo5l.jpg)
...
![Create an EC2 instance](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060918ooff40af8jjt4po4.png)


2、 现在在<ruby> 创建实例 <rt>  Create instance </rt></ruby>下点击<ruby> “启动实例” <rt>  Launch Instance </rt></ruby>按钮。


![Launch the EC2 instance](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060920yw06zypp8myjpyzy.png)


3、 现在，当你使用的是一个 “Free Tier” 帐号，接着最好选择 “Free Tier” 单选按钮以便 AWS 可以过滤出可以免费使用的实例。这可以让你不用为使用 AWS 的资源而付费。


![Select Free Tier instances only](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060923i4anondn8mrsn45r.png)
...
![Configure AWS server](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060925mqq339efq2ck3q2f.png)
...
![Create Key pair](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060927y4gmom44w9o2rwp8.png)
...
![Go to the running EC2 instance](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060930ekpcjqyzcaj4vc3q.png)


k、 现在你可以看到，你的新 VM 的状态是 “<ruby> 运行中 <rt>  running </rt></ruby>”。选择实例，请记下登录到服务器所需的 “<ruby> 公开 DNS 名称 <rt>  Public DNS </rt></ruby>”。


![Public DNS value of the VM](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060932fz63ap3e3zw4e9aw.png)
...
![Logged in to AWS EC2 server](https://linuxcn.img.undefined.today/data/attachment/album/201703/18/060934ly9glagz3glcy7p2.jpg)
