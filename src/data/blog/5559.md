...
![](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214841dr98puhklh96aehp.png)
...
![创建gitblit目录](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214903hf9d59es1duf4def.png)
...
![下载gitblit安装包](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214904p86fvbzhls5tpymp.png)
...
![解压gitblit压缩包](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214905epcd5i5rmpmaramm.png)
...
![启动gitblit服务](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214906m4bqllbhncq0bgli.png)


在你的浏览器中打开`http://localhost:8080`或`https://localhost:8443`，也可以将localhost根据本地配置替换为IP地址。输入默认的管理员凭证：admin / admin并点击login按钮。


![gitblit欢迎页面](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214906kk8as2t2271lmyoz.png)
...
![添加新用户](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214907z878djvte8887jxw.png)


现在，我们将创建一个开箱可用的仓库。点击 repositories > (+) new repository。然后，如下图所示添加新的仓库。


![添加新的仓库](https://linuxcn.static.byte.beer/data/attachment/album/201506/02/214908x2dqhnlwi4lirwtn.png)
