...
![](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223120m4mqoryw6r4yzpci.png)
...
![Install Freya](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223125v031nyxhznxj2jjj.png)


在进行下面的步骤之前会检查系统要求和资源有效性。如果你的系统有足够的资源，点击继续。


![Installation Requirements](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223125s96wdf9nimckcmkg.png)


安装向导提供许多安装形式。选取最适合你的选项，通常大多数都选用第一个选项：“擦除磁盘以安装elementary”。选择该选项，必须保证你的原有数据都已经正确备份了，因为磁盘（分区）擦除后，其上所有的数据就会丢失。


![Installation Types](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223126fn0n24z8in8y4yfv.png)


接下来的对话框显示了Elementary OS所使用和需要格式化的磁盘分区列表，确保数据完整后点击继续。


![Format Warning](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223126ynu7tmjb9bu6j1ez.png)


选择你的地理位置，确定时区，点击继续。


![Location](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223129ecxy8g14ss1js5f8.png)


选择你的语言，点击继续。


![Language](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223129f3xx3scs14rs1hxs.png)


填入你的信息，选择一个高强度的超级用户/管理员密码，点击继续。


![whoareyou](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223130dimvmmi8ypiy3m7y.png)


当你的信息提供后，核心安装进程就会启动，正在安装的组件的详细信息会在一个小对话框里随进度条一闪而过。


![Installation progress](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223131yio0hkreittxyfl6.png)


恭喜你！最新的Elementary OS 0.3 (Freya)已经安装完成了。此时需要重启来更新和完整注册，恭喜。


![Installation Complet](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223131hkbuyks9uuy6465k.png)


启动时，Elementary OS将显示它优雅的logo，然后会出现密码保护的管理员登入和游客访问选项。游客访问有相当多的限制功能，而且没有安装软件的权限。


![Login](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223134s1cdvzrf46l7wtwi.png)


下图是新安装的Elementary OS 0.3的画面。


![first look](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223137wyi7l4lreryf7417.png)
...
![Desktop Wallpaper](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223139uq0szs5wwixpy0wq.png)


Elementary OS真正的美丽在于优雅的泊板。桌面上没有任何图标，泊板上的应用图标显示逼真，通过它可以快速访问常用应用。


![Desktop Dock](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223140ph0y30uj4l5txm4h.png)


用户可以定制桌面的四个热角的功能。


![Hot Corners](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223141c3qnes89l9ooxdkk.png)
...
![ppa](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223142n8op9soztei6e89t.png)
...
![update repository](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223142z4kv078fh17hthzt.png)
...
![install elementary tweaks](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223143wk7wfv8hk9oxwf1o.png)


我们可以在Application > System Settings下的个人区域的看到增加了一个Tweaks项目。它现在可以给我们提供更多的个性化定制选项。


![tweaks](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223144fcqfcilstfl7elqq.png)
...
![gnome](https://linuxcn.static.byte.beer/data/attachment/album/201504/20/223144gkk94ka1g4eg3x1x.png)
