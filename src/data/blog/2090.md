...
pubDatetime: 2013-10-12 23:00:00
description: "学习如何用Python通过SSH自动连接远程机器并执行命令？掌握Python SSH模块库，实现自动化运维高效便捷，初学者需熟悉基本Python语法及网络编程原理。"
tags: ["Python", "SSH"]
---
...
第一步，我们导入所有需要的东西，并且给机器详情分配变量,就像图解1.
 ...
 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/12/162447uryy3s391bz931b9.png)
...
之后我们创建一个函数，使用pxssh创建并开始一个到ssh服务器的连接。
 ...
 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/12/162449snlyvq8ymlzkr6uq.png)
...
下一步是在两个机器间的ssh连接建立之后，创建一个函数来给机器发送命令.
 ...
 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/12/162450qettguztc4pp4h7x.png)


图解 3


 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/12/162451l672i11i3l1ihf13.png)
