...
pubDatetime: 2019-09-29 12:32:44
description: "通过一次编辑，轻松转换文本为多种格式，掌握Markdown，高效实现内容多样化呈现。"
tags: ["Markdown"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123226bjte253n2h44cjjj.jpg)
...
![Names of Markdown files](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123250xzw5vjyvz4dw3y6s.png "Names of Markdown files")
...
![Bold text in Markdown](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123301vwbz2f8wttq3bbtk.png "Bold text in Markdown")


6、对于**斜体**，将文本放在没有空格的下划线符号之间：`_我希望这个本文以斜体显示_`。（LCTT 译注：有的 Markdown 流派会将用下划线引起来的字符串视作下划线文本，而单个星号 `*` 引用起来的才视作斜体。从兼容性的角度看，使用星号比较兼容。）


![Italics text in Markdown](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123317u0ep0m0w2dmz0mlp.png "Italics text in Markdown")
...
![Hyperlinks in Markdown](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123337uuyttpuz47h6z5me.png "Hyperlinks in Markdown")


8、块引用是用大于号编写的（`>`）在你要引用的文本前加上大于符号和空格: `> 名言引用`。


![Blockquote text in Markdown](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123359h63m96mkscm1c9s9.png "Blockquote text in Markdown")
...
![Turtl application](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123406kudznzc1uni63ccn.png "Turtl application")
...
![Markdown text converted to PDF with Pandoc](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123418xeixhzl8b3yzhebf.png "Markdown text converted to PDF with Pandoc")
...
![Markdown text converted to email with Markdown Here](https://linuxcn.img.undefined.today/data/attachment/album/201909/29/123424orbu5k9b51psstp9.png "Markdown text converted to email with Markdown Here")
