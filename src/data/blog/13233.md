...
![](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232018q66pz2uc5uuq1p03.jpg "magnifying glass on computer screen")
...
![实体](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232133yn9fxn48z9nq9wd4.png "Entities")
...
![情感](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232134u49cg3zk9yp2q023.png "Sentiment")
...
![语法](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232134l5q5rjdwdszzdszj.png "Syntax")
...
![分类](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232134loa7cb69a8bnbapl.png "Categories")
...
![所有页面的点击次数柱状图](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232134obtqt33t7qwbqd7d.png "Histogram of clicks for all pages")


为了减少数据集的大小并仅获得效果最好的页面，我将数据集限制为在此期间至少获得 20 次曝光的页面。这是精炼数据集的按页点击的柱状图，其中包括 723 个页面：


![部分网页的点击次数柱状图](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232135xtqtlen7s7ydstoo.png "Histogram of clicks for subset of pages")
...
![services.json 文件](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232135eszdngayasad36cs.png "services.json file")
...
![拉取 API 数据的输出](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232135i2ne05ob5fe5feje.png "Output from pulling API data")
...
![来自示例站点的分类数据](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232136g27pgut772zk27z9.png "Categories data from example site")
...
![平均置信度排名分布图](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232136ic4s5ou4cgsycisu.png "Plot of average confidence by ranking position ")
...
![独特页面的情感柱状图](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232136wzorqo9d9ooypmo3.png "Histogram of sentiment for unique pages")
...
![示例网站的顶级实体](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232136d1ppkvn8vfkpdqqa.png "Top entities for example site")
...
![显著性与最佳排名位置的相关性](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232137bz34u2478b6b7ctz.png "Correlation between salience and best ranking position")
...
![基于实体名称和实体类型的主题](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232137fpa2olp874ohavha.png "Themes based on entity name and entity type")
...
![Google 搜索结果](https://linuxcn.static.byte.beer/data/attachment/album/202103/24/232137zhh0mh1d3y11dh5l.png "Google search results")
