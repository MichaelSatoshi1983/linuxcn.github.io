...
pubDatetime: 2018-03-31 00:33:56
description: "chkservice 是一个基于 ncurses 的终端工具，用于管理和视图 systemd 单元，提供便捷的服务修改体验。"
tags: ["systemd"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003351jc30ce9665zrcv2v.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003359yuaib5ak8jubxu55.png)


要查看帮助页面，按下 `?`。 这将向您显示管理 systemd 服务的可用选项。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003401u9mo6mbb9xfmbowf.png)


选择要启用或禁用的守护进程，然后点击空格键。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003401b3tz971s9g3gzyfh.png)


选择你想开始或停止的守护进程，然后按下 `s`。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003402hly4sz4jkrv8mljf.png)


选择要重新启动的守护进程，然后按下 `r`，之后，您可以在顶部看到更新的提示。


![](https://linuxcn.img.undefined.today/data/attachment/album/201803/31/003403pw1r4pwgunpcfrrf.png)
