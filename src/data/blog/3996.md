...
pubDatetime: 2014-10-12 10:46:00
description: "使用systemd timers实现自动备份。问题解决后，详细记录步骤，创建简化教程，避免遍历复杂资料。建议先行熟悉systemd.service, systemd.timer, 和systemd.target。以简单脚本myscript为例，轻松自动执行备份任务。"
tags: ["systemd", "定时器", "cron"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201410/11/235019zlcvleb3xu3zmkk9.png)
