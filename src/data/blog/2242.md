...
description: "深入探讨IBM Calgary IOMMU支持（CALGARY_IOMMU），实现对xSeries x366和x460的IOMMU支持，优化32位PCI设备兼容性。"
tags: ["Linux", "内核", "配置", "IOMMU", "技巧", "教程"]
---

在这个第四部分里，我们将继续配置更多的设置和特性。


![](https://linuxcn.img.undefined.today/data/attachment/album/201311/11/212246ngkdbnzgwskn5n3b.png)
