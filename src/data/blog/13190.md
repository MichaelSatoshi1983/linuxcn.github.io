...
![](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094113q0ggsbz0a0wb9eg4.jpg "Digital images of a computer desktop")
...
![创建一个新的 VirtualBox 虚拟机](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094214y24letj7z5e2pejv.png "Create a new VirtualBox")


选择使用的虚拟机的名称、操作系统（Linux）和 Linux 类型（例如 Debian 64 位）。


![命名 VirtualBox 虚拟机](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094215vmslb2e704rv2szb.png "Naming the VirtualBox VM")


下一步，配置虚拟机内存大小，使用默认值 1024 MB。接下来选择 “<ruby> 动态分配 <rt>  dynamically allocated </rt></ruby>”虚拟磁盘并在虚拟机中添加 `Moodle.iso` 镜像。


![添加 Moodle.iso 到虚拟机](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094215yiqlhvasg36ughux.png "Attaching Moodle.iso to VM")
...
![Moodle 应用配置](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094216n24gr0izprzduvr0.png "Moodle appliance settings")
...
![Moodle 登录界面](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094216ahapfa6xapg6fgln.png "Moodle login screen")


首次登录后，你将看到初始的 Moodle 网站的主仪表盘。


![Moodle 管理员仪表盘](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094216tp77mfocofy755fm.png "Moodle admin dashboard")
...
![Moodle 设置](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094217clyo11b1bubvby5f.png "Moodle settings")


你可以根据需要更改站点名称，并添加简短名称和站点描述。


![Moodle 网站名](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094217o1mmmpem3mfwww4i.png "Name Moodle site")


确保滚动到底部并保存更改。现在，你的网站已定制好。


![Moodle 保存更改](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094217a5v14fw888ofjvsh.png "Moodle changes saved")
...
![在 Moodle 中添加类别选项](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094217y5m005km05m8bka0.png "Add category option in Moodle")
...
![在 Moodle 中添加课程选项](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094218hgm2b4bgp7m2mb84.png "Add course option in Moodle")
...
![Moodle 课程列表](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094218ldbydbzxbpmyppmr.png "Moodle course list")
...
![在 Moodle 中添加活动](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094218w83d4ass0zk1s191.png "Add activity in Moodle")


我会看到一个弹出窗口，其中包含可以分配给我的学生的各种活动。


![Moodle 活动菜单](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094218y2z0vz7w7vxecdxc.png "Moodle activities menu")


Moodle 的工具和活动使我可以轻松地创建学习材料，并以一个简短的测验来结束一周的学习。


![Moodle 活动清单](https://linuxcn.static.byte.beer/data/attachment/album/202103/10/094219hpt724t0bbm47qfm.png "Moodle activities checklist")
