...
pubDatetime: 2015-09-01 08:42:00
description: "启用Ubuntu安装器中的LVM复选框，可轻松实现硬盘分区调整与快照创建。LVM技术类似于RAID或Windows存储空间，适合服务器和桌面使用。在新安装Ubuntu时采用LVM，实现实用功能简便操作，仅需点击即可，功能强大，适合追求灵活存储管理的用户。"
tags: ["LVM"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234513ykldvzvlrsftadk6.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234514p44yra3goor1lrm4.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234514ybbhcrx7tylp77lp.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234515x0o35f053ro1dr0o.png)


卷组视图会列出你所有的物理卷和逻辑卷的总览。这里，我们有两个横跨两个独立硬盘驱动器的物理分区，我们有一个交换分区和一个根分区，这是Ubuntu默认设置的分区图表。由于我们从另一个驱动器添加了第二个物理分区，现在那里有大量未使用空间。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234516cltmxtou08g6mr0m.png)


要扩展逻辑分区到物理空间，你可以在逻辑视图下选择它，点击编辑属性，然后修改大小来扩大分区。你也可以在这里缩小分区。


![](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/234516zlg6nd2wbg6163o1.png)
