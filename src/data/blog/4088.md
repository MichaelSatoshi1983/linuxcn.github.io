...
pubDatetime: 2014-10-26 11:35:00
description: "Linux命令行操作高效便捷，通过执行如wc命令简便计算文本文件中字与字符频次。准备文件使用$man命令输出至man.txt，简便运行$cat对文件进行分析。"
tags: ["wc", "命令行"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201410/25/223914bqytedyc7375jyev.jpg)
