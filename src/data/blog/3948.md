...
pubDatetime: 2014-10-03 12:42:00
description: "使用echo命令在Linux bash和C shell高效显示文本、变量值，简便操作：echo 文本 显示文本；echo -e '\b变量名' 显式变量内容；echo -e '\b'移除字符间空格。"
tags: ["echo", "命令"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201410/03/210844zi1h0ni0ij10tkdi.gif)
