...
pubDatetime: 2016-01-30 16:21:00
description: "在UNIX中，使用grep命令根据内容高效搜索.C、.H及.TXT文件。示例：grep 'pattern' *.ext，加入-i实现忽略大小写搜索。find命令用于目录层次搜索。"
tags: ["grep"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201601/30/142415eb8bz8oz420182x8.jpg)
...
![Fig.01: grep 命令显示搜索到的模式](https://linuxcn.img.undefined.today/data/attachment/album/201601/30/142614k0kfszpz1y1kpdyh.png)
