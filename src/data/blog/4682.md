...
pubDatetime: 2015-01-16 16:21:59
description: "Smartctl是Unix系统管理SSD/HDD的命令工具，用于打印SMART日志，自动检测错误，执行设备自检。适用于对Linux物理服务器智能磁盘进行错误检查与RAID相关信息提取。请确保已安装：Ubuntu环境下执行$sudo apt-get install smartmontools，或CentOS/RHEL下使用#yum install smartmontools。"
tags: ["smartctl", "硬盘"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/16/162204x9qqklzo66kl8j88.png)
