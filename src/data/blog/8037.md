...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165430ads2yka5a5lcyx2z.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165806sjtqx55hqh152522.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165810ymp4n22enwdalo9d.png)


这个英文句子表示成 Cypher 查询：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165815bllxxkz5e0lyflx2.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165818vsahvs9reydjsh7k.png)


考虑位于我们所研究的第一个模型之上的数据模型，现在让我们在下面的分类中找到用户的朋友喜好的航站楼里面离出入口最近的餐饮场所：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165821galadt9lallaqiul.png)


`MATCH` 子句和我们第一次 Cypher 查询的 `MATCH` 子句相似，只是现在我们依据喜好和朋友来匹配：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165828la8ai8aoa9zbf05c.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165834eplgtsi6pchxghid.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165838eouuq78bvuyt1hdu.png)


现在我们有两个向量：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165839ut226t22t09rszj5.png)


现在让我们按照<ruby> 欧几里得距离 <rp>  （ </rp> <rt>  Euclidean distance </rt> <rp>  ） </rp></ruby>的定义来计算这两个向量之间的距离：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165840b9z3oub59bgssrub.png)


我们把所有的数字带入公式中计算，然后得到下面的相似度，这就是两个用户之间的“距离”：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165841iug5l99col5bpgb1.png)


你可以很容易地在 Cypher 中计算两个特定用户的“距离”，特别是如果他们仅仅同时“喜好”一个很小的地点子集。再次说明，这儿我们依据两个用户 Alice 和 Greta 来进行匹配，并尝试去找到他们同时“喜好”的地点：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165844p0qe3mkemqv08xa0.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165848gf8w1f4cuf4m9fbf.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165850qu9qhweqkhho9qqe.png)


在这个查询中，我们依据地点和类别来进行匹配：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165853anumtugnrhhgn4tt.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165855lss9sbi9b5r34srz.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165857r7f3zi9fcjj9w37g.png)


假定用户对酒吧类评分的方式和一般的评分方式相似。然后我攫取出喜欢相同类别中的地点的用户名、类别名、“喜好”关系的平均权重，比如平均权重这些信息，从而我可以得到下面这样一个表格：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165900saw16a1a2anl5ln3.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165902n6vqnqq68pv6vg56.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165905a1iulczzc20zzve2.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165908d61pprs00ov26hys.png)


现在让我们考虑下面的查询：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165912qo90f0nofoi0wfoi.png)


通过这个 Cypher 查询，我们在更远处找到了在同一个集群中的相似用户。由于这个原因，我们删除了“距离”关系：


![](https://linuxcn.static.byte.beer/data/attachment/album/201612/14/165918mf77g2g7pqhhhmz8.png)
