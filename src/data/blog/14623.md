...
![](https://linuxcn.static.byte.beer/data/attachment/album/202205/22/115536nkfuuf4dklgg7fsx.jpg)
...
![concTCP.go TCP 服务端测试](https://linuxcn.static.byte.beer/data/attachment/album/202205/22/115539cgdpwgnnmm2g5oon.png)


类似地，下面这张图片显示了两个 TCP 客户端的输出（使用了 `nc` 工具）：


![是用 nc 工具作为 concTCP.go 的 TCP 客户端](https://linuxcn.static.byte.beer/data/attachment/album/202205/22/115539qumyxr7rmks3yrws.png)
