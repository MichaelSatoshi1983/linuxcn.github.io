...
pubDatetime: 2022-03-27 09:47:43
description: "专业指南详述双启动 Fedora Linux与Windows 10，全程配以精准截图。"
tags: ["Windows", "Fedora", "双启动"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094744eczngnxczcanshff.jpg)
...
![On the grub screen, you can select the operating system](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/202203/27/094745c3nny46lvxq8nlhk.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094745e7sn7rbhrrkjzr2h.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094746s2dzcdbcebsesdkz.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094748fglv8eaxt8ogo81a.png)


它将下载一个 exe 文件。在下载完成后，转到你所下载到的文件夹，并双击 `FedoraMediaWriter.exe` 文件来安装 “Fedora Media Writer” 工具。只需要重复点击 “<ruby> 下一步 <rt>  next </rt></ruby> 。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094749u7lhi7qlw9q7bk95.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094751pifnhb7bcgjbbqjt.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094753wpxzzf3mxwnfyw1r.jpg)


在下载 ISO 后，它会自动地对其进行检验，并给予你将 ISO 镜像写入到 USB 磁盘的选项，例如，创建临场 USB 。点击 “<ruby> 写入到磁盘 <rt>  Write to Disk </rt></ruby>” 按钮。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094754ba728zyctppc2y7y.png)


它将花费几分钟来完成安装过程。它显示 “<ruby> 完成 <rt>  Finished </rt></ruby>” 信息后，你可以关闭 “Fedora Media Writer” 工具了。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094755skslwrbl6qmcq5zz.png)
...
![Quickly press F2, F10 or F12 keys at the screen showing your system manufacturer’s logo](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094757w7ztf0etfk64sf6x.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094759wltq6y699aqm69f1.jpg)


如果一切顺利，你应该会看到像下面的一个屏幕。选择第一个选项 “<ruby> 启动 Fedora 工作站 <rt>  Start Fedora Workstation </rt></ruby>”：


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094800kinoytmcinthnjhg.jpg)


在数秒后，你应该会启动到 Fedora 临场会话期间，并会看到尝试或安装它的选项。选择 “<ruby> 安装到硬盘 <rt>  Install to Hard Drive </rt></ruby>” 。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094802kx1jx7oa88ou9xol.jpg)


它会要求选择安装过程的语言选项。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094803thq0yxnl0kqpq9ix.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094805l6itn61uimf10kwf.png)


选择磁盘，并点击“<ruby> 完成 <rt>  Done </rt></ruby>” 。现在，你应该会看到一条警告信息。在我的实例中，我没有在 “步骤 2” 中创建可用的空间，因此它会抱怨这里没有足够的可用的空间来安装 Fedora 。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094807pzaawlzw9nlnqnzp.png)


我点击 “<ruby> 回收空间 <rt>  Reclaim space </rt></ruby>” ，并缩小在这里的 Windows 分区。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094809cclill4pp2jepuup.png)


在这以后，将出现 “<ruby> 开始安装 <rt>  Begin Installation </rt></ruby>” 选项，开启安装过程。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094811qwcf3lbuct3ukpcd.png)


现在，它只是一个需要耐心等待的游戏了。将花费数分钟来提取文件并安装它们。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094812tghve1raa146vq7b.png)


当过程完成后，你将看到 “<ruby> 结束安装 <rt>  Finish Installation </rt></ruby>” 按钮，点击它。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094814wk0iaim6v0bm1az8.png)


你将回到 Fedora 临场会话期间。单击右上角的下拉菜单并选择 “<ruby> 重新启动 <rt>  Restart </rt></ruby>” 。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094817ehvv1f1e3wmo6ow3.jpg)


现在，当系统启动时，你应该会看到带有启动到 Fedora 和 Windows 选项的 [Grub 启动器](https://itsfoss.com/what-is-grub/)。


![](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/202203/27/094745c3nny46lvxq8nlhk.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094820x349pc0juhgk0cwn.png)


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094822ngt94elt609i7wo1.png)


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094824nulg510gx1ngff95.png)


在你完成后，你已经用上 Fedora Linux 了。


![](https://linuxcn.img.undefined.today/data/attachment/album/202203/27/094825xt3k4x3wc2ccqc3s.jpg)
