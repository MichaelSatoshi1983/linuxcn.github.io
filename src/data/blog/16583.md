...
![](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155635ocrk3q8dgg3rkkgh.jpg)
...
![在 Nautilus 中搜索](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155721f0v139r2ff974msu.png)
...
![单击下拉菜单](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155721jynypyzp7hu5hhi5.png)


单击下拉菜单上的 “<ruby> 选择日期 <rt>  Select Dates </rt></ruby>” 按钮。另外，选择选项 “<ruby> 文件名 <rt>  File Name </rt></ruby>” 以按文件名匹配。


![按日期搜索的设置](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155721u8jbjba82kpeeass.png)


这将为你提供一个扩展菜单，你可以在其中选择文件创建、修改或上次访问的日期。


![设定标准](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155722o819iqan3ony39yn.png)


在这里，如果你想设置自定义日期，请单击日历图标，如下图所示：


![点击日历图标](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155722r2zohw8ki0wx1fkf.png)


现在，你将看到一个小日历，并可以相应地选择日期。


![选择日期](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155723ytnk0d2fkykfn8nt.png)


从列表中设置你选择的日期后，你可以看到搜索栏上应用的条件，并向你显示基于该条件的文件。


![应用日期标准](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155723dngghh91gj9ecca3.png)
...
![根据文件类型搜索](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155724oufguvk0dozvpr54.png)


从展开的视图中选择要搜索的文件类型。在这里，我选择了 “PDF/Postscript”。


![设置所需的文件类型](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155724lme22ycoy26gijgy.png)


选择所需的文件类型后，你可以在搜索栏上看到应用的条件。你还将看到相应的结果。


![应用文件类型标准](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155724yhg0eotiphhg09y9.png)


在搜索选项中没有找到所需的文件类型？向下滚动到底部并单击 “<ruby> 其他类型 <rt>  other types </rt></ruby>”。


![获取更多文件类型](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155725u97u681pi8s9i949.png)


这将为你提供更多文件类型。


![列出更多文件类型](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155725dkx1xnm273nm3a9i.png)
...
![选择“全文”选项](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155726whhz6zhf6k86pgbf.png)
...
![仅在文件或文件夹中搜索](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155726xuc32y3jk3y3wwy2.png)
...
![应用多个过滤器](https://linuxcn.static.byte.beer/data/attachment/album/202401/25/155726mltzllhsszdkshid.png)
