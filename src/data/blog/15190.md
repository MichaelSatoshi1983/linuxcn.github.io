...
![ubuntu halloween theming final looks](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171414j8pfpj66f8pdzw9x.jpg)
...
![install gnome shell extensions user themes blur my shell and dash to dock](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171414a9rw8tegdeeefla9.png)
...
![set themes with gnome tweaks](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171415y04fmqlzdx7yx0ur.png)
...
![right click on font file and select open with fonts](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171415umjfgwfgygmmfjao.png)


然后，点击右上角的<ruby> 安装 <rt>  Install </rt></ruby>按钮。


![install font using font manager application](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171416aprrx7nalnxpf34z.png)
...
![change system fonts using gnome tweaks](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171416x6fc6zdllsseh56m.png)
...
![Disable Ubuntu Dock](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171416mmad9404m0itftia.png)
...
![select dash to dock settings](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171417fmszp9voi9ibs599.png)
...
![setting dash to dock icon size](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171417fzskr4kuhoszhrsi.png)
...
![opacity setting for dash to dock](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171418waxhsl513fgxrhns.png)
...
![select preferences from hamburger menu](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171418pmm1n2xcbonb1xyw.png)


单击 `+` ，来创建一个新配置文件。输入文件的名称，并点击 <ruby> 创建 <rt>  create </rt></ruby>，如下所示：


![create new profile in gnome terminal](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171419njqt4tfv93thif9d.png)


在这个新配置文件中，更改透明度设置，将透明度的滑块放在中间，如下图所示：


![set transperancy to gnome terminal](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171419n7dmh1mar14h3hps.png)


完成后，要将此配置文件设置为默认的配置文件，单击与新配置文件关联的三角形按钮，然后选择 “<ruby> 设置为默认 <rt>  Set as Default </rt></ruby>”。


![set new profile as default in gnome terminal](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171419brorrig29n9zsaic.png)
...
![blur my shell extension settings](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171420mx5nl0ihe0ic3ifc.png)
...
![applying blur effect to selected windows](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171420sbjlspt6q35nb2en.png)
...
![neofetch with custom backend](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171421ezunuunu4ounnron.png)
...
![ghosts shell color script](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171421hsvk222nm2mkjm2n.png)
...
![copy and paste conky files to home directory](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171421suke1hfguujzkf6c.png)
...
![conky theme applied](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171422zfzjgdv9g993dkdm.png)


将 Conky 添加到 [自启动应用程序列表](https://itsfoss.com/manage-startup-applications-ubuntu/) 中，以便在每次开机时都能自启动。


![add conky to the list of startup applications](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171422mkc0zm9a0nceprpe.png)
...
![set image as wallpaper from nautilus](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171423lixdjft7boikbqxz.png)
...
![ubuntu halloween theme final look](https://linuxcn.static.byte.beer/data/attachment/album/202210/29/171423c9nvhf4f99h3n969.jpg)
