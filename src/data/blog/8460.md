...
pubDatetime: 2017-04-29 10:36:00
description: "在CentOS 7及Ubuntu 16上，我将指导您安装与配置Elastic Stack以监控服务器日志，以及部署Elastic Beats进行客户端操作优化。"
tags: ["Lucene", "搜索引擎", "日志"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004453qr9m7m8322rs2ere.jpg)
...
![Check elasticsearch running on port 9200](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004509cumkpy8plxqqbxxz.png)
...
![Check memory lock elasticsearch and check status](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004512mt7f2mtur3t0fm7m.png)
...
![Kibana running as node application on port 5601](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004515rfpdup3bi2f2zuw2.png)
...
![Remove Server Block on Nginx configuration](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004517s2ihfkof5fj5zag1.png)
...
![Add nginx virtual host configuration for Kibana Application](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004520arcbpi9v0x119ctc.png)
...
![Logstash started on port 5443 with SSL Connection](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004523i98f4qasoq8qt94t.png)
...
![Filebeat is running on the client Ubuntu](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004526pa3c2cze7u7yyvkz.png)
...
![Login to the Kibana Dashboard with Basic Auth](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004530wvvf0ini30k8npni.png)


创建一个新的默认索引 `filebeat-*`，然后点击“创建”按钮。


![Create First index filebeat for Kibana](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004533ff3rzp89ppf3lm2k.png)


默认索引已创建。 如果 elastic stack 上有多个 beat，您可以在“星形”按钮上点击一下即可配置默认 beat。


![Filebeat index as default index on Kibana Dashboard](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004534lchbbto58h7b5cz8.png)


转到 “发现” 菜单，您就可以看到 elk-client1 和 elk-client2 服务器上的所有日志文件。


![Discover all Log Files from the Servers](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004536i8mh48fx54kr42hz.png)


来自 elk-client1 服务器日志中的无效 ssh 登录的 JSON 输出示例。


![JSON output for Failed SSH Login](https://linuxcn.img.undefined.today/data/attachment/album/201704/29/004547r1g0erhfl72vi15v.png)
