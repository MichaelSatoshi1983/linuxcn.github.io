...
pubDatetime: 2019-08-07 22:57:16
description: "在Linux命令行高效解析、格式化打印JSON，适用于shell脚本处理大型或复杂JSON数据。"
tags: ["JSON"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201908/07/225721su6tiyzzvvdwst59.png)
