...
![](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122211c2fgo53m9tw3xe2p.jpg)
...
![gdb coredump output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122227oj3pl6n6atioslct.png)
...
![GDB output with symbols](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122228ss9usrv88awa4a8a.png)
...
![gdb output crash on c1 switch](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122228fn8iihjpn0sjjfvf.png)


你可以检索有关程序的其他信息，`info source` 命令提供了当前文件的信息：


![gdb info source output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122228k2u20vnu2pfuftp6.png)
...
![gdb info shared output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122228jueq55u9ljv6e9au.png)
...
![gdb output stopped by sigint](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122229mp93xq1uz9qucx0p.png)


你也可以一步一步运行程序。在 C/C++ 中，入口是 `main` 函数。使用 `list main` 命令打开显示 `main` 函数的部分源代码：


![gdb output list main](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122229iq3znn6f47k3n6x3.png)


`main` 函数在第 33 行，因此可以输入 `break 33` 在 33 行添加断点:


![gdb output breakpoint added](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122229mbokzxhazvxifi2g.png)


输入 `run` 运行程序。正如预期的那样，程序在 `main` 函数处停止。输入 `layout src` 并排查看源代码：


![gdb output break at main](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122230jj16igub6aqu8ih6.png)
...
![gdb output corrupted](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122230pf6kv7nghf21ekrk.png)
...
![gdb output stop on watchpoint_1](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122230qm44qvg4rk14vv1q.png)


如果你继续运行程序，当监察点表达式评估为 `false` 时 GDB 将停止：


![gdb output stop on watchpoint_2](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122231dgk4vllg47vvg8y6.png)
...
![gdb output info watchpoints](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122231vczlbpkpchtkpglk.png)
...
![gdb output info breakpoints](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122231ldjxf5xvkjmqx22e.png)
...
![disabled breakpoints](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122232zxmu0u6z8mswssef.png)
...
![Set conditional breakpoint](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122232cqz0zswoqbppfyzx.png)
...
![print variable](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122232dyq8ybotqys0mhtq.png)
...
![modify breakpoint](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122233i1oo1ytovbtdmyot.png)
...
![catch syscall write output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122233g24zz7442i33z72z.png)
...
![catch syscall write output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122233m22g95vo4bmkv25m.png)
...
![whatis output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122234oxgtn3c6kbclh12n.png)


如果你要列出 `main` 函数范围内可用的所有变量，请输入 `info scope main` :


![info scope main output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122234ch9yjhch7h9bcycw.png)
...
![info locals output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122234cnnyc910iiggfdig.png)
...
![coredump application](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122234q9cde196c8cdm6ic.png)
...
![attach GDB to coredump](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122234l2k1mlzkfozwklwo.png)


当你用 GDB 附加到进程时，GDB 会立即停止进程运行。输入 `layout src` 和 `backtrace` 来检查调用堆栈：


![layout src and backtrace output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122235h6zssoqeioi6lt17.png)
...
![moving up the stack to main.cpp](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122235il2vavtstxxl12a1.png)
...
![Crash meme](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122235iscnb2eozvuolrv2.png)
...
![coredump output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122236nex7tbote4p7tx84.png)


`backtrace` 的输出显示崩溃发生在距离 `main.cpp` 五个栈帧之外。回车直接跳转到 `main.cpp` 中的错误代码行：


![up 5 output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122236jgmgvzj0w0f129og.png)
...
![no debugging symbols](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122236k5eh6f6x9ee7zz99.png)


`info file` 命令显示二进制文件的内存区域和入口点：


![info file output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122236a9uwtpyhu9z7jzpz.png)


`.text` 区段始终从入口点开始，其中包含实际的操作码。要在入口点添加断点，输入 `break *0x401110` 然后输入 `run` 开始运行程序：


![breakpoint at the entry point](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122237gko9cihecc922taz.png)
...
![changing assembly flavor](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122237xdsvvvs24yojys49.png)


现在输入 `layout asm` 调出汇编代码窗口，输入 `layout reg` 调出寄存器窗口。你现在应该看到如下输出：


![layout asm and layout reg output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122237catajn93nn2pypvv.png)
...
![continuing execution after crash](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122238dz4abef555z54rsz.png)
...
![stack division output](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122238iebmftyewwb322ow.png)
...
![print value](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122238obnnz33a1q31n5yb.png)
...
![Callstack assembly](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122238uj6y2jo4w4632xrr.png)
...
![GDB in VSCodium](https://linuxcn.static.byte.beer/data/attachment/album/202207/22/122239xp2g8gh28hiug9ik.png)
