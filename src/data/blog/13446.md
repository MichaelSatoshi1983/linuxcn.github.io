...
![](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201442luk1u6vqz3h3k8jn.jpg)
...
![测试 Flutter 应用](https://linuxcn.static.byte.beerhttps://linuxcn.static.byte.beer/data/attachment/album/202105/31/201524m9453rl9mtmdzx99.gif "Testing the Flutter app")
...
![创建一个新的 Dart 文件](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201524vap110sxfx80p21z.png "Create a new Dart file")
...
![导入 Flutter 包](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201524zlsefqh50efa8g5a.png "Importing Flutter package")
...
![重命名 StatefulWidget 类](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201525tzuhx5xtxk4tp99s.png "Renaming StatefulWidget class")


Flutter 识别到你重命名了 `StatefulWidget` 类，它会自动将它的 `State` 类也跟着重命名:


![State 类被自动重命名](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201525d6w2q2kiiijzni0w.png "State class renamed automatically")
...
![IDE 建议自动补完的代码](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201525xbzpb6bwwf595clw.png "IDE suggests autocompleting code")


按回车键即可完成输入，缺失的导入语句会被自动添加到文件的顶部。


![添加缺失的导入语句](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201526erzso7rg6g0sdsqk.png "Adding missing import ")
...
![查看微件选项](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201526rrcimnffoz2bfz05.png "Wrap with widget option")


输入 `Hero`，然后从建议的下拉列表中选择 `Hero((Key key, @required this, tag, this.create))`：


![查找 Hero 微件](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201526c33izlcl6gklkyet.png "Finding the Hero widget")


下一步, 给 Hero 微件添加 `tag` 属性 `tag: model.id`：


![在 Hero 微件上添加 tag 属性为 model.id](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201527u3ifl1y4uxu1sevv.png "Adding the tag property model.id to the Hero widget")


最后我们在 `item_details_page.dart` 文件中做相同的修改：


![修改item_details_page.dart文件](https://linuxcn.static.byte.beer/data/attachment/album/202105/31/201527t90kkp90mm6op9wx.png "Changing item_details_page.dart file")
