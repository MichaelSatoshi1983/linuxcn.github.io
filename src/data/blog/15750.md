...
![](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160055gt5d5u6dk5f4f5e7.jpg)
...
![Checking if Git is installed via VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160059e1qgm4u1qxy4yj1x.png)
...
![Cloning GitHub repo in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160059mwmumgyyypwplzym.png)


然后它会显示一条消息，要求你登录 GitHub。


![VS Code asking to sign in to GitHub](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160100ndlghrdduycgdzch.png)


你单击“<ruby> 允许 <rt>  Allow </rt></ruby>”按钮，它将打开 GitHub 登录页面。


![Connect GitHub to VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160100gv6nn4v4q70rnwnx.png)


如果你尝试克隆一个仓库，你应该会看到这样的消息并单击 “<ruby> 打开 <rt>  Open </rt></ruby>”。


![Opening GitHub repo in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160100qewnme0735mzmoxm.png)
...
![GitHub repos accessible from VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160100x9lz08r90kswne49.png)


或者，你可以单击左下角的配置文件图标，查看它是否显示你已登录到你的 GitHub 帐户。


![Checking if VS Code logged into GitHub account](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160101b00jggzdmjqmjg8f.png)
...
![Open a new window in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160101tcypczphiatazhqe.png)
...
![Clone a new GitHub repo in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160102cal8taayx6x6mlal.png)


它会问你把克隆的仓库放在哪里。


![Select a location for the cloned GitHub repo in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160102b8b2vbznpleriqsq.png)


它会询问你是否要将克隆的仓库在 VS Code 中打开。如果你想立即处理它，那就去做吧。


![Open the just cloned GitHub repo in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160102qg384edygasyc3na.png)


不仅仅是克隆的存储库，VS Code 会询问你是否信任你添加到其中的任何文件夹的作者。


![Trust author promot in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160103xm161mbyhmsb1yy1.png)
...
![Push your changes to GitHub from VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160103o9wtm9merdgcedmb.png)


如果你没有配置 Git 用户名和电子邮件，你将看到如下错误。


![Error in VS Code if Git username and email is not set](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160103lnuarr1zsrus0ln6.png)
...
![VS Code gives all kind of Git actions to perform](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160104jqw56w9nuu2udenr.png)
...
![Installing GitHub extension in VS Code](https://linuxcn.static.byte.beer/data/attachment/album/202304/24/160104uwty77cooy74wlll.png)
