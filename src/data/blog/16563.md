...
![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080808gtpgc9rvxxifjx7m.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080833uv5z353fwfokhz4v.png)


但是，如果你使用 systemd 之外的其他任何东西，它将显示初始化系统的名称，但是如果你使用的是 SysVinit，它只会显示 `init` 而不是 `sysvinit`：


![SysVinit only displays "init" instead of sysvinit](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080833unmh33sxnb3y636n.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080833b2c0plzgpzngu0qk.png)


如果你使用 [OpenRC 初始化访问](https://wiki.gentoo.org/wiki/OpenRC/openrc-init)，那么它将显示以下输出：


![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080834cfzx4xyyzn0y88yr.png)


但如果你使用 SysVinit，那么它会显示以下输出：


![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080834fzw7vxarwx9wdwr7.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202401/17/080835v96e38q4jr4rf8x9.png)
