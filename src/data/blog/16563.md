...
pubDatetime: 2024-01-17 08:08:33
description: "探索不同初始化系统，为项目最优选择，提升开发效率与成果质量。"
tags: ["初始化", "systemd"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080808gtpgc9rvxxifjx7m.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080833uv5z353fwfokhz4v.png)


但是，如果你使用 systemd 之外的其他任何东西，它将显示初始化系统的名称，但是如果你使用的是 SysVinit，它只会显示 `init` 而不是 `sysvinit`：


![SysVinit only displays "init" instead of sysvinit](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080833unmh33sxnb3y636n.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080833b2c0plzgpzngu0qk.png)


如果你使用 [OpenRC 初始化访问](https://wiki.gentoo.org/wiki/OpenRC/openrc-init)，那么它将显示以下输出：


![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080834cfzx4xyyzn0y88yr.png)


但如果你使用 SysVinit，那么它会显示以下输出：


![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080834fzw7vxarwx9wdwr7.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202401/17/080835v96e38q4jr4rf8x9.png)
