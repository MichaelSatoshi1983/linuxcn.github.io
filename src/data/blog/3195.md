...
pubDatetime: 2014-06-14 23:33:00
description: "记录终端操作，使用script命令创建输出记录，便于历史追踪与复现，支持终端会话完整保存与日后打印，通过在终端输入script实现。"
tags: ["script", "命令行", "记录"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233330ysxa1afoddk1avcd.png)
...
![Define script file](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233332uiteyu8axeeuyuen.png)
...
![Create collaborate file](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233333fe0svvieszifvxzv.png)
...
![Append the file](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233334m3b0vroaa24raj3r.png)
...
![Add script to bash profile](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233335dakdlmalewvpezdp.png)


然后保存。下次他登录进你的系统时，script命令就会自动运行，并把日志记录进**/usr/local/script/log*record*script**。


![Script without notification](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233336zlry0wwgynl3wyss.png)
...
![Script with notification](https://linuxcn.img.undefined.today/data/attachment/album/201406/14/233338h77jeef6v6pjctr9.png)
