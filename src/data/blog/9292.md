...
pubDatetime: 2018-01-30 11:35:00
description: "使用ssh安全复制文件时，若需排除某文件，不通过scp直接过滤，而应结合通配符与ssh，实现安全高效文件传输，确保精确复制，避免不必要的数据传输。"
tags: ["scp", "rsync"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201801/29/224214p1179wdr9laeriwg.jpg)
...
[![Scp exclude files but using rsync exclude command](https://linuxcn.img.undefined.today/data/attachment/album/201801/29/224228pk4edf2dzclkh9hf.jpg)](https://www.cyberciti.biz/media/new/faq/2017/12/scp-exclude-files-on-linux-unix-macos-bash-shell-command-line.jpg)
