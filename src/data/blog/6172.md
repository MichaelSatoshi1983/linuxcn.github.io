...
pubDatetime: 2015-09-08 00:21:36
description: "在Ubuntu 15.04下使用Gnome Network Manager创建无线AP热点，需配备支持AP模式的无线网卡。发现支持AP模式需在终端输入iw list确认，如需在Ubuntu安装iw，使用命令sudo apt-get install iw。操作步骤包括断开WIFI连接，以线网络接入为例继续后续设置。"
tags: ["WIFI", "AP"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201509/08/001208hzicx6nzfxkzuqnc.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/08/002002n6dbw3ft6o62wqw6.jpg)


5、 进入Wi-Fi安全选项卡，选择 WPA & WPA2 Personal 并且输入密码。 6、 进入IPv4设置选项卡，在Method(方法)下拉菜单里，选择Shared to other computers(共享至其他电脑)。


![](https://linuxcn.img.undefined.today/data/attachment/album/201509/08/002028yeaez0b974glbqgn.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/08/002100bhi6xg7eskezqz3e.jpg)


a、 把 `mode=infrastructure` 改成 `mode=ap` 并且保存文件。 b、 一旦你保存了这个文件，你应该能在 Wifi 菜单里看到你刚刚建立的AP了。(如果没有的话请再顶栏里 关闭/打开 Wifi 选项一次)


![](https://linuxcn.img.undefined.today/data/attachment/album/201509/08/002124iqf9512guh5g2kq2.jpg)
