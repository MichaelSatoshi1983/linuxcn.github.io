...
pubDatetime: 2015-01-19 14:19:00
description: "MultiSystem是一款简便的开源工具，助您在Linux系统中轻松创建多启动USB盘。只需网络链接与足够USB空间，可容纳任意多Linux发行版。适用于Ubuntu 14.10/14.04，提供手动与PPA安装选项，简化多系统启动流程。"
tags: ["MultiSystem", "USB", "启动盘"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102128op4sdepdvs2scnmv.png)


第一次启动时，MultiSystem界面看起来会像下面这样。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102129jg2iscwzigw2zc4i.png)


选择USB设备，点击**确认**按钮。如果你看到下面的错误窗口，不必担心，它说的是USB设备没有标签。点击OK让MultiSystem自动设置标签。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102130argxkgdptagkugak.png)


那么，拔出/重新插入USB，再次运行MultiSystem。选择USB盘，再次点击确认。现在，你被要求确认在USB中安装Grub2.点击OK继续。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102132oqxhjdb1x8zz0xjr.png)


最终，你会高兴地看到MultiSystem的界面。现在，时候创建多启动USB盘。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102134xt000p2z0typyhy0.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102135k1b47zkczc149ba4.png)


现在，MultiSystem会从ISO中拷贝文件，并让USB可启动。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102138egocu4csocgjgqgi.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102141jnjqqqq2tnntukla.png)


就是这样。我们的多启动USB盘就可以使用了。重启系统，并在BIOS中设置USB优先启动。选择你想要安装的发行版并开始安装系统。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102142ljsazzbbccusb551.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102145d8pispek10rgegok.png)


同样，你也可以在Ubuntu中使用QEMU或者Oracle VirtualBox测试多启动USB盘。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/102148nkkssssaqvsv5paw.png)
