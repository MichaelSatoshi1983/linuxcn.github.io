...
pubDatetime: 2015-04-01 08:00:00
description: "在Linux服务器上，通过关闭`expose_php = Off`，禁用默认的PHP版本信息显示，增强安全性，抵御攻击。操作步骤：编辑`/etc/php.ini`，将`expose_php`值更改为`Off`。"
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201503/31/234317pul3wy8pl8c73ce3.jpg)
