...
pubDatetime: 2015-06-20 13:28:00
description: "在基于Debian系统的Linux上编译wxWidgets 3.0以上版本只需几步：下载源码,解压至指定目录,确保环境具有C++编译器和相关开发工具，并配置构建参数以生成静态或动态库。全过程约需几分钟，实现跨平台应用开发。"
tags: ["wxWidgets"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/20/073112f3h66vfvvkpu4qpu.png)
