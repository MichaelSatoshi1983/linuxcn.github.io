...
pubDatetime: 2018-02-01 15:13:09
description: "轻松调试Linux或类UNIX系统上的bash脚本：运行`bash -x`查看脚本逐行执行，使用`echo`输出变量状态，确保脚本正确执行与调试。"
tags: ["shell", "脚本", "调试"]
---
...
[![如何在 Linux 或者 UNIX 下调试 Bash Shell 脚本](https://linuxcn.img.undefined.today/data/attachment/album/201802/01/151311iy411omf3kfwy2wy.jpg)](https://www.cyberciti.biz/tips/wp-content/uploads/2007/01/How-to-debug-a-bash-shell-script-on-Linux-or-Unix.jpg)
