...
![Filing cabinet for organization](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142456a5gd0h0yp5y5yotz.png)
...
![Screenshot of terminal showing config.example highlighted and a preview of the file in the terminal to the right](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142456gsgg0jg1up5oxcpz.png)
...
![Screenshot of a PNG file preview over a terminal window](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142456a23z23fzxkg2zr82.png)


在一个图像文件上点击 `i` 会给用户提供所有的 EXIF 数据。点击 `Shift+Enter` 将打开这个 PDF 文件。


![A screenshot showing a preview of a PDF file (tickets to a museum) floating over the terminal window](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142457tkv47sicc4e2s7c4.png)


同样的组合键将在系统默认的支持该编解码器的视频播放器中打开并开始播放视频。下面的例子是一个 mp4 视频，它在 [VLC](https://opensource.com/article/21/2/linux-media-players) 上播放得很好。


![Screenshot of a Bugcrowd University Cross Site Scripting video in VLC media player, previewed over the terminal](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142457pwfy6ysvguu3uthf.png)
...
![Screenshot of terminal showing timestamped files that can be renamed with the bulkrename command](https://linuxcn.static.byte.beer/data/attachment/album/202207/16/142457ye01y9llebkbsk0y.png)
