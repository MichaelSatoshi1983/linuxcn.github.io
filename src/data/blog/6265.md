...
pubDatetime: 2015-09-22 10:33:00
description: "Linux用户自由定制系统，多种发行版与桌面环境选择，满足个性化需求。Dock应用为桌面增添活力，特别适用于全局菜单用户，提供丰富选择。"
tags: ["Dock", "Plank"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073547itudzff6fz7xu3sm.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073549pvu9jfkvzf771u3r.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073549gjeiggmg8zmggp5k.jpg)


正如上面图片显示的那样，dock 包含许多带橙色标示的应用图标，这表明这些应用正处于运行状态。无需说，你可以点击一个图标来打开那个应用。同时，右击一个应用图标会给出更多的选项，你可能会感兴趣。举个例子，看下面的屏幕快照：


![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073550vgqi5imlkiwiizcf.jpg)


为了获得配置的选项，你需要右击一下 Plank 的图标（左数第一个），然后点击 Preferences 选项。这就会出现如下的窗口。


![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073550scz7y31kcc1aqcfs.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073550ydf8koopoe112rgp.png)


举个例子，我在 Appearance 里改变 dock 的位置为右侧，在 Behavior 里锁定图标（这表示右击选项中不再有 “Keep in Dock”）。


![](https://linuxcn.img.undefined.today/data/attachment/album/201509/22/073551i79gz6d7t297o9m7.jpg)
