...
pubDatetime: 2014-09-16 14:38:00
description: "在Linux shell脚本编程中，高效利用变量（系统定义&用户定义）至关重要；无需声明类型。系统定义变量由Linux自定义并维护，通过$ set命令可见。共同探讨变量类型、设置与应用方法。"
tags: ["Shell", "变量", "编程"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201409/16/143729b0qmspapdfhqaqb3.png)
