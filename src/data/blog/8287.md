...
pubDatetime: 2017-03-10 08:47:11
description: "自动化备份设备实验：使用Armbian Linux与Orange Pi，通过网络将USB驱动器挂载，适配Time Machine，实现高效数据保护。"
tags: ["Time Machine", "备份", "Mac", "Orange Pi"]
---

![Orange Pi as Time Machine Server](https://linuxcn.img.undefined.today/data/attachment/album/201703/10/084716wwu3ut2dr6rwm3ma.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201703/10/084720kck61gjl7dzm1k9k.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201703/10/084858p4haaly4hz3y3yan.png)


这样设置肯定有效，Orange Pi 能够很好的处理进程，不过这可能并不是最快速的备份方式。但是，这个方法比较简单且便宜，并且正如其展示的一样能够正常工作。如果对这些设置你已经成功或者进行了改进，请在下面留言或者发送消息给我。


![](https://linuxcn.img.undefined.today/data/attachment/album/201703/10/084903go1hzmcqvsm5jvvc.png)
