...
pubDatetime: 2015-04-07 14:33:00
description: "运用backupninja，您能定制Handler和Helper，实现基于Debian系统的高度可配置备份。通过编写自定义脚本，满足特定备份需求，超越常规配置，实现灵活且高效的数据保护策略。"
tags: ["backupninja", "备份"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233831caluar044r42clla.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233935we74l25w5ml5s7x7.jpg)


接下来将看到可选的操作类型，这里选择“backup of home directories"（备份home目录）：


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233940bvqd0d47qzlo9vgd.jpg)


然后会显示在helper中设置的默认值（这里只显示了3个）。可以编辑文本框中的值。注意，关于“when”变量的语法，参考文档的日程安排章节。


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233945yjnoo62fhoof6z7p.jpg)


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233947bo7nt884j7c3nduo.jpg)


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233949p0iiuus00ds3nniy.jpg)


当完成备份操作的创建后，它会显示在ninjahelper的初始化菜单中：


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233953po2mww4vuukmwrvp.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233956di2fmc1xll9nm2mb.jpg)


备份操作会发生一些错误，debug会提供一些有用的信息以帮助你定位错误并纠正。例如，当备份操作有错误并且没有被纠正，那么当它运行时将会打印出如下所示的错误信息。


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/06/233959boptxgpz35dytbzo.jpg)
