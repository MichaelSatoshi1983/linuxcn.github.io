...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/04/235739n64z4407mwwcc4yc.jpg)
...
4. `${0%.png}.jpg` – 设置新转换的图像文件的名字，`%` 符号用来删除源文件的扩展名
 ...
 [![Convert PNG to JPG Format in Linux](https://linuxcn.static.byte.beer/data/attachment/album/201612/04/235758uhc0hrooi6sh5p9s.png)](http://www.tecmint.com/wp-content/uploads/2016/11/Convert-PNG-to-JPG-in-Linux.png) 
...
3. `:::` – 指定输入源的符号，即上面示例的命令行，在这里 *png 或 jpg* 是命令参数。
 ...
 [![Parallel Command - Converts All PNG Images to JPG Format](https://linuxcn.static.byte.beer/data/attachment/album/201612/04/235758zxkwqk11y1ppqyx4.png)](http://www.tecmint.com/wp-content/uploads/2016/11/Convert-PNG-to-JPG-Using-Parallel-Command.png) 
...
4. `${image%.png}.jpg` 语句创建了转换后的图像名字，其中 `%` 表示去除源图像文件的扩展名。
 ...
 [![for loop - Convert PNG to JPG Format](https://linuxcn.static.byte.beer/data/attachment/album/201612/04/235759tllxnevp7vml3emv.png)](http://www.tecmint.com/wp-content/uploads/2016/11/Convert-PNG-to-JPG-Using-for-loop-Command.png) 
...
```
 ...
 [![Batch Image Convert Using Shell Script](https://linuxcn.static.byte.beer/data/attachment/album/201612/04/235759l7lvjgt9f31r8afr.png)](http://www.tecmint.com/wp-content/uploads/2016/11/Batch-Image-Convert-Using-Shell-Script.png) 
