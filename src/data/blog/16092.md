...
![](https://linuxcn.static.byte.beer/data/attachment/album/202308/14/110746hxia0hp18r1v11vz.jpg)
...
![Creating a shareable link and editing permissions on Penpot.](https://linuxcn.static.byte.beer/data/attachment/album/202308/14/110938egdktrob9tojyusq.jpg)
...
![An example of an asset library within Penpot.](https://linuxcn.static.byte.beer/data/attachment/album/202308/14/110946u681ws8u2pwz11pj.jpg)


共享这些库使整个团队都可以访问它们。当与定期访问相同源文件的团队合作时，这会很有帮助。如果新成员加入，他们开始为项目构建模型所需的所有素材都将随时可用。用户可以直接从 Penpot 文件导出这些素材。


![Exporting selected assets in a Penpot file.](https://linuxcn.static.byte.beer/data/attachment/album/202308/14/110955iaeqc0ccmbpqcvbq.jpg)


开发人员可以在任何浏览器上查看原型的全部内容。这种功能让网站建设变得更容易，因为你可以与原型同时进行编码。如果设计人员同时在处理文件，他们所做的更改可以通过**查看模式**刷新查看，如果是在实际文件中，则可以实时查看。


![An editor with code and the Penpot interface.](https://linuxcn.static.byte.beer/data/attachment/album/202308/14/111007w9gf9z977c797q83.jpg)
