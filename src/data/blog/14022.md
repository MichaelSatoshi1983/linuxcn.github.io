...
![](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235643wvmciyy2f8y3mi73.jpg "FreeDOS fish logo and command prompt on computer")
...
![manual install](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235654a06h0ihi1pl4p011.png "Select \"Use FreeDOS 1.3 in Live Environment mode\" to boot the LiveCD")
...
![using fdisk](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235654dmpy9nrembmnrrun.png "Select \"1\" to create a partition")


*选择 `1` 来创建一个分区（Jim Hall, [CC-BY SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)）*


![using fdisk](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235654rj0bgbwvr8xbk7rw.png "Select \"1\" on the next menu to make a primary partition")
...
![using fdisk](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235655q84x4zawri0uiw8r.png "You need to reboot to recognize the new partition")
...
![formatting the disk](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235655sxvjmbccmg3c3mss.png "Format the partition to create the DOS filesystem")
...
![formatting the disk](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235655x4ylu4yuzu37pm4e.png "FORMAT /S will use SYS to make the disk bootable")
...
![installing the software](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235656tu8yewenxfr52qnk.png "Unzip all of the Base packages to finish installing FreeDOS")
...
![installing the software](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235656hprgxww8tui7ib8i.png "After installing all the Base packages")
...
![rebooting FreeDOS](https://linuxcn.static.byte.beer/data/attachment/album/202111/25/235656b5dv4vah1ni77vin.png "Rebooting FreeDOS after a manual install")
