...
pubDatetime: 2017-03-22 08:24:00
description: "SELinux运用标签系统精细控制内核权限，主打类型强制策略，基于对象类型管理进程访问，另设有MCS与MLS，实现同类型进程分离及等级控制，强化访问管理。"
tags: ["安全", "SELinux"]
---

![SELinux policy guide](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062657tmm2pfmt6686punq.png "Your visual how-to guide for SELinux policy enforcement")
...
![Image showing a cartoon of a cat and dog.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062657hmiddihwztkdhmoi.png)


我们有一类希望能与之交互的客体，我们称之为食物。而我希望能够为食物增加类型：`cat_food` （猫的食物）和 `dog_food`（狗的食物）。


![Cartoon Cat eating Cat Food and Dog eating Dog Food](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062657b0yza0y5n2oy0716.png)


作为一个策略制定者，我可以说一只狗有权限去吃狗粮（`dog_chow`），而一只猫有权限去吃猫粮（`cat_chow`）。在 SELinux 中我可以将这条规则写入策略中。


![allow cat cat_chow:food eat; allow dog dog_chow:food eat](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062658sy57lyjjiwa6sjws.png "SELinux rule")
...
![Cartoon Cat eating Cat Food and Dog eating Dog Food](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062658zbbbxmdwebhmab5v.png)


此外，在 SELinux 系统中，由于禁止是默认规则，这意味着，如果狗进程想要去吃猫粮 `cat_chow`，内核会阻止它。


![](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062658e7gedpn7gg448dab.png)


同理，猫也不允许去接触狗粮。


![Cartoon cat not allowed to eat dog fooda](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062659zpiwk3p9wp757559.png "Cartoon cat not allowed to eat dog fooda")
...
![SELinux rule](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062659u3sdkpmni8d40psv.png "SELinux rule")
...
![Cartoon of two dogs fido and spot](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062700le6ybj3yjij61kz1.png)


我们将狗粮标记为 `dog_chow:random1(Fido)` 和 `dog_chow:random2(Spot)`。


![SELinux rule](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062700e56zebiqghzbdbxa.png "SELinux rule")
...
![Cartoon of Kernel (Penquin) holding leash to prevent Fido from eating cat food.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062700pt7mvvl7uczulmlj.png)


Fido (`dog:random1`) 允许去吃 `dog_chow:random1`。


![Cartoon Fido happily eating his dog food](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062701ejzaozfa69qqfhzq.png)


Fido (`dog:random1`) 去吃 spot(`dog_chow:random2`)的食物被拒绝。


![Cartoon of Kernel (Penquin) holding leash to prevent Fido from eating spots dog food.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062701qffe6pv6pgeaggkg.png)
...
![Cartoon of a Greyhound and a Chihuahua](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062701y4qzp4sqqamxmhwc.png)
...
![Cartoon of a Greyhound dog food and a Chihuahua dog food.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062702bsydx7sv7t5cogd7.png)


使用 MLS 策略，我们可以使 MLS 格雷伊猎犬标签支配吉娃娃标签。这意味着 `dog:Greyhound` 允许去吃 `dog_chow:Greyhound` 和 `dog_chow:Chihuahua`。


![SELinux rule](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062702xszf8yzat9ry58zh.png "SELinux rule")


但是 `dog:Chihuahua` 不允许去吃 `dog_chow:Greyhound`。


![Cartoon of Kernel (Penquin) stopping the Chihahua from eating the greyhound food.  Telling him it would be a big too beefy for him.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062702i0yblel8vhlr9qll.png)


当然，由于类型强制， `dog:Greyhound` 和 `dog:Chihuahua` 仍然不允许去吃 `cat_chow:Siamese`，即使 MLS 类型 GreyHound 支配 Siamese。


![Cartoon of Kernel (Penquin) holding leash to prevent both dogs from eating cat food.](https://linuxcn.img.undefined.today/data/attachment/album/201703/22/062703h07wob27ge204nar.png)
