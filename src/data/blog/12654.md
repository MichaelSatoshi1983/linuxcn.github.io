...
pubDatetime: 2020-09-26 11:51:03
description: "Mu助你高效掌握Python编程，简化学习曲线，提升编程技能。"
tags: ["Python"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115018dkf3lvfyekifliec.jpg)
...
![Mu editor](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115106dmaqiw60lndisbq6.png "Mu editor")
2. 输入 `import turtle` 导入 `turtle` 模块，就可以让乌龟动起来了。我的第一课是用 Python 代码画一个简单的正方形。


![Mu editor](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115111jb7kx6694lxkg937.png "Mu editor")
3. 保存这个程序，确保文件名以 .py 结尾。


![Saving program in Mu](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115116ltp8t8pl18pl8lum.png "Saving program in Mu")
4. 运行程序。哪怕是运行这样一个简单的程序都会让人兴奋，看到你写的程序的图形输出是很有趣的。


![Running Python program in Mu](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115120v5invn9za4xajnv4.png "Running Python program in Mu")
...
![for loops in Python with Mu](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115123c4rslxmhmz9z7mii.png "for loops in Python with Mu")


接下来，我将展示如何创建一个 `my_square` 函数，作为另一种绘制正方形的方法。


![my_square function](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115125eyc2j056eet02hbz.png "my_square function")


后来，我通过介绍其他 `turtle` 模块方法，包括 `penup`、`pendown` 和 `pencolor` 来扩展这个概念。很快，我的学生们就开始开发更复杂的程序，并对其进行迭代。


![Mu editor](https://linuxcn.img.undefined.today/data/attachment/album/202009/26/115127lcs7tvcvvos7cc56.png "Mu editor")
