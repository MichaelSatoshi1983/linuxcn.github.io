...
pubDatetime: 2023-06-30 10:26:00
description: "掌握i3窗口管理器，个性化系统外观与体验。深入指南，打造专属办公或创作环境。"
tags: ["定制", "i3"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102801n3z6gasul1lliwz0.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102820uocpcshfuyf888yr.jpg)
...
![如何在 Linux 中配置 i3 窗口管理器、i3blocks 和 i3gaps](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102821zq7ttqtktfu7pkqb.png)
...
![在 Arch Linux 上使用 lightdm 使用 i3 窗口管理器](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102822t5et88z1k5158u7f.png)
...
![生成 i3 配置文件](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102822hnnnomobnrnerwub.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102823rd00ll9fd0sdfnqd.png)
...
![在 Arch Linux 上使用 i3](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102823pdthka1ttmbmyw9h.png)
...
![在 i3 中查找已连接显示器](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102857zxxtczz82tbzipnd.png)
...
![在 i3 中永久更改显示分辨率](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102857ezeazoaha70u423l.png)
...
![使用 feh 实用工具在 I3 窗口管理器中更改背景](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102857dstn6m5zz7a34rrn.png)
...
![在 i3 窗口管理器中更改壁纸](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102857x7quo1u1juj7jyyo.png)
...
![锁定 i3 窗口管理器](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102858men99bu3enni9q54.gif)
...
![如何在 Arch Linux 中使用 i3lock-color](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102858rkjukk79wzkwy865.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102858o9c9o59k9zk7c9ia.png)


同样地，要更改图标，选择 “<ruby> 图标主题 <rt>  Icon Theme </rt></ruby>”，选择图标主题，然后点击应用按钮：


![使用 lxappearance 更改 i3 窗口管理器中的图标](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102859pfgywww1a6yfswg9.png)


应用主题和图标后，我的文件管理器如下所示：


![在 i3 窗口管理器中更改主题和图标](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102859dsg97i9ngxxgza5o.png)
...
![在 i3 配置文件中的工作区变量](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102931n80bo8eowvszz040.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102931wsbrrwobbm2s5i2t.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102931i7k5o1z5ovxfrx5n.png)
...
![并排打开应用程序和终端](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102932vow0ggvqzfqtvdzt.png)
...
![在 i3 窗口管理器中查找类名](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102933fupn6zuuu5skil5n.gif)
...
![将应用分配到工作区](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102933xs34z04so04ec9im.png)
...
![在 i3 窗口管理器中更改终端背景透明度](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102933luamt555uzrltu7g.png)
...
![在 i3 窗口管理器中更改 i3 状态配置路径](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102935ri04p7zm411zyjvm.png)
...
![自定义 i3 窗口管理器中的状态栏](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/102935jencumgmru7zg2xu.png)
...
![更改 I3 窗口管理器中的窗口颜色](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103014uo5uca5ujzqcnq1a.png)
...
![在 i3 状态栏中更改字体](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103016y9ieq631zqxdipoo.png)
...
![使 i3 状态栏透明的配置文件（i3 窗口管理器）](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103016a62ffo7pg1l0z2qf.png)


为了使你所做的更改生效，请重新启动 i3，你将得到透明的窗口和状态栏：


![在 i3 窗口管理器中使状态栏和窗口透明](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103017nc3ztxjpupuukthc.png)
...
![在 i3 窗口管理器中启用 i3blocks](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103019tz822cr0znt03zcr.png)


完成后，使用 `Mod + Shift + r` 重新启动 i3 窗口管理器，整个状态栏都会被更改，并显示如下：


![i3 窗口管理器中 i3blocks 的默认外观](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103020ulb4p4tco5cplcce.png)
...
![在 i3 窗口管理器中定制 i3blocks ](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103114h87ph979097p705c.jpg)


你可以查看我的主屏幕，其中包含这些块（点击下方的图片查看）。


![在 i3 窗口管理器中定制 i3blocks ](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103115a7v0jci0zc70woew.png)
...
![在 i3 窗口管理器中使用 i3gaps](https://linuxcn.img.undefined.today/data/attachment/album/202306/30/103149s6kreu8rcuqswwle.png)
