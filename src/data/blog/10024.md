...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001443wijtrv00r8sr90b0.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001450x9gxkkq8wxv8zn0w.png)


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001451iew2wdqwygaraawr.png)


创建完成后，你还需要做一些设置，添加更多的处理器核心，提高开机显示内存。在 VM 上打开设置选项，“设置 -> 系统 -> 处理器”，如果硬件条件允许，可以多分配一些处理器。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001451cv7grgl1l6go8x3r.png)


在 “设置 -> 显示 -> 显存大小” 中，你可以分配一大块内存并开启 3D 加速功能。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001452ajgwj8l1wpk9zklp.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001453iw4wi4bz0ncewinv.png)


下一步，如果想长时间使用 Android，选择 “Installation” 选项，你也可以选择 Live 模式体验 Android 环境。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001454nurscj3j1jpom1j1.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001454zsvpvmy7y7yvg3a2.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001454r5brfh9xd9h8upcz.png)


现在你被引导到 fdisk 工具页面。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001455pzexeffexudox2em.png)


为了简洁起见，我们就只创建一个较大的分区，使用方向键来选择 “New” ，然后选择 “Primary”，按回车键以确认。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001455t8h2gbl288qnhotb.png)


分区大小系统已经为你计算好了，按回车键确认。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001456njebitt9lrxxxxij.png)


这个分区就是 Android 系统所在的分区，所以需要它是可启动的。选择 “Bootable”，然后按回车键（上方表格中 “Flags” 标志下面会出现 “boot” 标志），进一步，选择 “Write” 选项，保存刚才的操作记录并写入分区表。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001456jbad46nw0et4ijoz.png)


现在你可以选择退出分区工具，然后继续安装过程。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001457n1qfnovnqqma4qyn.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001458f0xhpn6xjt6op8x9.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001459kzhm95fc9w8zm565.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001459nunzjb27iep92r29.png)


如果一切正常，你将会看到如下界面：


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001500ylqz8x71if3518kq.png)


如今的 Android 系统使用触摸交互而不是鼠标。不过 Android-x86 平台提供了鼠标操作支持，但开始时可能需要方向键来辅助操作。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001501js4t737j05u55ju7.png)


移动到”let’s go“按钮并按下回车键。选择 “Set up as new” 选项，回车确认。


![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001502n2ynnyt47ppnc9t2.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001503v3hhz48qnhdq0b0w.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201809/18/001505trff6lmnqldjiook.png)
