...
![](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084015z4cfiiy8e1ezmmz0.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084037n9fe4u93zku3uvll.png)
...
![下载并将操作系统放入 SD 卡的官方工具](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084037rnouujmw2iyjxufz.png)
...
![镜像工具：选择首选操作系统](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084038lhbnz52fhflohthf.png)


在“<ruby> 操作系统 <rt>  Operating System </rt></ruby>”下，选择 “<ruby> 其它通用的操作系统 <rt>  Other general purpose OS </rt></ruby>”：


![镜像工具: 其他通用的操作系统](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084038ps8trseuaj080rrj.png)


现在，选择 “Ubuntu”：


![镜像工具：发行版 - Ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084038a3e6d106t36y4yg0.png)


接下来，选择 “Ubuntu Desktop 21.04（RPI 4/400）”，如下图所示。


![镜像工具：发行版 - Ubuntu 21.04](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084039etzef3hoo8pqqut7.png)
...
![镜像工具：选择存储设备（SD 卡）](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084039bb6wkk3zk03wf3sf.png)


你应该可以根据存储空间大小，识别你的 Micro SD 卡。这里，我使用的是 32GB 的卡：


![镜像工具：选择 SD 卡](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084039pjjcsubajlanc5nn.png)


现在点击“<ruby> 写入 <rt>  WRITE </rt></ruby>”：


![镜像工具：镜像写入](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084040ya9nms07zscfefzm.png)


如果你已经备份了 SD 卡上的内容或是一张新卡，你可以直接进行：


![镜像工具：镜像写入确认](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084040wfycajgejfdheyxj.png)


由于这需要 [sudo](https://itsfoss.com/add-sudo-user-ubuntu/) 的权限，你必须输入密码。如果你从终端运行 `sudo rpi-imager`，就不会出现这种情况：


![镜像工具：镜像写入授权需要密码](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084040feqmvor8mqzq66rr.png)


如果你的 SD 卡有点旧，这将需要一些时间。如果它是一个新的高速 SD 卡，就无需很长时间：


![镜像工具：写入镜像](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084041vgz0agz1an1ncf5o.png)


为确保镜像写入成功，我不建议跳过验证：


![镜像工具：验证写入](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084041y6nzkgzng3blcgln.png)


写入结束后，会有以下确认提示：


![镜像工具：写入成功](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084041m4ixstzkscdqsx6k.png)
...
![树莓派 4B 板倒置，插入 Micro SD 卡](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084042gpeq6wyl20ww2ljl.jpg)


按照这个方向将卡慢慢插入板子下面的卡槽，轻轻地插，直到它不再往前移动。你可能还会听到一点咔嚓声来确认。这意味着它已经完美地插入了。


![树莓派 SD 插槽在板子背面的左侧](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084042dr8drqr8df2ei82o.png)


当你把它插进去的时候，你可能会注意到在插槽中有两个小针脚调整了自己的位置（如上图所示），但这没关系。一旦插入，卡看起来会有一点突出。这就是它应该有的样子。


![树莓派 SD 卡插入时有一小部分可见](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084042qz0ott7qok57o6t0.png)
...
![选择语言](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084042ccqqevihj6hq8l8v.jpg)


![选择键盘布局](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084043jfnrlttmcufffcdn.jpg)


![选择 WiFi](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084043zb6gnbsjxlbznuru.jpg)


你可以根据需求选择时区：


![选择时区](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084043ubdd1bmwvctdv060.jpg)


然后创建用户和密码：


![输入所需的用户名和密码](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084044ifn0u0u0nvuu03ud.jpg)


之后的步骤将配置一些东西，这个过程需要一些时间：


![完成 Ubuntu 设置](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084044hbi8ds7n71rnq1xd.jpg)


![完成 Ubuntu 设置](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084045e5ssf5a2smvwwefv.jpg)


系统会重新启动之前需要一些时间，最终，你将会来到 Ubuntu 的登录界面：


![Ubuntu 的登录界面](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084045txz3ppsfbcg9cf4p.jpg)


现在，你可以开始享受树莓派上的 Ubuntu 桌面了：


![树莓派上的 Ubuntu 桌面](https://linuxcn.static.byte.beer/data/attachment/album/202109/25/084045t9ag4aawym5y5awv.png)
