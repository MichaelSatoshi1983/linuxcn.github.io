...
pubDatetime: 2016-01-29 14:02:00
description: "使用grep命令通过添加-c或--count参数统计Linux或UNIX文件中匹配或不匹配特定单词的行数，示例输出分别为1与45。"
tags: ["grep"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201601/29/070409oun9deokc0clkkez.jpg)
