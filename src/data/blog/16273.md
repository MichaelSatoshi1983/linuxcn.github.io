...
![](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224338y0d7dgqlez0e0nmz.jpg)
...
![点击活动以访问](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224343kmrt22922rccjhrq.png)


你也可以通过按下 `Super` 键（即：`Windows` 键）来快速访问。


![GNOME 搜索界面](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224344x8yyt85ecc8ts8gu.png)


尽管 GNOME 内置了强大的搜索功能，但大部分人却仅仅用它来搜索和运行应用。


![大部分人用 GNOME 活动来搜索和运行应用](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224344zfgtiltv3vf31nkf.png)
...
![文件搜索](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224345kxqz9vxtnq9zopzg.png)
...
![文件管理器图标](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224346e48wi15l1nglffyw.png)


点击后，会打开 Nautilus 文件管理器，并进入搜索模式，你可以看到所有匹配到的文件。


![Nautilus 文件管理器的搜索模式](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224346whrhr7qooow96r9a.png)
...
![搜索概览中的字符](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224347azftrm9ompp4p34r.png)


一旦你找到了想要的字符，按回车键，就可以将其复制到剪贴板。然后使用 `CTRL+V` 进行粘贴。


![字符已复制](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224348wh8mvqnhve3krmqm.png)
...
![获取计算结果](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224349yiy3jcjfbyeycplm.png)
...
![GNOME Shell 搜索中的世界时钟](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224349sxx02uhd2zjgl7cl.png)
...
![获取运行中的终端窗口](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224350nh3e8d7iehahzdd6.png)
...
![设置中的 Firefox 角色——搜索提供器](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224350nn4aapzcsucekpks.png)


启动 Firefox 后，你可以在活动概览中搜索并找到网页结果。除此之外，你还可以在系统设置中，根据你的喜好对 Firefox 的显示顺序进行调整。


![Firefox 搜索结果](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224351by577tvoohhvht5q.png)
...
![搜索设置中的 GNOME Web](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224351ps5l7n0gsgpgjuyu.png)


如果它未被激活，只需开启这个开关。即使 GNOME Web 并没有被打开，它仍能正常工作。


![使用 GNOME Web 搜索得到的网络结果](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224351kuyfqy0yiukuuzui.png)
...
![设置中的搜索选项卡](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224352xx35x8z5xg35zp5i.png)
...
![用于排列项目的按钮和把手](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224353tsd91zyy1yg1j6jq.png)


你可以直接拖拽左侧的把手来调整项目顺序，将其放到你希望的位置。


![拖拽调整项目显示的顺序](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224353pq73jv897rn8ynvr.gif)


或者，你也可以点击右侧三点菜单，然后选择“<ruby> 向上移动 <rt>  Move Up </rt></ruby>”或“<ruby> 向下移动 <rt>  Move Down </rt></ruby>”。


![使用按钮上下移动](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224354wsgu3dzqcjbuztuf.gif)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224354vgogennjjdnentug.png)


现在，你可以开启或者关闭已有的搜索位置。或者点击添加按钮，添加新的位置。


![添加或移除位置](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224354a5jqy2mm222fqz5d.png)
...
![启用 - 禁用开关](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224355m9tcdu5rqgs9z8zd.png)
...
![在概览中禁用搜索](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224355krvzwp3j7j325p87.png)


在这种情况下，只有应用程序可以进行搜索，搜索结果会被隐藏。


![应用内搜索被禁用状态](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224356bslyst1134qclyj5.png)
...
![Shell 中的 DuckDuckGo 搜索](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224356rfrq2rf9olwan1oz.png)
...
![使用模糊搜索的 GNOME 搜索](https://linuxcn.static.byte.beer/data/attachment/album/202310/10/224357oj8517x790jx2525.png)
