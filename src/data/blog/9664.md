...
pubDatetime: 2018-05-21 08:24:16
description: "使用Jupyter创建动态共享笔记本，集成代码、方程、可视化与文本，实现交互式协作。"
tags: ["Jupyter", "IPython", "笔记"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082420s8r3azrm38op8b1n.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082421dnx6fqqawddisdxq.png)


在右上角有一个标有 “New” 的下拉菜单，它使我能够根据自己的指示和代码快速创建新的笔记本。请注意，我的新笔记本默认为 Python 3，这是我目前的环境。


![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082421kmzvrfqtb9vvnvn6.png)


一个带有一些默认值的新笔记本，它可以被改变（包括笔记本的名字），已打开。


![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082421nqp66yepjym62vgx.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082422vj8ane2zu85op753.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082422j434avlvey0fx7va.png)


我可以通过在命令前追加 `!` 来添加 Bash 命令或脚本的输出。


![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082423enzn3w8snluzl66r.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201805/21/082423lx5f31vj9mzzf1u1.png)
