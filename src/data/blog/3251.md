...
pubDatetime: 2014-06-24 09:00:00
description: "Linux内核编程挑战重重，但也是机遇无限。这不仅仅是一个复杂的C程序，它对所有开发者开放，鼓励阅读、学习与改进。从浮点运算的困难性，到堆栈的限制，乃至并发编程的复杂性，每一个细节都考验着程序员的智慧。向亚瑟C·克拉克学习，以勇气探索内核的深邃，让您的技能在挑战中成长。"
tags: ["内核", "开发", "模块"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201406/24/012730cu0k0hhwcu5w5az0.jpg)
