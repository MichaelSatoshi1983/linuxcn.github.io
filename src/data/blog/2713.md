...
pubDatetime: 2014-03-19 11:31:00
description: "在Linux中使用mkdir命令简便快捷创建目录，执行make directory操作，轻松拓展文件系统组织结构。"
tags: ["Linux", "mkdir", "目录"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113731gzar99fddba09uq3.gif)
...
![mkdir command](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113120i9olvlo35ytq8y51.png)
...
![mkdir directory exist](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113121x32kn1nz58i3zhn8.png)


另外一个创建目录的首要条件是， **在想要创建目录的目标路径下你必须具有访问权限**。当你无法取得权限时 mkdir 会报告这个错误。


![mkdir permission denied](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113122n0yd9y4zmmfmuvff.png)
...
![create multiple directories](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113123mti5fi5e550pwth5.png)
...
![mkdir sub-directory](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113125e1k7hc9wgbwqyjuk.png)
...
![mkdir set privilege](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113126pwxmqw5xxhiwtaih.png)
...
![mkdir verbose](https://linuxcn.img.undefined.today/data/attachment/album/201403/19/113127ar5led790p5u7u0m.png)
