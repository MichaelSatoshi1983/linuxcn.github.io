...
pubDatetime: 2018-06-24 09:19:00
description: "通过灵活的文档存储方式，直接管理数据，省去传统数据库中的底层结构创建、数据规范化等步骤。"
tags: ["MySQL", "JSON"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/091941py6eywfye6fyeeex.jpg)
