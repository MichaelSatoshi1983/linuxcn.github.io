...
![](https://linuxcn.static.byte.beer/data/attachment/album/201907/07/111847v1zx3qk5qqhklyjp.png)
...
![Tig screenshot](https://linuxcn.static.byte.beer/data/attachment/album/201907/07/111922w78yfrcezh09gi18.jpg "Tig screenshot")
...
![Searching Tig](https://linuxcn.static.byte.beer/data/attachment/album/201907/07/111926fdajcz52gczdb8bs.png "Searching Tig")


这些就足以让你浏览你的提交信息了。这里有很多的键绑定，但单击 `h` 将显示“帮助”菜单，你可以在其中发现其导航和命令选项。你还可以使用 `/` 和 `?` 来搜索“帮助”菜单。使用 `q` 退出帮助。


![Tig Help](https://linuxcn.static.byte.beer/data/attachment/album/201907/07/111928z34e4cwe5gi5e8e5.png "Tig Help")
...
![Tig status](https://linuxcn.static.byte.beer/data/attachment/album/201907/07/111934kc99omloqorykps7.png "Tig status")
