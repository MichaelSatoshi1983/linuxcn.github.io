...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154517uqnqdfi79yqidi79.jpg)
...
![installing vlc with apt ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154519drr0ufpauzfzmhdr.png)
...
![list installed packages vlc ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154520fihw24233hgnr8pr.png)
...
![package set manually](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154520np0a3bz0ynjn5jha.png)


可以看到它的状态已经从 `[installed,automatic]` 变成了 `[installed]`。


![listing installed packages with vlc](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154520r16zzrc9kcryihyk.png)


现在，让我删除 VLC 并运行 `autoremove` 命令。你可以看到 `vlc-plugin-base` 不在要删除的软件包列表中。


![autoremove vlc ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154520b6qupdgwvw0xcir6.png)


再次检查已安装软件包的列表。`vlc-plugin-base` 仍然安装在系统上。


![listing installed packages after removing vlc](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154521af9i0iooonnilid8.png)
...
![set package to automatic](https://linuxcn.static.byte.beer/data/attachment/album/202206/05/154521vkjj4rszj1z1kqjj.png)
