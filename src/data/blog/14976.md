...
pubDatetime: 2022-08-28 18:02:25
description: "采用Linux优先策略的应用程序，提供高效、稳定与安全的解决方案。"
tags: ["图像提升"]
---
...
![Linux-First AI Image Upscaler Upscayl Released its First Version](https://linuxcn.img.undefined.today/data/attachment/album/202208/28/180226jam8sfflyysfqzmq.png)
...
![厨房的模糊老照片](https://linuxcn.img.undefined.today/data/attachment/album/202208/28/180227owm665vhv54qzv5q.jpg)
...
![使用 Upscayl](https://linuxcn.img.undefined.today/data/attachment/album/202208/28/180228dszomezhesbqrv2e.png)


这需要相当大的处理能力，但我的 8 核、第 11 代 i7 处理器和 16GB 内存可以轻松应对。


![Upscayl 工作时 CPU 的使用情况](https://linuxcn.img.undefined.today/data/attachment/album/202208/28/180229hq01bq0ntxtut10w.png)


单张图片的处理花了大约 4 分钟，435KB 的图片最终变成了 24MB 的图片。说实话，我几乎没有注意到明显的差异。


![由 Upscayl 放大的图像](https://linuxcn.img.undefined.today/data/attachment/album/202208/28/180230xn9qe9fqyyomewf6.png)
