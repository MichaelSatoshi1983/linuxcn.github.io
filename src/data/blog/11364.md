...
pubDatetime: 2019-09-20 11:34:00
description: "virt-manager提供全面Linux虚拟化管理功能，简化虚拟机创建、配置与管理。"
tags: ["虚拟机"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113434dxbbp3ttmxbhmnnm.jpg)
...
![Virtual Machine Manager's main screen](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113502hmwwmlaaww5ojxm0.png "Virtual Machine Manager's main screen")
...
![Step 1 virtual machine creation](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113503ew9gey9m9gy9k0oq.png "Step 1 virtual machine creation")


在下个页面中，选择要安装的操作系统的 ISO 文件。（RHEL 8 镜像位于我的下载目录中。）Virt-manager 自动检测操作系统。


![Step 2 Choose the ISO File](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113504sntswo8naw8arngq.png "Step 2 Choose the ISO File")


在步骤 3 中，你可以指定虚拟机的内存和 CPU。默认值为内存 1,024MB 和一个 CPU。


![Step 3 Set CPU and Memory](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113505dhehrv0e44747z2v.png "Step 3 Set CPU and Memory")
...
![Step 4 Configure VM Storage](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113507tfipllbzlpvkk299.png "Step 4 Configure VM Storage")
...
![Changing the CPU count](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113508u65xx676zfmomtzs.png "Changing the CPU count")
...
![The Add New Hardware screen](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113510o77sdxy7as5nnsna.png "The Add New Hardware screen")


对 VM 配置感到满意后，单击 “<ruby> 开始安装 <rt>  Begin Installation </rt></ruby>”，系统将启动并开始从 ISO 安装指定的操作系统。


![Begin installing the OS](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113511lbrhiwblh5lrf55b.png)


完成后，它会重新启动，你的新虚拟机就可以使用了。


![Red Hat Enterprise Linux 8 running in VMM](https://linuxcn.img.undefined.today/data/attachment/album/201909/20/113514uk44br4yfogu7gg4.png "Red Hat Enterprise Linux 8 running in VMM")
