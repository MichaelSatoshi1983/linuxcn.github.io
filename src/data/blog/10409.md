...
pubDatetime: 2019-01-02 23:34:00
description: "救援与紧急模式下，挂载所有本地文件系统，启动关键服务。紧急模式则更加精简，不启动任何额外服务。"
tags: ["救援模式", "紧急模式"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/233456h882cm5rw28ynwrm.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/233457hjyzsbrkrv5ygr3r.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/233457bixanaaxo8r3fxo7.png)


添加完成后，只需按下 `CTRL+x` 或 `F10` 即可继续启动救援模式。几秒钟后，你将以 root 用户身份进入救援模式（单用户模式）。以下是 Ubuntu 18.04 LTS 服务器版中救援模式的样子：


![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/233458nbo2sy2k0pdyh1d2.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/234845oh66t6gtwtu4lu3w.png)


添加 `systemd.unit=emergency.target` 后，按下 `Ctrl+x` 或 `F10` 继续启动到紧急模式。


![](https://linuxcn.img.undefined.today/data/attachment/album/201901/02/233459o8g8ff8w8gc3gs80.png)
