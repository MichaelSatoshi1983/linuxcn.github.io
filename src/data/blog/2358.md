...
description: "Linux的ps命令：显示系统进程快照，包含用户ID、CPU、内存使用及命令名等关键信息，非实时更新。"
tags: ["Linux", "命令", "ps", "技巧", "教程", "进程"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201312/10/162330g4qxdqw4izqy3858.png)
