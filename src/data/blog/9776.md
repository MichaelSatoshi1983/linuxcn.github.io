...
pubDatetime: 2018-06-24 21:34:47
description: "命令行审计高效不涉数据库，仅利用已有数据进行操作，确保系统性能不受影响。"
tags: ["命令行", "审计", "数据库"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213451olqt644bmk3ket3l.png)
...
![Tshirt, Keep Calm and Open A Terminal](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213452octytg2ltexeleuf.jpg "Tshirt, Keep Calm and Open A Terminal")
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213452zz2mgmc282mj2jsg.jpg)


现在我可以将这个长长的命令封装成一个 shell 函数，`longest`，它把第一个参数认为是文件名，第二个参数认为是字段号：


![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213453y2pftzl6vlvfmv6m.png)


现在，我可以以函数的方式重新运行这个命令，在另一个文件中的另一个字段中找最长的数据项，而不需要去记忆这个命令是如何写的：


![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213453qlb0dzyixpx77prx.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201806/24/213454yel0elzx66yhyyzg.png)
