...
pubDatetime: 2014-02-06 19:03:00
description: "学习如何在Linux Mint 16中个性化桌面体验，通过安装Moka图标主题，跃升至专业级主题与图标定制。"
tags: ["Linux", "Mint", "主题", "图标", "安装", "技巧"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201404/03/135338bugmlrqpp7mmz02p.jpeg)


现在你可能已经明白为什么我说在 Linux Mint 中的图标更改稍微隐藏了。至少第一眼，你不会找到一个选项来改变图标。只改变图标，选择 **Other settings** 并点击 **Icons**。你会在这里找到所有的图标设置。选择你喜欢的一个。


![](https://linuxcn.img.undefined.today/data/attachment/album/201404/03/135339ws9bie99rjm8ewpc.jpeg)


改变会立即生效，并不需要重启。下面是我的 Linux Mint 使用 Moka 图标主题后的桌面：


![](https://linuxcn.img.undefined.today/data/attachment/album/201404/03/135340vrl992dnd3lnddf1.jpeg)
