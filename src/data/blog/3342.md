...
pubDatetime: 2014-07-08 10:00:00
description: "掌握基础命令，了解Shell，参与CLI星期二系列。今天，探索Linux根文件系统导航。用户目录在/home，存储私有文件，/etc夹存储配置文件。了解存储结构，提升Linux技能。"
tags: ["命令行", "命令行星期二"]
---
...
![Filesys](https://linuxcn.img.undefined.today/data/attachment/album/201407/07/233707ujanspjf9bq77dfa.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201407/07/233559w224vpnrb3s22f45.gif)


想象一下，自己在一个巨大的公寓里面从一个房间走到另一个房间房间，迷路了。 pwd就像面包屑指引着你到你的出发点，这样你就不会在文件夹迷宫里面失去你的方向！


![pwd](https://linuxcn.img.undefined.today/data/attachment/album/201407/07/233709fguylz5yopyfzp44.png)
...
![cd](https://linuxcn.img.undefined.today/data/attachment/album/201407/07/233710hkkogk9kdc69m355.png)
