...
pubDatetime: 2015-07-02 16:33:41
description: "探索Nagios内置脚本监控通用服务（MySQL, Apache, DNS）；跳过主机组与模板配置；运行命令行Nagios服务检测脚本前准备；获取执行指南与文件路径：/usr/lib/nagios/plugins/和/etc/nagios-plugins/config/；执行命令：root@nagios:~# cd /etc/nagios-plugins/config/。"
tags: ["Nagios", "监控"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/02/163344eo0tnj54x3d5odb3.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/02/163346zzfav21gnfn13pfp.jpg)
