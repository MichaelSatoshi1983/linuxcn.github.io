...
pubDatetime: 2016-01-18 10:23:00
description: "Git, 创立于Linus Torvalds, 专为管理大小项目设计, 提供高效分布式版本控制. GitLab, web 基础全功能 Git仓库管理应用, 集代码审查、wiki、问题跟踪于一身, 便捷快速实现代码创建、审查、部署及托管, 支持官方免费代码仓库或自建服务器使用."
tags: ["git", "GitLab"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232900v5neda85uwet0ss8.jpg)
...
![install dependencies gitlab ubuntu debian](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232914ce66d7vkb7hmkb3d.png)
...
![install dependencies gitlab fedora](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232915f7lk5k4jbudcuc22.png)
...
![Downloading Gitlab Ubuntu](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232916n851de7q12kme8qt.png)
...
![Downloading Gitlab Debian](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232916t79abb973poz311p.png)
...
![Downloading Gitlab Fedora](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232917ypl3xiy1uhqxuw7z.png)
...
![Installing Gitlab Ubuntu Debian](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232917qoql8u82om4e2hzn.png)
...
![Installing Gitlab Fedora](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232918g4bkkeznzlymb5yr.png)
...
![Reconfiguring Gitlab](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232918p5sagkaksnkk1esv.png)
...
![Gitlab Login Screen](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232919m8c1lnla90xanzan.png)


现在，为了登录进面板，我们需要点击登录按钮，它将询问我们的用户名和密码。然后我们将输入默认的用户名和密码，即 **root** 和 **5iveL!fe** 。在登录进控制面板后，我们将被强制要求为我们的 GitLab root 用户输入新的密码。


![Setting New Password Gitlab](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232919r0tlngjgf70fqf50.png)
...
![Creating New Projects](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232920pxs6iivl46ffzxf4.png)


接着，我们将被询问给我们的项目输入所需的信息和设定，正如下面展示的那样。我们甚至可以从其他的 git 仓库提供商和仓库中导入我们的项目。


![Creating New Project](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232920s8rsrggg0o5r882g.png)


做完这些后，我们将能够使用任何包含基本 git 命令行的 Git 客户端来访问我们的 Git 仓库。我们可以看到在仓库中进行的任何活动，例如创建一个里程碑，管理问题，合并请求，管理成员，便签，Wiki 等。


![Gitlab Menu](https://linuxcn.img.undefined.today/data/attachment/album/201601/17/232921mlquhi1qlumjz5qv.png)
