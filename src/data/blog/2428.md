...
description: "掌握Ubuntu、Linux Mint及Debian用户解压并重构.deb文件技巧，轻松修改系统配置。"
tags: ["Linux", "Debian", "Ubuntu", "打包", "Deb", "技巧", "教程"]
---

**以下教程将会为Ubuntu、Linux Mint和Debian GUN/Linux用户讲述，如何在它们基于Debian的Linux操作系统上轻松的解压和重新打包.deb文件。**


![](https://linuxcn.img.undefined.today/data/attachment/album/201312/30/2100095l8mokmv52wzp54k.jpg)
