...
![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205244xkk5ilwhk7yt5h77.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205245zpvxpnudxp7e7nie.png)


如果你需要更多信息，输入 `?` 命令来查看文档。对此的更多详细信息，你可以使用 `??` 命令。


![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205245l6gub53b6me75je7.png)


另一个很酷的功能是使用 `!` 字符执行系统 shell 命令的能力。然后可以在 IPython shell 中引用该命令的结果。


![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205245tzarh4ah1wdhvtvh.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205246tahcccaacaobv0hh.png)


当你调用函数或方法时，会自动显示需要的参数和文档字符串。


![](https://linuxcn.static.byte.beer/data/attachment/album/201805/19/205246gafxpokpcpd3doao.png)
