...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174414x08j455m4qdj5r48.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174433y01kd6y2qijjkiki.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174438qygha4tht4wwbhgs.png)
* `netstat -s` 显示每个协议的状态总结。


![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174442ul47727hk1eb4897.png)
* `netstat -i` 显示每个接口传输/接收（TX/RX）包的统计数据。


![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174447bydeo1j1838yw78l.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174454cg0aeoocpene1ee4.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174458as66m3mih663el10.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174508wohjcoakaqaoaw8q.png)
* `ip neighbor` 显示当前的邻接表和用于去添加、改变、或删除新的邻居。


![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174514pyy1lb4ksmybp2u8.png)


![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174517jcs6k8ty6t39m637.png)
* `arp` （它的全称是 “地址解析协议”）类似于 `ip neighbor`。`arp` 映射一个系统的 IP 地址到它相应的 MAC（介质访问控制）地址。


![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174521zpztdlnlpe6ttmfc.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/31/174527ur0sfyr1vfoomo1m.png)
