...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110546fff10ck07e2p0z2f.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110606fmpfzm0f2gkvfobb.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110606a6z06wyve3twn06e.png)


因此，在你想要压缩的磁盘驱动器卷上点击鼠标右键，并在弹出的菜单中选择 <ruby> 压缩卷 <rt>  Shrink </rt></ruby> 选项。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110606m65o66y1k2j5yiif.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110607hzkuyui8didozziz.png)


在缩小磁盘空间后，它将显示为 <ruby> 未分配 <rt>  Unallocated </rt></ruby> 或 <ruby> 可用空间 <rt>  Free Space </rt></ruby>，如图所示。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110607n7ne65wcm59z5m6p.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110607ugqlqwtugk1girzl.png)


Ubuntu 22.04 将开始加载，如下所示。这最多需要一分钟。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110607uwlf222o2onlnjr2.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110608lvrkrkkkbb9bkh09.png)


接下来，选择你的首选键盘布局，并单击 <ruby> 继续 <rt>  Continue </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110608f0txnc0mxtcxmohf.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110608m3dbuzlqllyxbqly.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110608yagsnljf6sf6ynvz.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110609cfhzcbg8oxg82sxo.png)


如图显示填写 `/boot` 分区的详细信息，然后单击 <ruby> 确定 <rt>  OK </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110609lcg6vc7xkezk7bkk.png)


接下来，具体指定 `/home` 分区，并单击 <ruby> 确定 <rt>  OK </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110609ytdro6lbg3glbgfg.png)


接下来，定义 `/`（根）分区，并单击 <ruby> 确定 <rt>  OK </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110609kksq1j24zyno2ksy.png)


为定义交换空间，设置大小，并在 <ruby> 使用为 <rt>  Use as </rt></ruby>：选项中选择 <ruby> 交换区域 <rt>  Swap area </rt></ruby>。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110610a34ztwodo81o01zq.png)


最后，如果你正在使用 UEFI 启动模式，那么创建一个 EFI 系统分区。我们将分配 300MB 到 EFI 分区。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110610uxfdex7fl01x184h.png)


下图是一份我们的分区表的分区摘要：


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110611l66tzpjzb969ttv9.png)


为继续安装，单击 <ruby> 现在安装 <rt>  Install Now </rt></ruby>。在下图显示的弹出窗口中，单击 <ruby> 继续 <rt>  Continue </rt></ruby>来保存更改到磁盘。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110611a4kck5vvv14jiq46.png)


接下来，安装程序向导将自动侦测出你的位置，只需要单击 <ruby> 继续 <rt>  Continue </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110611wqtz40oq6mwmjmwg.png)


接下来，通过具体指定姓名、计算机的名称和密码来创建一个登录用户。接下来单击 <ruby> 继续 <rt>  Continue </rt></ruby> 按钮。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110612wtwhyrcee4itczlr.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110612lrr1p1ndanndxrid.png)


在安装过程完成后，单击 <ruby> 立刻重新启动 <rt>  Restart Now </rt></ruby> 按钮来重新启动系统。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110612sd2v6cy8aa6tat68.png)


在这时，移除你的可启动 USB 驱动器，并按下回车键。


![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110612wkqfkadzx0aakqke.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/12/110613b55p3yh3bnprc8y8.png)
