...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/18/170815hfrcdfd4lltd737z.jpg)
...
![Screenshot of terminal showing the options for tmate sharing: web session (regular and read-only) and ssh session (regular and read-only)](https://linuxcn.static.byte.beer/data/attachment/album/202206/18/170821ka5cs5n8e9fabf89.png)
...
![Screenshot showing tmate terminal window and 2 versions of sharing sessions demonstrating the same code](https://linuxcn.static.byte.beer/data/attachment/album/202206/18/170822azu4qnddr45dc4xu.png)
...
![A screenshot of the terminal showing the output after using the new-session and -F options: connection information for either a web session (regular or read-only) or ssh session (regular or read-only)](https://linuxcn.static.byte.beer/data/attachment/album/202206/18/170822yh1qfnnnhnfv9h11.png)
