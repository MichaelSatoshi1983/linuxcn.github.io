...
pubDatetime: 2018-08-19 21:59:00
description: "基于Go语言中切片的特性，巧妙用作栈实现，详细解读其底层运作，分享技术洞见与实践。"
tags: ["Golang", "切片"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201808/19/215935hm6cc01zr0ickppc.jpg)
...
语句 `b := a` 定义了一个类型是 `[5]int` 的新变量 `b`，然后把 `a` 中的内容 *复制* 到 `b` 中。改变 `b` 对 `a` 中的内容没有影响，因为 `a` 和 `b` 是相互独立的值。<sup id="fnref1"> <a href="#fn1" rel="footnote">  1 </a></sup>
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201808/19/215957yqhveimh59ro9mz9.png)
