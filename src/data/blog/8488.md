...
![](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082705awkyywiddmllikiz.jpg)
...
![在 Ubuntu 16.04 上安装 Java OpenJDK 7](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082935ycvptkobpap1kczp.png)
...
![已经将 Jenkins 安装到 8080 端口](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082936nz9x3tp3t5lt3tlp.png)
...
![检查 Apache 和 Jenkins 是否在运行](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082936kflul7x2apz24fyg.png)
...
![获取 Jenkins 管理员密码](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082937w15csssj5irjas1k.png)


将结果粘贴到密码框然后点击 Continue。


![安装和配置 Jenkins](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082937kqa85rqfq8g057m4.png)


现在为了后面能比较好的使用，我们需要在 Jenkins 中安装一些插件。选择 Install Suggested Plugin，点击它。


![安装 Jenkins 插件](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082937suee44ve39nugzxz.png)


Jenkins 插件安装过程：


![Jenkins 安装完插件](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082938w8tuwj49vjvjhwjw.png)


安装完插件后，我们需要创建一个新的管理员密码。输入你的管理员用户名、密码、电子邮件等，然后点击 ‘Save and Finish’。


![创建 Jenkins 管理员账户](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082938xgup9kw27zdrrgku.png)


点击 start 开始使用 Jenkins。你会被重定向到 Jenkins 管理员面板。


![重定向到管理员面板](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082938i2pwpd5m715t1kdt.png)


成功完成 Jenkins 安装和配置。


![Jenkins 管理员面板](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082939lllbnfo6q8zimdiq.png)
...
![Jenkins 全局安全设置](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082939i0pfgt28v9opu3zg.png)
...
![配置 Jenkins 权限](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082940imizr93mamzqqy5f.png)
...
![在 Jenkins 中创建新的任务](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082940cuvm06ut2mcv4t7s.png)


输入任务的名称，在这里我输入 ‘Checking System’，选择 Freestyle Project 然后点击 OK。


![配置 Jenkins 任务](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082940qzb6ggxb33686tt1.png)
...
![启动 Jenkins 任务](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082941lbtzihp8cfnfjxpu.png)
...
![构建和运行 Jenkins 任务](https://linuxcn.static.byte.beer/data/attachment/album/201705/08/082941f32l7yefw35yyooj.png)
