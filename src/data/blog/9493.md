...
pubDatetime: 2018-03-29 12:59:54
description: "探索vi/vim、nano与emacs，本文详解三种命令行高效文件编辑方法，助您提升终端操作技能。"
tags: ["编辑器"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/125951j1hzg8sd36hosws4.jpg)
...
![Nano 命令行编辑器](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/125956w2cosbvuahxlvdvb.png)
...
![在 nano 中打开文件](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/125957jux9prajr4fiaffr.png)
...
![在 nano 中保存文件](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/125959galu5oo3jvuf24lu.png)


注意，在这个阶段，您有一个选项，可以保存不同的系统格式。键入 `Alt+D` 选择 DOS 格式，`Atl+M` 选择 Mac 格式。


![以 DOS 格式保存文件](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130000zaowbhv55ocb5c5a.png)


敲回车保存更改。


![文件已经被保存](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130001nzggxzbcbnwx0nbx.png)
...
![使用 nano 在文件中搜索](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130002i6fa33k25u9um906.png)
...
![在 emacs 中打开文件](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130003jm6mri6xvjmsq666.png)
...
![emascs 中保存文件](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130005mvsvzd5x5fxa3srz.png)


现在，如果您放弃修改并且退出时，在 `Ctrl+x` 之后键入`Ctrl+c`。编辑器将会立即询问，如下图：


![emacs 中抛弃修改](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130007tmlwz22qq2ywx38p.png)
...
![使用 emacs 在文件中搜索](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130008kq9mmiiroh3i5vo8.png)


继续，使用 `Alt+Shift+%` 执行替换操作。您将被询问要替换单词。回复并回车。之后编辑器将会询问您是否替换。例如，下方截图展示了 `emacs` 询问使用者关于单词 ‘This’ 的替换操作。


![使用 emacs 替换单词](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130009igxu9g994xmn1d12.png)


输入替换文本并回车。每一个替换操作 `emacs` 都会等待询问，下面是首次询问：


![确定文本替换](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130010fozfz11kcoktt8fq.png)


键入 `y` 之后，单词将会被替换。


![键入 y 确定操作](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130011i3u7p87l45llzcvm.png)


这些就是几乎所有的基础操作，您在开始使用 `emacs` 时需要了解掌握的。对了，我们忘记讨论如何访问顶部菜单，其实这些可以通过使用 `F10` 访问它们。


![基础编辑器操作](https://linuxcn.img.undefined.today/data/attachment/album/201803/29/130012gqfd9mxmnddsgd9u.png)
