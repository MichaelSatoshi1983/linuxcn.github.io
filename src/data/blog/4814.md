...
pubDatetime: 2015-02-04 07:11:00
description: "解压tar文件到指定目录，使用Linux或类Unix系统命令：tar -xf file.name.tar -C /path/to/directory。示例：tar -xf $HOME/etc.backup.tar -C /tmp/data。"
tags: ["tar", "解压"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201502/03/221358gzjbez0riq87ptpq.png)
...
![Gif 01: tar Command Extract Archive To Different Directory Command](https://linuxcn.img.undefined.today/data/attachment/album/201502/03/221419v9v9dus0s955ucu0.gif)
