...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/15/124434vfv2bojtobboovwg.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/15/124435l7v4p99mp8l4kz76.png)
...
[Lector](https://github.com/BasioMeusPuga/Lector) 是一个简单的电子书阅读器程序。Lector 支持最常见的电子书格式，如 EPUB、MOBI 和 AZW，以及漫画书格式 CBZ 和 CBR。它很容易设置 —— 只需指定包含电子书的目录即可。你可以使用表格或书籍封面浏览 Lector 库内的书籍。Lector 的功能包括书签、用户自定义标签和内置字典。![](https://linuxcn.static.byte.beer/data/attachment/album/201807/15/124435uaxxhbqu3o2iuoiu.png)
...
Ranerger 是一个基于文本的文件管理器，它带有 Vim 键绑定。它以三列显示目录结构。左边显示父目录，中间显示当前目录的内容，右边显示所选文件或目录的预览。对于文本文件，Ranger 将文件的实际内容作为预览。![](https://linuxcn.static.byte.beer/data/attachment/album/201807/15/124435gx2f1qiivil8liig.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201807/15/124436myb910aupvppjsty.png)
