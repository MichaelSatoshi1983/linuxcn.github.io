...
pubDatetime: 2015-03-26 07:21:00
description: "Ramlog系统守护进程于启动时创建虚拟磁盘，复制/var/log内容，所有日志更新至虚拟盘。重启或停止时，变更暂存/var/log.hdd；关机时，虚拟盘日志完整保存至硬盘，确保一致性。支持tmpfs、ramfs及内核ramdisk，利用rsync同步日志。警惕：突发断电或内核崩溃影响数据安全。"
tags: ["ramlog", "日志", "内存"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201503/24/162817udy63cdzf2jyld7a.png)
