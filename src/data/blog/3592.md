...
pubDatetime: 2014-08-14 07:00:00
description: "echo命令，内建shell工具，显示变量值或文本。关键用法：`echo`无输入输出空白行，有输入则打印。支持`-n`防换行，`-e`启用/`-E`禁用转义解释。灵活构建shell脚本。"
tags: ["echo", "命令"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201408/13/002548cey7ufu2fq968m8e.png)
