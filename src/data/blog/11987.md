...
![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115531iuuw57udntwcdv2w.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115535e0v0wqnn5x50w62r.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115537zetu5e1t5iwp85dd.png)
...
![Select interface](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115540wprooaftzo8l39nz.jpg)


例如，我只列出了**有线**网络接口。


![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115542aiddliilletd3izx.jpg)


接下来，要开始捕获数据包，你必须选择接口（在我的示例中是 `ens33` ），然后单击“Start capturing packets”图标，如下图所示。


![Start capturing packets with Wireshark](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115544uxcek5e5knxekeun.jpg)


你还可以同时从多个接口捕获数据包。只需按住 `CTRL` 按钮，同时单击要捕获的接口，然后点击“Start capturing packets”图标，如下图所示。


![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115545zs8pqaup3t9rro8r.jpg)


接下来，我尝试在终端中使用 `ping google.com` 命令，如你所见，捕获了许多数据包。


![Captured packets](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115548eiyixoj8emk8glhm.jpg)


现在你可以选择任何数据包来检查该特定数据包。在点击一个特定的包之后，你可以看到与它相关的 TCP/IP 协议的不同层的信息。


![Packet info](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115550arsmqmwp2rxvw26u.png)


你还可以在底部看到该特定数据包的原始数据，如下图所示。


![Check RAW data in the captured packets](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115554n5704o7qqa071smm.png)
...
![Stop packet capture in Wireshark](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115559yo00jd5dflrvafw5.png)
...
![Save captured packets by Wireshark](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115602hk5na15uykknbwek.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115605w6nimr6r0xa0sb7a.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202003/12/115607eccpcpcc0wwzk0bu.png)
