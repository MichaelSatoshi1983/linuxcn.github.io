...
![](https://linuxcn.static.byte.beer/data/attachment/album/202002/09/104113w1ytjmlv1jly0j1t.jpg)
...
![/r/emacs in Tuir](https://linuxcn.static.byte.beer/data/attachment/album/202002/09/104140dzsgra6ngzdqqg8d.png "/r/emacs in Tuir")
...
![Filtering by Reddit's "top" category](https://linuxcn.static.byte.beer/data/attachment/album/202002/09/104151rzne3n6o6p34erej.png "Filtering by Reddit's \"top\" category")


你可以使用箭头键或 `j`、`k`、`h` 和 `l` 键浏览列表，这与 Vi/Vim 使用的键相同。底部栏有用于应用导航的命令。如果要跳转到另一个子板，只需按 `/` 键打开提示，然后输入你要进入的子板名称。


![Logging in](https://linuxcn.static.byte.beer/data/attachment/album/202002/09/104158ni3uik25i9wowow5.png "Logging in")
