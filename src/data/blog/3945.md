...
pubDatetime: 2014-10-03 08:02:00
description: "精通Unix文本处理基础，发现awk作为文本处理利器的广泛用途。简言之，awk是将数据划分为字段的强大工具，可辅助Linux系统管理员高效处理文本。通过$1命令选择输入的第一字段仅是其众多功能之一。"
tags: ["awk"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201410/02/220752yr1mmmme1n8mt1n6.jpg)
