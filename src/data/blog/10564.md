...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225829gev45x8esm5rvap5.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225852ntahahrz8li1gwvc.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225904o1eqhoz64rvehkyh.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225915p20r1n26xymhppc2.png)


这跟运行命令 `git diff custom_functions.org` 类似。储藏文件更简单。只需要移动光标到文件上然后按下 `s` 键。该文件就会迅速移动到已储藏文件列表中：


![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225927hlw0ir4elq3sql44.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225937y62gu1tbobbz6y3y.png)


将光标移动到想要启用签名标志的行，然后按下回车。`--signoff` 文本会变成高亮，这说明该标志已经被启用。


![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/225955cznnyy62yttyy6yo.png)


再次按下 `c` 键会显示一个窗口供你输入提交信息。


![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/230005ys8viu8jjj008hoz.png)


最后，使用 `C-c C-c`(按键 `Ctrl+cc` 的缩写形式) 来提交更改。


![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/230016d8rg8c3zme0dm8d8.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201902/23/230028opz99jqd6oxd9lt9.png)
