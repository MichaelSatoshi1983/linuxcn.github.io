...
pubDatetime: 2014-05-21 22:02:07
description: "了解UMASK在Linux中如何设定新文件夹权限，推荐全新用户深入阅读。UMASK代表用户文件创建掩码，影响新文件默认权限。教程详述八进制值设定方法：0(rwx), 1(rw-), 2(r-x), 3(r--), 4(-wx), 5(-w-), 6(仅可执行)，助您个性化权限配置。"
tags: ["umask"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201405/21/220211ggfaw4rux2fuvc9y.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201405/21/220214i3dzx3hx595mdquk.jpg)
