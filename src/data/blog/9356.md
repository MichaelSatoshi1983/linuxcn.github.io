...
![](https://linuxcn.static.byte.beer/data/attachment/album/201802/17/124700v1sssrbsovwoe18y.jpg)
...
[![How to make sure parent directories (if non-existent) are created](https://linuxcn.static.byte.beer/data/attachment/album/201802/17/124712ke4vbazwtebta4eb.png)](https://www.howtoforge.com/images/command-tutorial/big/mkdir-p.png)
...
[![How to set permissions for directory being created](https://linuxcn.static.byte.beer/data/attachment/album/201802/17/124715j7jd9jt9jzc95vth.png)](https://www.howtoforge.com/images/command-tutorial/big/mkdir-def-perm.png)


但是，如果你想自定义权限，那么你可以使用 `-m` 这一命令行选项。


[![mkdir -m command option](https://linuxcn.static.byte.beer/data/attachment/album/201802/17/124716pqzvq22qyxqqytcq.png)](https://www.howtoforge.com/images/command-tutorial/big/mkdir-custom-perm.png)
...
[![How to make mkdir emit details of operation](https://linuxcn.static.byte.beer/data/attachment/album/201802/17/124719w9sdmccbhmbuw2hv.png)](https://www.howtoforge.com/images/command-tutorial/big/mkdir-verbose.png)
