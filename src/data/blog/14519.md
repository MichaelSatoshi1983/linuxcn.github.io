...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160106isue6ya6hhlwy7wq.jpg)
...
* 选择下面显示的 “<ruby> 驱动器 <rt>  Drives </rt></ruby>”，然后分区并格式化一个空白的存储设备 ![Cockpit Storage management](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160106czrmwcovwpwvqjmm.png)
* 在选定的存储设备这个界面上，创建一个新的分区表或者格式化并创建新的分区。当初始化磁盘的时候，在 “<ruby> Partitioning <rt>  分区 </rt></ruby>” 类型选项上，选择 “GPT 分区表”
* 选择一个文件系统类型，这里选择 “EXT4” 。这对于一个限制 I/O 能力（比如 USB 2.0 接口）和限制带宽（小于 200MB/s）的设备是适合的 ![Create a partition in Cockpit](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160107veiva32kf357b9a2.png)
...
![Backup workflow – version 1.0](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160107z2bh4guccpe4quzp.jpg)
...
![Backing up to the secondary cloud](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160107makklr1zglagrlj9.png)


![Restoring files from cloud storage](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160108nnnjnf2jsf2n119v.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160108imp1i8c7pfiixxcx.png)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160108yhykm2y7mpa7ay7n.png)
...
![SELinux logs](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160109wye640h965fnge2e.png)
...
![Storage logs in Cockpit](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160109wkihzsv7g5j5jxpe.png)
...
![Software updates](https://linuxcn.static.byte.beer/data/attachment/album/202204/28/160109vmsogoq0wou7vg3j.png)
