...
pubDatetime: 2014-05-30 09:30:00
description: "升级至Ubuntu 14.04后，确保系统安全通过使用内置Dj Dup Backup Tool进行备份，支持本地及远程存储。多种外接工具如Dropbox客户端、UbuntuOne（已停用）及Box，助力自动备份关键文档，保障数据安全。"
tags: []
---
...
![ubuntu1404-backup](https://linuxcn.img.undefined.today/data/attachment/album/201405/29/232037qjlppmbvmml0p300.png)


接下来，选择备份的文件夹(即保存)，忽略的文件夹，以及在哪里保存备份。位置是我们要首先设置的。对于存储位置，我们选择**WebDAV** 。接下来输入服务器地址(如下所示), 文件夹应该是/dav/，并输入你的Box用户名。


![ubuntu1404-backup-1](https://linuxcn.img.undefined.today/data/attachment/album/201405/29/232037vqq7q12x8qwxbobx.png)


回到概况，选择**立即备份**。


![ubuntu1404-backup-2](https://linuxcn.img.undefined.today/data/attachment/album/201405/29/232038slyll7qb3yh3qy33.png)


你会被要求输入密码。输入后继续。


![ubuntu1404-backup-3](https://linuxcn.img.undefined.today/data/attachment/album/201405/29/232038b64zvvzt9bz4ihbu.png)
...
![ubuntu1404-backup-4](https://linuxcn.img.undefined.today/data/attachment/album/201405/29/232038qxcrtigttcca1wgh.png)
