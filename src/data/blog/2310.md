...
pubDatetime: 2013-11-28 15:21:00
description: "在Linux控制台，使用'uname'命令便捷获取系统信息，无需鼠标右键操作。"
tags: ["uname", "命令", "Linux", "操作系统", "信息", "技巧", "教程"]
---

当你在控制台模式下，无法通过“鼠标右键 > 关于”获取操作系统的信息。这时，在Linux下，你可以使用**uname**命令，帮助你完成这些工作。 Uname是**unix name**的缩写。在控制台中实际使用的时候只需键入**uname**。


![](https://linuxcn.img.undefined.today/data/attachment/album/201311/28/133107waaiialkaazaaa0u.png)
