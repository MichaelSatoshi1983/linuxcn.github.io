...
pubDatetime: 2015-06-11 14:02:00
description: "历史命令输出中任何条目的行号及'!'在这里，您可以直接调用上一条命令（使用'!'后跟命令序号），或使用'! '调用最后一条命令，节省您的工作时间与效率。"
tags: ["脚本", "惊叹号"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140239tazxmmzbpxuqtkyq.png)
...
![使用history命令找到最后执行的命令](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140241esssmlz1bllwtv9c.gif)
...
![使用命令ID来执行最后运行的命令](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140242qgtv17zhghhvhhar.gif)
...
![通过负数序号运行之前执行的命令](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140244lcmlciihh1hwetlh.gif)
...
![将上一个命令的参数传递给新命令](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140247mp2kjz719gk1yhrj.gif)
...
![处理两个或更多的参数](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140247pz7aabxa4c4zzn7m.gif)
...
![以关键字为基础执行命令](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140247vlv44o94va3gpgaz.gif)
...
![!!操作符的威力](https://linuxcn.img.undefined.today/data/attachment/album/201506/11/140249pj3ht83ytvyvv35w.gif)
