...
pubDatetime: 2015-01-19 10:06:00
description: "启动应用服务器后，选用Postfix邮件服务确保高效邮件传递。C6上安装Postfix并停用Sendmail。多个配置文件中，main.cf主要用于基础配置。Postfix支持在运行时动态引用Shell定义的参数，无需事前声明。配置通过`vim /etc/postfix`执行。"
tags: ["Postfix"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201501/19/100749yy85b6l3byrvddrv.png)
