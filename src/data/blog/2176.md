...
pubDatetime: 2013-10-27 23:49:00
description: "了解如何在Ubuntu中使用权限管理，仅授权用户可见home文件夹内容。通过adduser命令创建的用户目录默认所有人可见，需调整权限确保安全。掌握这一技术，保护个人数据不再无谓暴露。"
tags: ["Linux", "Ubuntu", "技巧", "保护", "Home", "文件夹", "教程"]
---
...
使用被加密的账号第一次登录后，你将会看到如下截图的界面，包含更多关于加密home文件夹的信息。
 ...
 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/27/230357kasscm4sjyams3c4.png)
