...
pubDatetime: 2014-06-16 12:55:00
description: "使用bash getopts函数简化交互式脚本命令行参数处理，添加功能函数与纯文本帮助，构建高效脚本模板。"
tags: ["bash", "脚本", "shell"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201406/16/144459khrh6o1s7m1kmjl4.png)
