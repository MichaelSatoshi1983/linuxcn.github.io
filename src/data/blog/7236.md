...
pubDatetime: 2016-04-17 08:32:41
description: "Drone 自由开源，提供卓越持续集成环境，集成广泛代码库提供商，包括 Github、Bitbucket 和 Google Code。"
tags: ["持续集成", "CI", "Drone"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083233byu0ug1w081fkf12.jpg)
...
![Registering App Github](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083244l2z4422ffnuqjjqq.png)


要创建一个应用，我们需要在 `New Application` 页面点击 `Register`，然后如下所示填表。


![Registering OAuth app github](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083244iez3myymmmtmmmgb.png)
...
![Client ID and Secret Token](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083245t812jriyt188zgtz.png)
...
![Configuring Github Drone](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083246eqoauwqoemeeinut.png)
...
![Configuring SMTP Drone](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083246piirni6676p1ippr.png)
...
![Login Github Drone](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083246snkpvi67kxvxk8il.png)


因为在上面的步骤里配置了 Github，我们现在只需要简单的选择 github 然后进入应用授权步骤，这些完成后我们就可以进入工作台了。


![Drone Dashboard](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083247h9unlpl55zl99pu1.png)


这里它会同步我们在 github 上的代码库，然后询问我们要在 drone 上构建那个代码库。


![Activate Repository](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083247kawasxc5qqwhz3a5.png)
...
![Building Application Drone](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083248drz8o8005ht1oa85.png)


所有操作都完成后，我们就能在终端看到构建的结果了。


![Build Success Drone](https://linuxcn.img.undefined.today/data/attachment/album/201604/17/083248gug4esx0rbworp32.png)
