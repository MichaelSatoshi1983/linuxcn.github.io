...
pubDatetime: 2015-04-03 07:19:00
description: "原文中描述的要点是：C语言的数据类型与控制结构因多被直接支持，故实现自包含程序所需运行库文件小。确实有不直接被支持的数据类型，如大多数嵌入式系统中无浮点运算单元，C中float操作还原生支持不全，处理浮点运算时需额外注意。"
tags: ["C语言", "数据类型"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/02/220038aewq0e5z640nlwl0.jpg)
