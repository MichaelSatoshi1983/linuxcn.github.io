...
pubDatetime: 2021-09-16 12:37:00
description: "选择合适镜像简化Debian安装过程，确保高效、安全的系统部署体验。"
tags: ["Debian"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123647x9uz7zjjqrq0qwkk.jpg)
...
![对于新用户来说，从默认的 ISO 中安装 Debian 是有问题的](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123706khb2clqhh2bec26f.png)
...
![下载非自由版的临场 Debian ISO](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123707nu46mr2tlm2bk2s6.png)
...
![用 Etcher 创建 Debian 的临场 USB 盘](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123710bajfvmfqf3qzgfyo.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123710v7nj366aa1v6k7ea.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123712lc999hhhi6cwc96v.jpg)


一会儿就会看到如下图的显示界面，选择第一个选项。


![Debian 启动界面](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123713bpqa13zkr144krvp.png)
...
![Debian 临场欢迎界面](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123715zv1frff0nhrhwi88.png)


欢迎界面之后，按下 `Windows` / `Super` 键进入活动区。你应该可以看到 Debian 的安装按钮。


![开始安装 Debian](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124105c3oobfpjf3ek3061.jpg)


它会打开一个友好的 [Calamares 图形安装器](https://calamares.io/)。从这里开始事情就比较简单了，


![Debian 11 Calamares 图形安装器](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123717b44574nu75ewnuqs.png)


它会让你选择你的地理位置和时区。


![选择你的地理位置和时区](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124139wonwbwqwyjyzp5wz.jpg)


下一个界面，会让你选择键盘类型。这儿请 **注意**。你的键盘会根据你所选的位置自动选择。例如，我的位置是印度，它会自动默认选择印度键盘和印地语。我需要将其改为印度英语。


![选择键盘类型](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124153hjejgnapdhj8dl1l.jpg)
...
![磁盘分区](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123719okurr9u3orgsmmmm.png)
...
![设置用户名和密码](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123720m9k8fcfeewwrlpfk.png)
...
![安装配置的汇总信息](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124221muud66wxusuwtlmt.jpg)


现在只需要等待安装完成。


![安装 Debian](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123723t0rhk7y800y0q8ru.png)


几分钟后就会完成安装。当安装完成，它会提示重启。


![完成 Debian 安装](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/123724o61b39xt9xel8t9j.png)


重启系统后如果一切顺利，你应该可以看到 Debian 的 GRUB 界面。


![Debian 启动画面](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/202109/16/124247mlnxuus7xbvbnxsy.jpg)
...
![增加新的启动选项](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124311tj8m2dzj7n5tjz4m.jpg)


它会提供一个增加 EFI 文件的选项。


![选择 EFI 文件](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124446hnswvnia6fjakifv.jpg)


由于在安装过程中 Debian 创建了 ESP 分区，因此一个包含必要文件的 `EFI` 目录已经创建好了。


![选择 EFI 目录](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124500cc3l97jaanjm7o0l.jpg)


它会显示一个 `Debian` 目录及其他目录。选择 `Debian` 目录。


![选择 Debian 目录](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124520skpcestkstcezfub.jpg)


在 `Debian` 目录，你将看到 `grubx64.efi`、`shimx64.efi` 等文件。请选择 `shimx64.efi`。


![选择 shimx64.efi](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124546q8p8lwphncau8iwz.jpg)


你需要给这个文件一个合适的名字。最后的界面应该如下:


![增加 efi 文件的新启动选项](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124605eaxkochfcxq1hqax.jpg)


现在你应该有了这个启动选项。因为我命名为 `Debian`，它显示了两个 `Debian` 引导选项（我猜其中一个是从 efi 文件来的）。按下 `F10` 保存退出 BIOS 的配置。


![新增的启动选项](https://linuxcn.img.undefined.today/data/attachment/album/202109/16/124807u87eyj54qrr8oyi4.jpg)


现在启动你的系统，你可以看到带有 Debian 启动选项的 GRUB 界面了。你现在可以体验 Debian 了。


![](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/202109/16/124247mlnxuus7xbvbnxsy.jpg)
