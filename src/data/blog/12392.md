...
![](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/224752iib7xgh7icr8478f.jpg)
...
![Prerequisites for a solid development process](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/224842j18g88t8ptlt8z3m.png "Prerequisites for a solid development process")
...
![5% about products, 15% about process, 80% about people](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/224912njddunhzhyuayzyd.png "5% about products, 15% about process, 80% about people")
...
![Improving quality and visibility of pipelines](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/224923qy3odty04g4yzn5g.png "Improving quality and visibility of pipelines")
...
![CI build/CD release pipeline](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/224942byvjt49x94zqjfhh.png "CI build/CD release pipeline")
...
![Breaking down the CI build pipeline](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225011ee1vpjlv1r1hjwrr.png "Breaking down the CI build pipeline")
...
![Breaking down the CD release pipeline](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225030gxma3a66the4ewem.png "Breaking down the CD release pipeline")


不要使用构建转换来生成多个特定环境的构建。通过一个构建实现*发布时转换*、*标记化*和 XML/JSON 的*值替换*。换句话说，*右移滞后*具体环境的配置。


![Shift-right the environment-specific configuration](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225047zi8z8pgf3sfr8nss.png "Shift-right the environment-specific configuration")


安全存储发布配置数据，并且根据数据的*信任度*和*敏感度*，让开发和运维都能使用。使用开源的密钥管理工具、Azure 密钥保险库、AWS 密钥管理服务或者其他产品，记住你的工具箱中有很多方便的工具。


![Dev-QA-production pipeline](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225059w67gtmnw8mf7yrv8.png "Dev-QA-production pipeline")


使用*用户组*而不是*用户*，将审批人管理从跨多个流水线的多个阶段移动到简单的组成员。


![Move approver management to simple group membership](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225128qst8gs1tsb05eez6.png "Move approver management to simple group membership")


创建一条流水线并且对赋予特定的交付阶段的权限，而不是重复流水线让团队进入他们感兴趣的地方。


![Pipeline with access to specific delivery stages](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225144jf5inb5sktyk0bgi.png "Pipeline with access to specific delivery stages")
...
![The full pipeline](https://linuxcn.static.byte.beer/data/attachment/album/202007/07/225211c6x1o9b0lapz2a49.png "The full pipeline")
