...
![](https://linuxcn.static.byte.beer/data/attachment/album/202007/19/110018bl392bj3g3g41a23.jpg)
...
![](https://linuxcn.static.byte.beer/data/attachment/album/202007/19/110445g5z2rorc3ww353bo.png)


当登录 shell 正常退出时，如果 `~/.bash_logout` 和 `/etc/bash_logout` 存在，它们会被调用。下一幅图展示了 Bash 作为交互式 shell 启动时的过程。例如，当用户从桌面环境打开终端模拟器时，会按照以下顺序进行。


![](https://linuxcn.static.byte.beer/data/attachment/album/202007/19/110446i6mynysngyinoz5y.png)
