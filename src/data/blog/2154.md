...
description: "FreeBSD 10.0 Beta 1，一款支持多架构的开源操作系统，现已发布，备受欢迎。"
tags: ["FreeBSD", "操作系统", "Linux", "测试"]
---

**FreeBSD 10.0 Beta 1, 一个可以运行在x86, ARM, IA-64, PowerPC, PC-98, and UltraSPARC 等架构上的操作系统, 已经发布并且可供下载测试。**


 ![](https://linuxcn.img.undefined.today/data/attachment/album/201310/23/2130383fgk0gpputzuljf0.png)
