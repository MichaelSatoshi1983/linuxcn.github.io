...
![](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111057e0ol09ja0q6wlnej.jpg)
...
![The logo of the Ink/Stitch project](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111101ibxlkejgg6uo1g8x.png)
...
![Inkscape with the swatches dialogue open, which shows the Madeira Rayon color palette](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111101hw2zexmbfwbmn8xi.png)
...
![Inkscape with a “Chopin” glyph for satin stitching defined for the Lettering function](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111102gkbv45xkw54zctkv.png)
...
![On the left side the Lettering dialogue and on the right the preview of this settings](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111103gztn5shtjtwjtn88.png)
...
![The new Fedora logo as Stitch Plan Preview](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111104tzkvnnd4pnojweep.png)
...
![Nicubunu’s Fedora hat icon as embroidery. The angles for the stitches of the head part and the brim are different so that it looks more realistic. The outline is done in Satin stitching](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111105ax1e9sd1kxlt4q7e.gif)
...
![Parameter setting dialogue and on the right the Fedora logo shape embroidered as Zig-Zag line](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111105mkykk9oi44xoubex.png)
...
![Fedora logo shape as Satin Line embroidery](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111106d5dc2i7p78apzxzx.png)
...
![A running stitch – each dashed line will be converted in such one](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111107sstx3xmo3epmec93.jpg)
* **豆针**：豆针可用于边缘装饰或添加设计细节。使用平针来回缝制就是豆针，这种缝法会增加线迹的厚度。


![Bean Stitches – creating a thicker line](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111107eifyv4iritriksv7.jpg)
* **手工针**：在该模式下，Ink/Stitch 会将路径的每个节点当作穿针点；这些节点也正是针穿入的位置。


![In manual mode – each node will be the needle penetration point](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111107lw0lqew0pfsa0ac9.png)
* **E 字针**：E 字针是一种简单但十分好用的绷缝线迹，用于贴花织物。这种线迹多用于婴儿装，因为婴儿的皮肤比较敏感。


![E-Stitch mostly used for applications on baby cloths, soft but strong connection](https://linuxcn.static.byte.beer/data/attachment/album/202208/16/111107wpfmje2f2suzgj5f.jpg)
