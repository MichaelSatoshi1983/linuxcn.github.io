...
pubDatetime: 2021-01-12 09:49:00
description: "掌握Linux技巧，轻松高效完成任务。针对中高级用户，运用一行命令或脚本快速解决。帮助新手理解复杂命令，提升Linux操作效率。"
tags: ["TLDR"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094925yu3e0nn3qt00oo4c.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094927avcofk9dkg84kvcv.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094928wdydwji5jcscljw6.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094930kagkxac1xzcqxgnd.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094931jc70ox0m3b7t6ct5.png)


从列表中选择任意示例命令并按回车键。在选定的命令前会看到一个 `*` 符号。例如，我选择第一个命令即 `sudo apt update`。现在，它会问你是否继续。如果命令正确，只需键入 `y` 继续，并输入 `sudo` 密码运行所选命令。


![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094933a0gsi3rxewoje448.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094935hvh5s757777yyi55.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094936j585bk9xk4bb0533.png)


然后将要求你确认该命令是否正确。如果命令正确，只需键入 `yes` 或 `y` 就可以开始下载文件。


![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094938vmcxjxj9zm7ygvko.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094939tu8pctupe8cpebv8.png)


现在，系统将提示你输入 tar.gz 文件的路径。只需输入路径并按回车键。Tldr++ 支持智能文件提示。这意味着它会在你键入时自动补全文件名。只需按 `TAB` 键自动完成。


![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094941dwi202ex80gax6ao.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094942nimiwlb8vv0vsnzt.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094944t6qgaoo2zd2b48gd.png)


输入要移动的文件路径，并输入目标路径并按回车键。


![](https://linuxcn.img.undefined.today/data/attachment/album/202101/12/094945x8xf1ezxe8ufq0t0.png)
