...
pubDatetime: 2013-09-18 22:33:00
description: "学习如何在ext2、ext3、ext4分区中轻松添加或修改Linux文件系统卷标，提升磁盘管理效率."
tags: ["文件系统", "Linux操作系统", "磁盘分区", "Linux文件系统卷"]
---
...
正如你看到的,在**blkid**和**lsblk**命令输出信息上，只有我的Windows分区是有卷标的，浏览文件管理器可以看到每一个分区都有一个通用的名称。
 ...
 ![Need to edit linux file system label](https://linuxcn.img.undefined.today/data/attachment/album/201309/17/1439149kwlrblwreb6416r.png "Unlabeled partition")
...
![After editing Linux file system label](https://linuxcn.img.undefined.today/data/attachment/album/201309/17/143915lsrmg1glsuu1ebpq.png "File system with label")
