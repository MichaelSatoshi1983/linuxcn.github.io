...
description: "通过决定内核是否生成ELF核心转储文件，配置细节影响内核大小至4KB，选项no避免额外膨胀。"
tags: ["Linux", "内核", "配置", "ELF_CORE", "EPOLL", "技巧", "教程"]
---

OK，我们还继续配置内核。还有更多功能等待着去配置。


![](https://linuxcn.img.undefined.today/data/attachment/album/201311/06/223032bhbqwxqnb5hhazn4.jpg)
