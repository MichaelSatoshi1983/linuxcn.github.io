...
pubDatetime: 2013-12-23 17:01:00
description: "错误的日期时间可能导致程序编译失败，对于管理员而言，准确的时间管理至关重要。"
tags: ["Linux", "date", "命令", "日期", "时间", "技巧", "教程"]
---

操作系统上的时间也许只是当做一个时钟。特别在控制台下, 我们通常并不认为时间有什么重要的。但是对于管理员，这种认识是错误的。你知道错误的日期和时间会导致你不能编译程序么?


![](https://linuxcn.img.undefined.today/data/attachment/album/201312/23/133720ehtmbelwmwsdk59b.png)
