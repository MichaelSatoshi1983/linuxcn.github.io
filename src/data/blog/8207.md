...
pubDatetime: 2017-02-16 07:00:00
description: "在Linux环境下，使用 ifconfig 或 ip 命令可手动检测内部IP地址；执行 wget 或 curl 命令可手动查询公共IP地址。"
tags: ["IP", "地址"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201702/14/230206qro19g5o5koz3473.png)
