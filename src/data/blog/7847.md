...
pubDatetime: 2016-10-09 14:42:00
description: "本文教你如何高效同时处理服务器多个请求，深入解析并发处理技术，提速业务响应，实现高效系统性能。"
tags: ["服务器", "Web"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144117s2djox1sesdiviid.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144221rqrdi1vhdzbf0r3g.png)
...
![](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/201610/09/144221gpbfsxuquizfl2lq.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144223uo5qz8qok8wb099h.png)


当你等待足够长的时间（60 秒以上）后，你会看到第一个 `curl` 程序完成，而第二个 `curl` 在屏幕上输出了“Hello, World!”，然后休眠 60 秒，进而终止。


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144224k01m1zo1ef710fmr.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144225dabrkbpphuubp5e5.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144226b648t2futy2vyt5v.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144227ozv3rynoay6a76my.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144228yg1j0wt0l0t40i0g.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144229pge5dm0ixbw9i6tj.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144229pbe9pahr8m2e2r4t.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144229dnhwgqoo67oanscq.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144231mgczk5ap7of0akjx.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144232r6o3vrgtom63pz4y.png)


一般情况下，UNIX shell 会将一个进程的标准输入流（STDIN）的文件描述符设为 0，标准输出流（STDOUT）设为 1，而标准错误打印（STDERR）的文件描述符会被设为 2。


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144233sdabhm76haaddwa0.png)
...
![](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/201610/09/144233qv878ax8rlkb3sso.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144234oxoss2xo3ux3sysj.png)


在 UNIX 系统中编写一个并发服务器最简单的方法，就是使用系统调用 `fork()`。


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144234wtjonkwkkt0b2d02.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144235a1xp89vzdq6n9n90.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144237dlqkiiqo4j4r9oit.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144238qs0uzarwo5rua2v2.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144239j2iv2esj9svdivjs.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144239bxen0lvyjreinl6g.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144240p2xiaofi2cxhoo2m.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144241uwx1agi4xljgwgir.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144242rnzg3zh0d1qmnm0h.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144242xwf457nwft574404.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144243orgiz9gzzotl1fo7.png)


这是它的工作流程。当一个子进程退出时，内核会发送 `SIGCHLD` 信号。父进程可以设置一个信号处理器，它可以异步响应 `SIGCHLD` 信号，并在信号响应函数中等待（`wait`）子进程收集终止信息，从而阻止了僵尸进程的存在。


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144244n844sw233eab5s58.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144245lantztjl3tlalitl.png)


刚刚发生了什么？`accept` 调用失败了，错误信息为 `EINTR`。


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144246txay743rab5zura7.png)


当子进程退出并触发 `SIGCHLD` 事件时，父进程的 `accept` 调用被阻塞了，系统转去运行信号处理器，当信号处理函数完成时，`accept` 系统调用被打断：


![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144246fea64024jb14hda1.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144247j00e0g8unel00ynx.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144248d4q49tpglnnnntpz.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144249sxqgjqoj5cvo5on5.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201610/09/144250vs6pqlc7jzpbs57b.png)
