...
pubDatetime: 2018-01-31 14:55:02
description: "探索 .bashrc: macOS/Linux 下自定义默认bash行为的关键配置文件"
tags: [".bashrc"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201801/31/145506vz6pxrtzqoxtmgou.png)


你的 home 目录下藏着很多隐藏文件。如果你在运行 macOS 或者主流的 Linux 发行版的话，你就会在靠近隐藏文件列表的上方看见一个名为 `.bashrc` 的文件。那么什么是 `.bashrc`，编辑 `.bashrc` 又有什么用呢？


![finder-find-bashrc](https://linuxcn.img.undefined.today/data/attachment/album/201801/31/145506am14t1jmx4tjzq17.png "finder-find-bashrc")
...
![terminal-edit-bashrc-1](https://linuxcn.img.undefined.today/data/attachment/album/201801/31/145507bxspgcpiizi4nnng.png "terminal-edit-bashrc-1")
...
![terminal-edit-bashrc-3](https://linuxcn.img.undefined.today/data/attachment/album/201801/31/145509t7n1tnnqwnnn6tnn.png "terminal-edit-bashrc-3")
...
![terminal-edit-bashrc-2](https://linuxcn.img.undefined.today/data/attachment/album/201801/31/145509hbz59nzan249fs95.png "terminal-edit-bashrc-2")
