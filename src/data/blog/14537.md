...
pubDatetime: 2022-05-02 23:39:00
description: "Samba配置实现跨平台文件共享，简化不同系统间资源访问。"
tags: ["共享", "Samba"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233859oqqjvfr6tqz9bfqp.jpg "Blue folders flying in the clouds above a city skyline")
...
![Sebool](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233906mxw5xkxgupp56xk8.png "Enabling Samba to enable user directory access")
...
![firewall-config](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233907adbagpspbvrkv2az.png "firewall-config tool")
...
![从 Windows 访问 Linux](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233907x04jd7i8v8tcuxkn.png "Accessing Linux machine from Windows")


系统将提示你输入登录信息。输入第 3 步中的用户名和密码组合。你现在应该可以访问 Linux 机器上的主目录：


![从 Windows 访问 Linux](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233908sonkofsvzsqzvkeh.png "Accessing Linux machine from Windows")
...
![打开网络和共享中心](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233908jd5syp3s24od8jsp.png "Open network and sharing center")
...
![更改高级共享设置](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233909kece9tjceo9ctcs8.png "Change advanced sharing settings")


选择与你的连接对应的配置文件并打开 <ruby> 网络发现 <rt>  network discovery </rt></ruby> 和 <ruby> 文件和打印机共享 <rt>  file and printer sharing </rt></ruby>：


![网络共享设置](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233909eg8q000o5yn6io58.png "Network sharing settings")
...
![授予访问权限](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233909nx9dldkjtktl5xzk.png "Give access")


检查你当前的用户名是否在列表中。点击 <ruby> 共享 <rt>  Share </rt></ruby> 将此文件夹标记为共享：


![标记为共享](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233910wawhjxv727nvxvnr.png "Tag as shared")


你可以通过在文件资源管理器的地址栏中输入 `\\localhost` 来显示所有共享文件夹的列表：


![共享文件夹](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233910e9lzmi8pt9st9iyi.png "Shared folders")


![共享文件夹](https://linuxcn.img.undefined.today/data/attachment/album/202205/02/233911isxutx5npu3nwn25.png "Shared folders")
