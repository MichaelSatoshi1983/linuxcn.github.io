...
pubDatetime: 2018-06-14 12:50:16
description: "减小内存使用量，提升程序执行效率，尾调用通过将函数调用作为最后一个操作实现优化。"
tags: ["尾调用", "堆栈"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201806/14/125010urao2rzn7ccn7om0.jpg)
