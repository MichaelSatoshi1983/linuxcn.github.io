...
![](https://linuxcn.static.byte.beer/data/attachment/album/201909/24/162919ygppgeevgrj0ppgv.jpg)
...
![Moving a file in GNOME.](https://linuxcn.static.byte.beer/data/attachment/album/201909/24/162941j3bvbvvxnc5bxvvc.jpg "Moving a file in GNOME.")


而 KDE Plasma 桌面中的 Dolphin 文件管理器默认情况下会提示用户以执行不同的操作。拖动文件时按住 `Shift` 键可强制执行移动操作：


![Moving a file in KDE.](https://linuxcn.static.byte.beer/data/attachment/album/201909/24/162943i4px4s5mz48saswv.jpg "Moving a file in KDE.")
