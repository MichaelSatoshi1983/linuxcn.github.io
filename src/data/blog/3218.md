...
pubDatetime: 2014-06-18 13:44:00
description: "逻辑卷管理LVM提供灵活的硬盘管理，实现在Linux与类Unix系统中动态调整卷大小，无需重新启动，支持动态添加硬盘扩展逻辑卷，不干扰已存数据。其采用分层架构，由物理磁盘分解为分区与物理卷汇聚形成卷组，实现高效而安全的存储管理。"
tags: ["LVM", "磁盘", "分区"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201406/18/134408sa12dauefffyszfg.jpg)
