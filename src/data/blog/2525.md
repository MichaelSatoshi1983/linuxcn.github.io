...
pubDatetime: 2014-01-29 11:24:00
description: "在这一指导中，将学习如何在单台PC上并行运行Linux（Ubuntu）与Windows操作系统，实现二者的和平共存，适合寻求灵活性与兼容性的用户。"
tags: ["Linux", "Ubuntu", "Windows", "双系统"]
---

**尽管微软想让你信任Windows，但一个Linux操作系统和一个Windows操作系统可以在同一台PC上和平共存。这个文章会指导你如何让一个Ubuntu系统和Windows操作系统并行运行。**


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/29/111759fg1jou031ogsjjpk.jpg)
