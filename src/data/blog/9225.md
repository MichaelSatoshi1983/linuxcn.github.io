...
![](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070345hjucturadqtdebdq.jpg)


最近我不得不给我的手机下载更新包，但是当我开始下载的时候，我发现安装包过于庞大。大约有 1.5 GB。


![使用 Chrome 下载 MIUI 更新](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070345xznmmvgz8z7rb7i7.png)
...
![savetodrive 将文件保存到 Google Drive ](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070346forqglsfd2rfxye2.png)


这将会请求获得使用你 Google Drive 的权限，点击 “Allow”。


![请求获得 Google Drive 的使用权限](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070346tzak4t2pq2vrxxgw.jpg)
...
![savetodrive 直接给 Google Drive 上传文件](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070347c998lammvr3zsyxk.png)


你将会开始看到上传进度条，可以看到上传速度达到了 48 Mbps，所以上传我这个 1.5 GB 的文件需要 30 至 35 秒。一旦这里完成了，进入你的 Google Drive 你就可以看到刚才上传的文件。


![Google Drive savetodrive](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070348mb7wzhs70kdspvyi.png)


这里的文件中，文件名开头是 *miui* 的就是我刚才上传的，现在我可以用一个很快的速度下载下来。


![如何从浏览器上下载 MIUI 更新](https://linuxcn.static.byte.beer/data/attachment/album/201801/10/070348ot0qww0wv0amf8mi.png)
