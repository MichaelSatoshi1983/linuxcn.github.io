...
pubDatetime: 2013-11-07 23:24:00
description: "升级Ubuntu 13.10内核风险较大，官方不推荐超官方仓库升级特定版本。适合勇于冒险的用户。"
tags: ["Ubuntu", "升级", "Linux", "内核", "技巧", "教程"]
---

Ubuntu 13.10已经发布，不过它的内核可不是最新的。当然坚持Ubuntu 13.10当前内核不是一件坏事。事实上。不特别建议升级超出你的Linux发行版的官方仓库测试过的特定版本。


![](https://linuxcn.img.undefined.today/data/attachment/album/201311/07/2320203uua3auqqawkucxx.png)
