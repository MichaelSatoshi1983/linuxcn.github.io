...
pubDatetime: 2015-08-09 11:38:00
description: "使用Linux或类Unix系统，运行`env VAR=value`设置变量，然后执行程序。显示当前环境用`printenv`或`env`。例如，打印环境变量数量：`env | wc -l`或`printenv | wc -l`，输出示例：20。</br>"
tags: ["命令", "环境变量"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201508/08/234643lz4436ndzo8sqds5.jpg)
...
![Fig.01： Unix/Linux： 列出所有环境变量](https://linuxcn.img.undefined.today/data/attachment/album/201508/08/234703bjxggfndgrsxr9gz.jpg)
