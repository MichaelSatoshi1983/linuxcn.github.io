...
pubDatetime: 2015-05-17 20:33:00
description: "Linux系统启动探讨：比较传统init与创新型systemd，系统进程管理进化之旅。systemd引入新特性和优化，传统 SysV init系统效率待提升。了解两者启动流程，深化对Linux启动机理理解。注意，systemd尚处测试，未来Linux将全面采用其启动管理机制。"
tags: ["systemd"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203724enh95nh9idhkyglc.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203329njlvc2p3c12el22p.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203329k5cv7y6cl6rsfofz.png)


"multi-user.target"会将控制权交给另一层“**basic.target**”。


![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203330e173g84w17qkg3kc.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203330av1cz6zs3us8cyzs.png)


**6.** "sysinit.target"会启动重要的系统服务例如系统挂载，内存交换空间和设备，内核补充选项等等。sysinit.target在启动过程中会传递给**local-fs.target**。这个target单元的内容如下面截图里所展示。


![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203331k66nojnty66466na.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203331gq30tzrtjo23tq3r.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203332uzqvf52rqfipfd2a.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203332aisj9qis2bs2e9me.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203333vrrl22jpktsrxljh.png)


在文件里修改GRUB*CMDLINE*LINUX\_DEFAULT项，设定它的参数为：“**init=/lib/systemd/systemd**”


![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203334udokzqhbzrqw7kbl.png)


就这样，你的Ubuntu系统已经不再使用传统的引导程序了，改为使用Systemd管理器。重启你的机器然后查看systemd引导过程吧。


![](https://linuxcn.img.undefined.today/data/attachment/album/201505/17/203337oocokqr0rrd7g343.png)
