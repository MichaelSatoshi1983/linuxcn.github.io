...
pubDatetime: 2015-10-29 13:51:43
description: "学习Oracle 11g升级至12c，遵循专业指南，适合CentOS 7 64位Linux。涉及数据库创建与配置，注意选择正确类别的Oracle安装，输入加密路径及密码，确保安全与高效升级过程。"
tags: ["Oracle"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135146vmafav6226gz77zm.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135149vtfto8rnozizt7oi.png)


然后我选择安装 Oracle 11g “Decktop Class”。如果是生产环境，你必须选择 “Server Class”。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135150yd3cuhii9uzn7hdz.png)


然后你输入安装 Oracle 11g 的各种路径以及密码。下面是我自己的 Oracle 11g 安装配置。确保你正确输入了 Oracle 的密码。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135152wgv5vb1v4ry548cs.png)


下一步，我按照如下设置 Inventory Directory。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135155q7rfz4h6so9kucks.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135156da0rzp0qb0p00906.png)


如果一切顺利，你会看到类似下面的截图，已经开始安装 12c。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135204y6q7vv4jdmyqv361.png)


然后你可以选择跳过更新或者下载最近更新。如果是生产服务器，建议你必须更新。我这里选择跳过。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135207vwf8ffozlfpnojfx.png)


现在，选择升级现有数据库。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135209f39lc7c7c47zq177.png)


对于语言，这里已经有 English。点击下一步继续，或者你可以根据你的需要添加语言。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135212njjn2jpqww2y0zsc.png)


现在，选择企业版。你可以根据你的需求选择。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135214k6cn65iqcfwchdl7.png)


然后选择软件位置路径，这些都是不言自明的。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135217l8nk23yfxx82cik3.png)


对于第七步，像下面这样使用默认的选择继续下一步。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135220lecnb9lebr0buzze.png)


在第九步中，你会看到一个类似下面这样的总结报告。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135222hbu00ob52p22d0bg.png)


如果一切正常，你可以点击第九步中的 install 开始安装，进入第十步。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135224rrkrzkik91n5z39w.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135227rqbqhh5zbfos8ra6.png)


在第二步，你会发现它显示了 11g 的位置路径以及 12c 的位置路径。同时你也会发现它指示说从原来的 Oracle Home Release 11 安装 Oracle Home Release 12.点击下一步进入步骤三。


![](https://linuxcn.img.undefined.today/data/attachment/album/201510/29/135230knppskpp78aiw7rp.png)
