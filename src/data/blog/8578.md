...
pubDatetime: 2017-06-05 14:07:00
description: "数据库连接池是一种优化B/S架构的技术。连接池中的连接对象易受管理，简化资源管理与提升系统性能。面对连接需求，连接池提供连接复用、分配，确保高效合理利用资源，防止连接被频繁创建与释放造成的性能损耗。"
tags: ["数据库", "漫画"]
---

![Life (and Death) in the DB Connection Pool](https://linuxcn.img.undefined.today/data/attachment/album/201706/05/140712giqn2zgynkl17fq1.png)
