...
pubDatetime: 2020-11-24 11:35:00
description: "无需下载安装，即点即用 Fedora，操作系统的灵活性与应用便利兼得。"
tags: ["VirtualBox"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113504ku7qkthi72cu272x.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113851dw5ptwdimun36dn2.jpg)
...
![创建一个新的虚拟机](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113512b5hmk3jktptklldz.png)
...
![命名你的虚拟机，并未它指定至少 3 GB RAM](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113928u3tvp6vvddqpyly0.png)
...
![以 VDI 格式分配 15-20 GB 的磁盘空间](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113521yfeprrrf0bbkva1l.png)


在你点击虚拟机的 Start 按钮之前，你需要加载如下所示的 ISO [光驱]。


![将 Fedora ISO 添加到光驱存储中](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113525ipj9cpgyj8kvnph0.png)


因为你的虚拟硬盘是空的，虚拟机将从这个 ISO 启动。可以把它看作是使用临场 USB 或磁盘安装 Linux。


![在设置中将 ISO 添加为光驱](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113543zi6s7445p1dz1pjg.png)


然后，如果你有一个多核 CPU，建议为虚拟机分配 2 个或更多的核。你可以在 “System” 选项卡下找到 CPU 核心。配置系统时，单击 “OK” 并启动虚拟机。


![可选：分配 CPU 核数](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113546vjfvrqtjsjf8zft8.png)
...
![Fedora 运行在虚拟机的临场环境中](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113548fnhw5ii9wwn6unmw.png)


要启动安装对话框，单击 “Install To Hard Drive”。


![点击 “install to hard drive”](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113553hkitokla5kou5u0a.png)


在你继续安装之前，有必要定义你的键盘布局、你的时区以及最终安装操作系统的位置。


![选择键盘布局、日期和时间，然后是安装目标位置](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113557zipiio9ijiisisap.png)
...
![磁盘应该会自动识别](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113608xzcffmz9myyzggff.png)


一旦你配置完了上面的，点击 “Begin Installation”。


![开始 Fedora 的安装](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113617t84x5i8pqopg1gql.png)
...
![安装后关闭 Fedora 临场环境](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113633ryap4va2ihfii5it.png)


你必须手动卸载在初始步骤中加载的 ISO 文件。


![从光驱中移走 Fedora ISO](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113636gs82gs5ciqo0sa9v.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113651vdjk7wkn65psnp7e.png)


当提示单击 “Download” 时，系统将弹出下载 Guest Additions 镜像界面。


![安装 VirtualBox Guest Additions](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113706jmm2bbww4rb3qzll.png)
...
![启用访客和宿主系统间的剪贴板共享](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113710wze2uxu5729zz6zq.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113712n55313f1vu5nunz1.png)


下次启动虚拟机时，该文件夹应该显示为网络驱动器。


![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113718cc4e2ewe355izec5.png)
...
![安装 VirtualBox 扩展包](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113723ngjetye1f31dwsj1.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113725k4fzu21yanynz9rp.png)


当你下次启动虚拟机，你的 USB 将是可访问的。


![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113730yzsag6s70uvsa30a.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113733c19mfhmuf261h929.png)


选择要导出的虚拟机，然后单击 “Next”。


![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113737yl60l709s0be7i9e.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/24/113740fxxzllyxp2lj5j87.png)
