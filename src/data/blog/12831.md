...
pubDatetime: 2020-11-17 11:14:00
description: "通过技术手段，快捷知晓磁盘空间使用情况，精准管理存储资源。"
tags: ["磁盘"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111346h0vrdvldsy6hlhlh.jpg)
...
![在 Linux 中使用 df 命令检查可用磁盘空间](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111415ep0wcwezfo7r9wgp.png)
...
![理解 df 命令输出](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111419q1ja1a1oav9oat9v.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111529q66vkkcqinqo7z5j.png)


你可以使用 `lsblk` 命令来查看在你系统上的所有磁盘和分区。


![](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111428nzihr67wuqdy4u00.png)
...
![Disk Usage Analyzer 工具](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111431strcqtorxa0wrxrz.jpg)


在这里，你将看到所有实际的磁盘和分区。你可能需要单击一些分区来挂载它们。它显示所有已挂载分区的磁盘使用情况。


![磁盘使用情况检查](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111433wfozjudjvuvswosj.png)
...
![GNOME 的 Disks 工具](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111436mfzrgfers1jra1ea.jpg)


启动工具和选择磁盘。选择一个分区来查看可用磁盘空间。如果没有挂载分区，那么先通过单击 “▶” 图标来挂载它。


![检查 Ubuntu 的桌面版本的可用磁盘空间](https://linuxcn.img.undefined.today/data/attachment/album/202011/17/111439d008nk80uwpuok6v.png)
