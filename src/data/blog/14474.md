...
pubDatetime: 2022-04-15 12:38:00
description: "使用OpenWRT提升网络路由器控制权，解锁高级功能与定制化可能。"
tags: ["树莓派", "OpenWRT"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123813xtpegv7e5xvj7c7a.jpg "Mesh networking connected dots")
...
![Teltonika TRM240 modem](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123837qmzh759hi2z6ouew.png "Teltonika TRM240 modem")
...
![OpenWRT image files](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123837luqias8lnu8nuqa1.png "OpenWRT image files")
...
![IP addresses](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123837fj0d5jqjrldld566.png "IP addresses")


在你的电脑上打开浏览器然后导航到 192.168.1.1 。这将打开一个验证网页，你可以登录到你的树莓派。


![OpenWRT login page](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123838hj2af0wjfrd3fqdf.png "OpenWRT login page")
...
![LAN interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123838t51ez044nuu5benq.png "LAN interface")


应该会出现一个弹窗，在这个窗口中，你需要键入与你将要连接树莓派的路由器子网匹配的 IP 地址。如果需要的话，修改子网掩码，并输入树莓派将要连接的路由器的 IP 地址。


![Enter IP in the LAN interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123838plnoy7zyyiemnne1.png "Enter IP in the LAN interface")
...
![Scan the network](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123839lxuz8tgubdblgzxd.png "Scan the network")
...
![New interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123839b5yzqhfv6leb55zy.png "New interface")
...
![Updating packages](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123839anspzfff8smmxxxf.png "Updating packages")
...
![Add a new mobile interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123840gs5udo2dsobbmbmb.png "Add a new mobile interface")
...
![Configuring the interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123840y4xifbjzj8fqzjbu.png "Configuring the interface")
...
![Configured interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123840rbwocykiaobocai4.png "Configured interface")
...
![Terminal interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123840apwjwktttpq4i5qa.png "Terminal interface")
...
![Firewall zones](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123841kac5yawr9rf11reb.png "Firewall zones")
...
![Firewall zone settings](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123841lhoy4nyw6phag6ge.png "Firewall zone settings")
...
![Firewall zone settings](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123841j1ghr2e92ebaheee.png "Firewall zone settings")
...
![Enabling wireless network](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123842m99yjgw1j39j9dhr.png "Enabling wireless network")


如果你想，你可以通过编辑 “ESSID” 选项来修改接口名称。你也可以选择它要关联的网络。默认情况下，它会与 LAN 接口关联。


![Configuring the interface](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123842iaiqxd88asqcyh9y.png "Configuring the interface")


要为这个接口添加密码，选择 “<ruby> 无线安全 <rt>  Wireless Security </rt></ruby>” 选项，选择 “WPA2-PSK” 加密方式然后在 “<ruby> 密钥 <rt>  Key </rt></ruby>” 选项字段键入接口的密码。


![Setting a password](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123842snb29bh5cj12nnob.png "Setting a password")
...
![Packages with luci- prefix](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123842kjdhl54hh9rlqbae.png "Packages with luci- prefix")
...
![Raspberry Pi router](https://linuxcn.img.undefined.today/data/attachment/album/202204/15/123843a89zopodddooo2h8.jpg "Raspberry Pi router")
