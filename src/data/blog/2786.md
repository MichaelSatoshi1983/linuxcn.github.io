...
pubDatetime: 2014-03-31 22:37:10
description: "通过编辑/etc/hosts文件，学会在Ubuntu Linux上屏蔽不受欢迎网站，无需第三方应用，操作简单便捷。确保以root权限执行，使用文本编辑器修改系统文件。本教程指导使用vim编辑器完成操作。"
tags: ["防火墙", "hosts"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201403/31/223715yjee4a1yzzise34d.jpg)
