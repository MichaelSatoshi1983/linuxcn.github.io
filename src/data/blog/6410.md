...
pubDatetime: 2015-10-16 07:59:00
description: "习惯使用phpinfo()访问配置信息，尝试实现类似pyinfo()未果。发现已有实现但布局欠佳，决定自行优化代码布局，借鉴Python官网设计风格，提升用户体验。欲获取改版代码、下载及示例，请参考[Gist]与下载地址。"
tags: ["python"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201510/16/000334en7p54ggks870bgh.gif)
