...
pubDatetime: 2014-06-24 15:13:00
description: "在Linux、OS X或Unix-like系统bash中，使用`shopt -s extglob`启用扩展模式匹配，删除非.iso、.zip格式文件：`rm !(*.iso|*.zip)`。"
tags: ["文件", "删除", "Shell"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201406/24/151307gi7yvhtpoybdb6pk.jpg)
