...
pubDatetime: 2023-09-26 10:33:09
description: "使用代码注释，Doxygen生成广泛使用的开源文档工具，简化代码理解与分享。"
tags: ["Doxygen", "文档"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202309/26/103240lkeeijekke3egs5n.jpg)
...
![A screenshot of a doxygen generated main page on Firefox. The content field under My Project Documentation is blank.](https://linuxcn.img.undefined.today/data/attachment/album/202309/26/103309q0shh51euusk0j7j.png)
...
![A screenshot of the terminal showing the differences, Project Name, Project Brief, Recursive, and status of Generate Latex](https://linuxcn.img.undefined.today/data/attachment/album/202309/26/103309d32ec3ck46ayuqqq.png)
...
![A screenshot of the C++ example of using Doxygen showing the Byte Stream Class Reference. The categories in the list are public member functions, writing (operators for writing to the stream), and reading (operators for reading from the stream)](https://linuxcn.img.undefined.today/data/attachment/album/202309/26/103309cv5pzl1o6k155j0j.png)


在空行（空行是段落分隔符）之后是构造函数的实际文档。用 `@param[in/out]` 关键字标注传递给构造函数的参数，Doxygen 基于此生成参数列表：


![Screenshot of the Doxygen example showing the parameters under ByteStream](https://linuxcn.img.undefined.today/data/attachment/album/202309/26/103310bhmjmafjzbjbhubj.png)
