...
![](https://linuxcn.static.byte.beer/data/attachment/album/201612/16/062646xyjbihhlhgybtj8m.jpg)


从本质上来说它是一个 cURL 工具的封装，意味着你可以在 URL 后使用几个有效的 cURL 选项，但是不包括 `-w`、 `-D`、 `-o`、 `-s` 和 `-S` 选项，这些已经被 httpstat 使用了。


![httpstat Curl Statistics Tool ](https://linuxcn.static.byte.beer/data/attachment/album/201612/16/062701hi6cma6cfimimmfk.png)
...
![httpstat - Showing Website Statistics](https://linuxcn.static.byte.beer/data/attachment/album/201612/16/062702lnaq6hfe87bbyq70.png)
...
![httpstat - Custom Post Request](https://linuxcn.static.byte.beer/data/attachment/album/201612/16/062702t66dkrlbr4wk9lq6.png)
