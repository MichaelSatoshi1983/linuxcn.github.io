...
pubDatetime: 2016-09-06 13:43:55
description: "现在可在Azure SQL中无缝处理关系型数据与JSON，利用内置函数轻松实现JSON文本转表及表数据转JSON，增强数据管理灵活性和效率。"
tags: ["JSON", "Azure"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201609/06/134401se3vua5qy341jyeh.png)
