...
pubDatetime: 2015-03-31 08:42:00
description: "在Debian或Ubuntu服务器管理中，dpkg与apt-get用于包操作。查看特定包是否安装，如'firefox'，使用dpkg -s firefox命令。示例输出包含包状态、版本、维护详情与兼容架构。"
tags: ["软件包", "apt", "dpkg", "apt-get"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201503/30/134439j2j5747yac16y76w.png)
