...
![](https://linuxcn.static.byte.beer/data/attachment/album/201706/13/174644t3bpa2ra424e24e3.jpg)
...
![CPU 架构](https://linuxcn.static.byte.beer/data/attachment/album/201706/13/174714eahc6khachn6z5hk.png)


上面是一个 4 核 CPU 的简单漫画示意图。每个核都有一组寄存器以及不同等级的缓存（有些是共享缓存、有些不是），然后是主内存。


![GPU 架构](https://linuxcn.static.byte.beer/data/attachment/album/201706/13/174715iziw6x8iueqzienc.png)
