...
pubDatetime: 2014-02-01 10:18:00
description: "探索Linux高效技巧与实用提示，这里精选8个读者推荐，助您优化文件管理，特别演示如何按大小排序文件。"
tags: ["Linux", "shell", "命令", "技巧", "ls", "reset", "script", "scriptplay", "随机数", "chrome"]
---

我们时不时给你带来关于Linux的提示与技巧。和这个系列保持一致，这里有8个我们从读者收到最有趣的提示和技巧。我们希望你喜欢它。请继续读下去。。。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/30/2200220gt6to7h06dtbi0b.png)
