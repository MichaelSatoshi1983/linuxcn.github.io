...
pubDatetime: 2014-12-21 10:31:00
description: "Bourne Shell's `if` statements assess conditions; if true, execute specified code block; otherwise, skip and proceed. Syntax: `if then command1 command2 .. last_command fi`. Supports `if-else` for alternative execution based on condition outcome."
tags: ["Shell编程", "Shell脚本"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201412/21/103252nq0neivincaeeiq0.png)
