...
pubDatetime: 2015-08-03 14:05:00
description: "优化Ubuntu开机速度，管理冗余启动应用，释放系统资源，提升设备响应，通过GUI工具掌控自动启动程序，打造流畅操作体验。"
tags: ["开机", "启动"]
---

![在 Ubuntu 中管理开机启动应用](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220629bz0x7xxjljeiufxx.png)
...
![ubuntu 中的开机启动应用工具](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220629xvit4hm213hdu9g3.jpg)


点击它来启动。下面是我的`Startup Applications`的样子：


![在 Ubuntu 中查看开机启动程序](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220630ohmcktx52cc5ha2c.png)
...
![在 Ubuntu 中移除开机启动程序](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220630f5j97wc7bq7855wk.png)


要将一个程序从开机启动程序列表中移除，选择对应的选项然后从窗口右边的面板中点击`移除`按钮来保留你的偏好设置。


![在 Ubuntu 中将程序从开机启动列表中移除](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220632h9cz94vae2ag3c8m.jpg)
...
![编辑开机启动应用列表](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220636lss7zeywsywgz87n.png)


这将展示出运行这个特定的程序所需的命令。


![在开机启动列表的程序运行所需的命令](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220637qodukg1dn70qunyi.jpg)
...
![在 Ubuntu 中延迟开机启动的程序](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220637au44lg6gw7blq2u7.png)
...
![Ubuntu 下的程序菜单](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220637bh22fdqr68qihc22.jpg)


这将展示出在各种类别下你安装的所有程序。在 Ubuntu 的低版本中，你将看到一个相似的菜单，通过它来选择并运行应用。


![Ubuntu 下的 main menu ](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220640w42j2zgu29u69jjz.jpg)


在各种类别下找到你找寻的应用，然后点击 `属性` 按钮来查看运行该应用所需的命令。例如，我想在开机时运行 `Transmission Torrent 客户端`。


![在 Ubuntu 下查找运行程序所需的命令](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220649gvkl0gnvil12yjy1.jpg)


这就会向我给出运行 `Transmission` 应用的命令：


![在 Ubuntu 下查找运行某个程序所需的命令](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220658z737j7xs5pp8p43i.png)
...
![在 Ubuntu 中添加一个开机启动程序](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220700lrrgsj93c7h73s3r.jpg)
...
![在 Ubuntu 中查看隐藏的开机启动程序](https://linuxcn.img.undefined.today/data/attachment/album/201508/02/220702oj501820jmq05jig.jpg)
