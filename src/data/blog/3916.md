...
pubDatetime: 2014-09-28 09:39:00
description: "Wal Commander GitHub版多平台开源文件管理器，支持Windows、Linux、FreeBSD与OSX，重现Far管理器风格。新版0.17引入命令历史自动补全、自定义文件操作命令与OS X实验性支持XQuartz，新增快捷键，提供Win64、Linux、FreeBSD与OSX预编译二进制文件，从GitHub源代码编译。"
tags: ["Wal Commander", "文件管理器"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201409/28/093930n72blaew5wwoz99r.png)
