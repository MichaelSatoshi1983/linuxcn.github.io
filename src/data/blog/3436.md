...
pubDatetime: 2014-07-20 17:53:58
description: "使用Sosreport收集RHEL/ CentOS系统配置信息与诊断数据，包括内核版本、模块、配置文件，支持运行外部程序扩展收集，输出为结论文档。该工具是红帽技术支持要求必须提供的文件，用于服务器故障排除。安装需确保sos包在系统中，可通过yum命令补充安装。一键生成全面系统报告。"
tags: ["sosreport"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201407/20/175405kijg156u1t4len6g.jpg)
