...
pubDatetime: 2017-08-03 18:37:38
description: "期待已久的增强功能现已实现：LXD 现支持多个存储池，扩展灵活性与管理能力。"
tags: ["LXD", "容器", "存储"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183727syjxl7jwmy3myzfy.jpg)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183742znbdqms55exehmax.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183745leleohwutuu97qtq.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183748w445y36fffe5ov3x.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183752f6br797bu4r7579g.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183755ef4pvhcrag6z4gwp.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183757uk2z86ykrb7bu8er.png)
...
![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183800okv60676c0zc99xd.png)


但是我们让 `xen-isolated` 与 `xen1` 有相同的映射，并把它重命名为 `xen2` 来反映这个变化。现在我们可以将 `my-custom-volume` 连接到 `xen1` 和 `xen2` 而不会有问题：


![asciicast](https://linuxcn.img.undefined.today/data/attachment/album/201708/03/183803tuv0ty10i9z2v9v2.png)
