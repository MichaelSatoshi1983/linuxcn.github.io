...
pubDatetime: 2014-01-06 16:03:00
description: "快速掌握在Ubuntu系统中设置Dropbox方法，简化文件存储与同步流程，提升工作效率与用户体验。"
tags: ["Linux", "Ubuntu", "Dropbox", "移动硬盘", "技巧"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150940klapoeekecrnairo.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150949ei6mr3iw3r3tcy3z.png)


下一步，格式化驱动器的文件系统为**NTFS**格式。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150951o6kgmmroerrroc0g.png)


格式化之后，选择 **Tools –> Mount Options**


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150953e9e965krnyrk5yif.png)


然后指定相应的选项，如下图所示：安装点（准备将Dropbox的文件夹放到这里），文件系统类型，以及下面的图片中的其他选项。保存它时，你就大功告成了。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150955n1pwhr83wll8xwcq.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/150957okoknkacof3fdfxo.png)


当提示选择安装类型，选择‘**Advanced’**并指定位置安装Dropbox文件夹。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/15095915gy5o8tco00ftrr.png)


设置完毕后，重新启动，如果Dropbox的不会提示你缺少文件夹，那么就成功了。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/06/151001salgal3rl033z13s.png)
