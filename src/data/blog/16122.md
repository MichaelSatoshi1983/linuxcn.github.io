...
pubDatetime: 2023-08-24 09:32:15
description: "通过Podman启动GitLab执行器提供便捷方法，本文详述两种高效实践，专为技术优化而设。"
tags: ["Podman", "GitLab"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093145pkr5rd2qqkmch6xv.jpg)
...
![Display available GitLab runners in your repository's settings](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093215hkkwcwx0ws4hcc6n.png)
...
![Restart the GitLab runner](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093216z65zpupklzejukeu.png)


接下来，验证你的 CI 流水线正在使用执行器。你的 CI 任务日志将提及正在使用的执行器的名称以及任何其他配置信息，例如 执行器的执行环境的功能标志和容器镜像。


![View CI tasklogs to display the runner](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093216cmjd453j75aj4c7a.png)
...
![Verify the new runner is visible](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093216nhrhr3538h4o2omm.png)


最后，验证你的 CI 流水线正在使用你的执行器：


![Verify the CI pipeline](https://linuxcn.img.undefined.today/data/attachment/album/202308/24/093216gqhuse4qsilepl64.png)
