...
pubDatetime: 2014-11-25 16:37:24
description: "使用Puppet时,面临独特需求如修改不同服务器配置文件,Augeas工具应运而生,专为此类情境设计,填补Puppet能力空白,尤其在资源类型不可用情况。此文档教你如何运用Augeas简化配置文件管理,使其成为配置编辑的强大助手。"
tags: ["Puppet", "Augeas"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/25/163727yz7ejia7eic969i3.png)
