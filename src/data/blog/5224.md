...
pubDatetime: 2015-04-08 09:40:00
description: "基于Vagrant的本地环境下的HHVM测试结果不尽如人意，且在研究原因。然而，DigitalOcean服务器上运行的HHVM表现出优越性能，超越最新PHP-NG版本。显示HHVM在JIT热启动后效能出色，但某些情况下无法在所有系统上复现。回忆几个月前对WordPress 3.9完全支持HHVM的报道，初期基准测试显示HHVM远超使用于所有PHP构建的Zend引擎。后续问题浮现，探索HHVM整体效果。"
tags: ["PHP", "PHP-NG", "HHVM"]
---

**摘要：在一个基于Vagrant的本地环境中，可能是某个错误的原因，导致HHVM测试结果很差；在HHVM伙伴们协助下，该原因仍在研究中！然而，在DigitalOcean的一个4GB虚拟机中，HHVM甚至盖过了最新版的PHP-NG的风头！**


![](https://linuxcn.img.undefined.today/data/attachment/album/201504/07/234331p3bmkxwx500xxf5s.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/07/234146hvke5qwoe41e405p.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201504/07/234214demrp6k0zkzgooz8.png)
