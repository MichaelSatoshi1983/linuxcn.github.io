...
pubDatetime: 2014-07-31 16:49:00
description: "在GNOME Shell中寻觅热爱的应用与流畅切换，挑战你的桌面期待。一个用户熟悉的直接启动器/切换器，为何被隐藏屏幕包围？GNOME的哲学追求专注，却令喜欢桌面置物的用户困惑。需要一个既能保留审美，又兼顾功能，使桌面满足个性化需求和效率的新方案。"
tags: ["桌面", "应用", "GNOME Shell"]
---
