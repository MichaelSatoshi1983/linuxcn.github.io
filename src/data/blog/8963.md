...
pubDatetime: 2017-10-15 21:56:00
description: "Flashback精准模拟HTTP/HTTPS资源，适用于测试，复现Web服务与REST API行为。"
tags: ["Flashback", "测试"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201710/15/215549qf6816w11zwjpkwz.jpeg)
...
![Scenarios where we have POSTed data to update the external resource.](https://linuxcn.img.undefined.today/data/attachment/album/201710/15/215603k11skaj8jee8fjf1.jpg "Scenarios where we have POSTed data to update the external resource.")
...
![Testing this internal service in a testing environment.](https://linuxcn.img.undefined.today/data/attachment/album/201710/15/215603h9nbfc6b6z72b1fm.jpg "Testing this internal service in a testing environment.")
...
![After the necessary scenes get recorded, we can deploy them to our test environment.](https://linuxcn.img.undefined.today/data/attachment/album/201710/15/215604yr3fwqwqbazvzgwv.jpg "After the necessary scenes get recorded, we can deploy them to our test environment.")


在测试环境（隔离并且没有 Internet 访问）中，Flashback 在与开发环境相同的端口上启动。所有 HTTP 请求仍然来自内部服务，但响应将来自 Flashback 而不是 Internet 提供商。


![Responses will come from Flashback instead of the Internet providers.](https://linuxcn.img.undefined.today/data/attachment/album/201710/15/215604d83nijiy3t3y03wt.jpg "Responses will come from Flashback instead of the Internet providers.")
