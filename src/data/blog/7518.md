...
pubDatetime: 2016-06-29 10:25:00
description: "ORB从Orbital Apps推出，是一种新型软件包，支持便携、交互式安装与离线使用，无需管理员权限，随U盘携带，简化应用安装与使用流程。"
tags: ["ORB", "Orbital"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/123743ln5h556dtnhqptta.jpeg)
...
* 将其移动到想要的位置（本地磁盘/U 盘）。
* 打开存储 ORB 包的目录。
![](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/123845u8m55xm7ttdgz5z5.jpg)
* 打开 ORB 包的属性。
![给 ORB 包添加运行权限](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/124001cdiq004k5keglgld.jpg)
* 在权限标签页添加运行权限。
* 双击打开它。
...
![点击 OK](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/124028uet07lz4esv7friy.png)


![输入你的密码并继续](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/124054r313rkk8f2g12f75.png)


![它会开始安装…](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/124120vy55gpy916bz06lp.png)


![一会儿它就完成了…](https://linuxcn.img.undefined.today/data/attachment/album/201606/29/124144g5ycuq7p5aa47y9a.png)
* 完成安装之后，你就可以正常使用了。
