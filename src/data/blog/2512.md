...
pubDatetime: 2014-01-24 22:48:00
description: "获取用户ID及组ID，揭示Linux下身份识别与权限管理关键，简化登陆规则应用。"
tags: ["Linux", "命令", "id", "用户", "技巧", "教程"]
---

要登入一台计算机，我们需要一个用户名。用户名是一个可以被计算机识别的身份。基于此，计算机会对使用这个用户名的登陆的人应用一系列的规则。在Linux系统下，我们可以使用 **id** 命令。


![](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224330reqemanyys28hmhf.png)
...
![id默认输出](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224340paeu2a2r2laqhg7p.png)
...
![-a 选项](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224341fmeq0vuumq0mvexx.png)
...
![-G 选项](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224342aicobkik2byb7pjr.png)
...
![-g 选项](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224343tn8sxsz5qsnoyoxp.png)
...
![leni 用户](https://linuxcn.img.undefined.today/data/attachment/album/201401/24/224344322ijx4qnbv2noa7.png)
