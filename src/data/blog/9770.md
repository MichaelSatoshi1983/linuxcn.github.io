...
pubDatetime: 2018-06-22 14:43:21
description: "利用最新Linux内核（版本4.4及以上），通过eBPF技术，将任意内核函数调用转换为用户空间事件。借助bcc轻松实现，利用C语言编写探针，Python处理数据，高效监测系统行为。"
tags: ["eBPF", "内核"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201806/22/144303vbnrgmmynvhcwczl.jpg)
