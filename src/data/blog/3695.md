...
pubDatetime: 2014-08-27 08:46:00
description: "要检PDF中字体，使用pdffonts命令行工具，它是Poppler PDF工具集的一部分。在Debian, Ubuntu或Linux Mint中安装：$ sudo apt-get install poppler-utils；在Fedora, CentOS或RHEL中：$ sudo yum install poppler-utils；pdffonts可列出PDF文档中所有使用的字体。"
tags: ["PDF", "字体", "pdffonts", "Linux", "有问必答"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201408/27/005030kd3j1dds1wlidzjj.png)
