...
pubDatetime: 2018-02-04 22:13:00
description: "通过复制技术，在不影响主服务器性能的同时，创建并自动化管理数据库副本，用于运行查询、数据冗余，确保高效稳定的数据管理和访问。"
tags: ["MariaDB", "数据库", "主从复制"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201802/04/221301ve5vvocwioceiz5t.jpg)
