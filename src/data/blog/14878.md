...
![](https://linuxcn.static.byte.beer/data/attachment/album/202207/30/071627r176w1k1y5dkkw6w.jpg)
...
![Checking Python version in Ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202207/30/071649t3b6wbzcavyk267t.png)
...
![install python is python3 ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202207/30/071649fitwdowttttdhutu.png)


你可以看到符号链接已经被创建，你可以使用 `python` 命令（实际上是运行 `python3`），没有任何问题。


![checking python ubuntu](https://linuxcn.static.byte.beer/data/attachment/album/202207/30/071650elcug2c4olqolalp.png)
