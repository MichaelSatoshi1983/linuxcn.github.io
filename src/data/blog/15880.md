...
![](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155438l5oaiwow5wcmtczo.jpg)
...
![授予 GtkStressTesting 读取所有的权限](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155523w802maan7ny12w1w.png)
...
![选择 Linux 中 CPU 压力测试的时间和核心数](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155524hkp23fr3i3v33grz.png)
...
![使用图形界面压力测试 Linux CPU](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155524wj5oph5n5ln05poi.png)
...
![使用 s-tui 命令行实用程序进行压力测试](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155525kyyjooceffeohcyg.gif)
...
![在 Linux 中监控 CPU 的时钟速度、负荷和利用率](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155525pb9za9d1dr91bjir.png)


你可以使用鼠标或键盘箭头键浏览菜单，然后点击“<ruby> 压力选项 <rt>  Stress options </rt></ruby>”，选择你想要压力测试系统的时间（以“秒”为单位）：


![设置 Linux 中 CPU 压力测试的时间长度](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155525nzrfdgfjlrszjdvn.png)


最后，选择“<ruby> 压力 <rt>  Stress </rt></ruby>”选项，它会在指定时间内开始压力测试：


![使用终端压力测试 Linux 中的 CPU](https://linuxcn.static.byte.beer/data/attachment/album/202306/06/155526nzacqcc6qc2agqgc.png)
