...
pubDatetime: 2015-06-09 07:12:00
description: "文件系统控制属性保障数据安全，仅在ext2、ext3或ext4中应用，通过lsattr与chattr管理。特性包括：a - 追加写入；A - 禁止更新访问时间；c - 映射文件内容变化。此机制限制root权限操作，强化数据保护。"
tags: ["lsattr", "chattr"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/08/101852ztnsest7d6ptnrt1.jpg)
