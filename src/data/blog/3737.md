...
pubDatetime: 2014-09-02 10:04:00
description: "遇到sudo执行/usr/local/bin程序时提示“command not found”，需确保bin目录在PATH环境变量中。检查或编辑您的.bashrc或.bash_profile文件，添加`export PATH=$PATH:/usr/local/bin`以永久解决此问题。"
tags: ["PATH", "Linux有问必答", "Linux"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201409/02/100251qzxgd0mmdmmm526e.jpg)
