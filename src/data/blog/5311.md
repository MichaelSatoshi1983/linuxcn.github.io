...
pubDatetime: 2015-04-20 15:02:00
description: "Shell脚本是文本文件，集成命令完成系统管理任务。在Linux中，/bin/bash为默认登录shell，通过chsh命令可更改指定用户登录shell。脚本中使用字符串、数字、布尔值等变量类型。"
tags: []
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201504/20/150204htfznh8zzw3alua8.jpg)
