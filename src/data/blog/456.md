...
pubDatetime: 2012-04-09 14:57:00
description: "在安装Ubuntu前，备份数据，精确磁盘布局，验证兼容性，确保高效顺利的初始化体验。"
tags: ["安装", "Ubuntu", "备份", "数据", "磁盘"]
---
...
只安装Linux系统  
![分区方案1](https://linuxcn.img.undefined.today/data/attachment/album/201204/09/0837186x8w88eiucxcwi2c.png "分区方案1")


只安装Linux系统，并有独立的数据存放分区  
![分区方案2](https://linuxcn.img.undefined.today/data/attachment/album/201204/09/083718lrrr5zck6kekbqdb.png "分区方案2")


linux与windows双系统共存  
![分区方案3](https://linuxcn.img.undefined.today/data/attachment/album/201204/09/083723rpu1rcywzjr3z53i.png "分区方案3")


Linux于Windows双系统，并有独立的数据存放分区  
![分区方案4](https://linuxcn.img.undefined.today/data/attachment/album/201204/09/083724uq7ebqw8tqegbp6f.png "分区方案4")
...
![thinking-ubuntu](https://linuxcn.img.undefined.today/data/attachment/album/201204/09/083724qvxtr8xaq0c30j07.jpg "thinking-ubuntu")为什么选择Ubuntu？Ubuntu是众多Linux发行版中比较流行的一个，有着庞大的用户群，良好的社区支持。当然，它不是你的唯一选择，还有其他的Linux发行版也是很不错的，比如Fedora、LinuxMint、OpenSUSE和Archinux等等。。 我现在用的就是Archlinux
