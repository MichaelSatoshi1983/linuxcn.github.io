...
![](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094238qvh45pv2jtpde9td.jpg)
...
![标记已使用和未使用的对象](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094242ekey6bbskknnnk56.png)
...
![标记清除的过程](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094242w1ugomsyfm0ifvzm.png)


**删除压缩（标记整理）**：除了会删除未被引用的对象，我们还会压缩被引用的对象（未被删除的对象）。这样以来，新对象的内存分配就相对容易了，并且内存分配的效率也有了提升。


![标记整理的过程](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094242tql8ilffi2l1y18n.png)
...
![Hotspot 堆内存结构](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094243g3vz801fy8rfmfmu.png)
...
![对象分配](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094243aiyipbyzxpesoreo.png)
...
![填充伊甸区](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094243y9gyyn9p9so8ck82.png)


次要回收：在该垃圾回收过程中，所有存活和死亡的对象都会被做上标记。其中，存活对象会被移动到 S0 幸存者区。当所有存活对象都被移动到了 S0，未被引用的对象就会被删除。


![拷贝被引用的对象](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094244zx9givz9dii91fv1.png)
...
![对象年龄增长](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094244a9z9nrj7d7dd1jlo.png)
...
![额外年龄增长](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094244wj61ar47data1zmd.png)
...
![晋升](https://linuxcn.static.byte.beer/data/attachment/album/202206/22/094245vbgaa35vq0aq5sv0.png)
