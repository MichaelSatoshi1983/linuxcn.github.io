...
pubDatetime: 2017-11-17 10:10:00
description: "学习在树莓派上配置Postgres数据库，创建表，编写查询，利用pgAdmin进行可视化管理，以及从Python实现数据库交互的完整教程。"
tags: ["PostgreSQL", "树莓派"]
---
...
![How to set up a Postgres database on a Raspberry Pi](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231228w1yr2z7zlzn1y0vr.png "How to set up a Postgres database on a Raspberry Pi")
...
![installing postgres](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231229ybrcyjabbrchszyr.png "installing postgres")
...
![creating a postgres user](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231229kj9hqr0qdsh0dqzd.png "creating a postgres user")
...
![a postgres query](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231230uyhiztyhmc9tw9cc.png "a postgres query")
...
![connect your database with pgadmin](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231231ryspj0jzf25s2wh2.png "connect your database with pgadmin")
...
![ edit the postgresql configuration to allow remote connections](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231231cpl8zu71q33eosxv.png " edit the postgresql configuration to allow remote connections")


做完这些之后，在其它的电脑上打开 pgAdmin 并创建一个新的连接。这时，需要提供一个连接名，输入树莓派的 IP 地址作为主机（这可以在任务栏的 WiFi 图标上悬停鼠标找到，或者在一个终端中输入 `hostname -I` 找到）。


![a remote connection](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231232wl25zlm3dahm3n2h.png "a remote connection")
...
![viewing test data](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231233itfcdqqc7qvdv7qi.png "viewing test data")
...
![Python](https://linuxcn.img.undefined.today/data/attachment/album/201711/14/231234azhhh88heic8ezc4.png "Python")
