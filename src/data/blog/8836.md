...
pubDatetime: 2017-09-03 20:02:29
description: "体验Linux内核26年进化，从SLS 1.05窥见其发展足迹。"
tags: ["Linux", "SLS"]
---
...
![Happy anniversary, Linux: A look back at where it all began](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200233sptfve0p013twzdq.png "Happy anniversary, Linux: A look back at where it all began")
...
![Installing SLS 1.05 from the login prompt](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200234llktk4abge6qtkb4.png "Installing SLS 1.05 from the login prompt")


在 SLS 1.05 中引入的一个漂亮的功能是支持彩色的文本模式安装器。当我选择彩色模式时，安装器切换到一个带有黑色文字的亮蓝色背景，不再是我们祖祖辈辈们使用的原始的普通黑白文本。


![Color-enabled text-mode installer in SLS 1.05](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200234z1tet1604h77m1cb.png "Color-enabled text-mode installer in SLS 1.05")
...
![Creating a partition for Linux, putting an ext2 filesystem on it, and installing Linux](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200235wsn2uitws5l09s9t.png "Creating a partition for Linux, putting an ext2 filesystem on it, and installing Linux")


![First boot](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200235beiun1ufey3uanjo.png "First boot")
...
![Checking out the filesystem and available disk space](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200236cbwkwzyawhadm8y8.png "Checking out the filesystem and available disk space")


熟悉的 `/proc` 元文件系统在 Linux 1.0 就存在了，尽管对比我们今天在现代系统上看到的，它并不能提供许多信息。在 Linux 1.0， `/proc` 包含一些接口来探测类似 `meminfo` 和 `stat` 之类的基本系统状态。


![The familiar /proc meta filesystem](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200236hlqi0l2g05tl0lh1.png "The familiar /proc meta filesystem")
...
![The /etc directory](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200237b4imixd85zhri644.png "The /etc directory")
...
![The Softlanding menu shell (MESH)](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200237xuc27l10ttemjztl.png "The Softlanding menu shell (MESH)")


除了 MESH 之外，在 SLS 1.05 中还少量包含了一些全屏应用程序。你可以找到熟悉的用户工具，包括 Elm 邮件阅读器、GNU Emacs 可编程编辑器，以及古老的 Vim 编辑器。


![Elm mail reader](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200238g821lltit8m1xfr1.png "Elm mail reader")


![GNU Emacs programmable editor](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200238c9zn4ivenvhveqrs.png "GNU Emacs programmable editor")


SLS 1.05 甚至包含了一个可以让你在终端玩的俄罗斯方块版本。


![Tetris for terminals](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200239iyviailypdpvvtvr.png "Tetris for terminals")
...
![Minicom modem-dialer application](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200239l0wzqyuoyy9498z2.png "Minicom modem-dialer application")
...
![A simple nroff text document](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200240z6pnnfcxnfy6fpx0.png "A simple nroff text document")


![nroff text document output](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200241snm0mb41m7jxoxlm.png "nroff text document output")
...
![The syssetup program](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200241k0dr4h548c2444dv.png "The syssetup program")


但这是来自于 1994 年的 X windows，它仍然并没有桌面的概念。我可以从 FVWM （一个虚拟窗口管理器）或 TWM （选项卡式的窗口管理器）中选择。TWM 直观地设置提供一个功能简单的图形环境。


![TWM](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200243grmcggnmjvwj9iio.png "TWM")
...
![Shutting down](https://linuxcn.img.undefined.today/data/attachment/album/201709/03/200243e9w82pgh9n39cpza.png "Shutting down")
