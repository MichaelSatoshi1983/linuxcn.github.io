...
pubDatetime: 2019-06-15 14:50:00
description: "了解如何在Linux系统上安全高效地管理活动根分区，采用GParted工具进行智能缩放操作，提升系统性能与存储优化。"
tags: ["分区", "GParted"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/144916pbzkkixq7w7qkrbi.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145612w63zfjhpkpvtajh3.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145717o92mgqzqwejpqbmk.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145731cqt4o2uv2eu4c2rf.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145746hfux4ikk77eh7fj1.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145802zzcgd5c6555g6s55.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145852yhne6nlm2kb6ootr.jpg)


为做到这一点，按下 “Resize/Move” 按钮来重新调整分区大小。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145932aswps4mz4m4ss964.jpg)


现在，在第一个框中输入你想从这个分区中取出的大小。我将索要 “10GB”，所以，我添加 “10240MB”，并让该对话框的其余部分为默认值，然后点击 “Resize/Move” 按钮。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/145950z8dd0bjggkdgkgt8.jpg)


它将再次要求你确认重新调整分区的大小，因为你正在编辑活动的系统分区，然后点击 “Ok”。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150015rgat4lzhpotpoagb.jpg)


分区从 30GB 缩小到 20GB 已经成功。也显示 10GB 未分配的磁盘空间。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150033lwrzejyjaiee1ft4.jpg)


最后点击 “Apply” 按钮来执行下面剩余的操作。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150051vfrb7p4ssqrd5dbo.jpg)


`e2fsck` 是一个文件系统检查实用程序，自动修复文件系统中与 HDD 相关的坏扇道、I/O 错误。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150108erbbkap4zake5r0k.jpg)


`resize2fs` 程序将重新调整 ext2、ext3 或 ext4 文件系统的大小。它可以被用于扩大或缩小一个位于设备上的未挂载的文件系统。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150134u01njjw4zgnhjg3h.jpg)


`e2image` 程序将保存位于设备上的关键的 ext2、ext3 或 ext4 文件系统的元数据到一个指定文件中。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150213q97o5ddzwww4l5ei.jpg)


所有的操作完成，关闭对话框。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150231hu86ib3j0r4ii0o9.jpg)


现在，我们可以看到未分配的 “10GB” 磁盘分区。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150307xp6kpp666yzb2ybp.jpg)


重启系统来检查这一结果。


![](https://linuxcn.img.undefined.today/data/attachment/album/201906/15/150322e7gu3uvdez8urgrm.jpg)
