...
pubDatetime: 2014-07-08 09:00:00
description: "在Linux/Unix下,清除DNS缓存使用这些命令: 对于nscd: `nscd -r`；对于BIND或dnsmasq: `systemctl restart bind`或`service dnsmasq restart`。这些操作能解决频繁拨号断线导致的DNS问题。"
tags: ["DNS", "缓存", "BIND", "dnsmasq"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201407/07/224629rpjizuxq1iid8l66.png)
