...
pubDatetime: 2018-04-20 16:24:00
description: "掌握这13个Git技巧，显著提升版本控制能力，优化项目协作效率。"
tags: ["版本控制", "Git"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201804/20/162427h1tuyumjtud0y1zz.jpg)
...
![GitLab commit graph viewer](https://linuxcn.img.undefined.today/data/attachment/album/201804/20/162443um677p6j31bq7wmm.png "GitLab commit graph viewer")


如果你是一个专注于命令行的用户或者发现分支切换工具让人分心，那么可以从命令行获得类似的提交视图。这就是 `git log` 命令的 `--graph` 参数出现的地方：


![Repository visualized with --graph command](https://linuxcn.img.undefined.today/data/attachment/album/201804/20/162444d1110dn3bb1t1dn0.png "Repository visualized with --graph command")
