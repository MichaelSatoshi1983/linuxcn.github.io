...
pubDatetime: 2015-01-27 20:30:55
description: "启动Ubuntu桌面时加入特定参数，直接进入命令行界面，简化GUI启动，高效处理不需图形环境的任务。"
tags: ["GRUB", "GUI", "CLI", "启动"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/203101fk7ijaoj50j5gj75.jpg)


接着会进入下一屏，这里你可以修改内核启动选项。向下滚动到以“linux”开始的行，这里就是内核参数的列表。删除参数列表中的“quiet”和“splash”。在参数列表中添加“text”。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/203108s3crd6d1dp0882kx.jpg)


升级的内核选项列表看上去像这样。按下Ctrl+x继续启动。这会以详细模式启动控制台一次（LCTT译注：由于没有保存修改，所以下次重启还会进入 GUI）。


![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/203114q0g0s0s0ae9625is.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/203125gltxtruidm20l2ir.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201501/27/203132iaazlmm88axaa4dm.jpg)
