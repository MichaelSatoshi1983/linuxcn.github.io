...
pubDatetime: 2015-06-25 10:13:00
description: "此文展示shell脚本，运用rsync命令实现Linux本地至远程服务器文件/目录备份，交互过程需输入远程主机及其路径。采用现有文件列表备份选定项，自动化密码输入（SSH密钥验证），简化备份操作，实例备份指定文件夹。"
tags: ["备份", "脚本", "rsync", "expect"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201506/25/101502qmc0s2og00rm20q0.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/25/101538i78tldd3pclt7l5p.png)
