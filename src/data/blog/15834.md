...
pubDatetime: 2023-05-22 11:00:00
description: "掌握在Ubuntu中精准安装Qemu方法，搭建虚拟环境，配置Linux镜像，全面提升系统部署与实验效率。"
tags: ["Qemu"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/105942liixku1fx7uufgi1.jpg)
...
![检查该计算机是否支持基于硬件的虚拟化](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110025q7mqi6kl89zwrmy6.png)
...
![检查 Linux 中系统的核心总数和线程数](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110025ecux6lmju7za66r0.png)
...
![从系统菜单中启动 Qemu](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110025rbuyqablqnai6baa.png)


接下来，点击 “<ruby> 文件 <rt>  File </rt></ruby>” 菜单，选择 “<ruby> 新建虚拟机 <rt>  New Virtual Machine </rt></ruby>” 选项：


![在 Qemu 中创建新的虚拟机](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110026u37a7c373703i3c7.png)


从这里，选择第一个选项 “<ruby> 本地安装介质 <rt>  Local install media </rt></ruby>”，这将允许你从文件管理器中选择 ISO：


![选择本地 ISO 文件以在 Qemu 中创建新的虚拟机](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110026vdglgson2dsx2xdi.png)
...
![在 Qemu 中导入 ISO 文件](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110026gq6qfqm8u9anhydl.png)
...
![解决 Qemu 中未检测到 ISO 的问题](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110027xbpp8wehdyopgdhw.png)


接下来，你将被要求根据你的需要分配内存和存储。我建议桌面版至少要有 2 个核心、4GB 内存和 25GB 的存储空间：


![在 Qemu 中为虚拟机分配内存、内核和存储空间](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110027tlq7707wq757qnyq.png)
...
![在 Qemu 中命名你的虚拟机](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110028fwkkikkvswnrddn0.png)
...
![打开 Qemu 中虚拟机的设置](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110028n8bh8d8b7jgzhod8.png)


现在，点击 “<ruby> 信息 <rt>  Info </rt></ruby>” 按钮，选择 “<ruby> 内存 <rt>  Memory </rt></ruby>” 并启用共享内存：


![在 Qemu 中启用共享内存](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110029jbz3kgwgkgxhfhoh.png)
...
![在 Qemu 中创建共享文件夹](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110029fboooea9ghowoerr.png)
...
![在 Qemu 中挂载共享文件夹](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110029erof5y7xzwc55xxj.png)
...
![使 Qemu 中的共享文件夹永久化](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110030b2cc367b8h3ws3ha.png)
...
![在 Qemu 中使用共享文件夹](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110030r4x9w7bg7abwfvcc.gif)
...
![Qemu 中的自动调整大小](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110030kadoszs96a9lw9w1.gif)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202305/22/110308h81q5sc5f50c4ecf.png)
