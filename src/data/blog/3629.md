...
pubDatetime: 2014-08-18 13:50:00
description: "用git下载Linux-stable源码，执行cd Linux-stable<版本号>，或下载压缩包后cd<版本号>。复制发行版配置文件到当前目录，修改新配置根据需要增添功能，生成内核并安装。确保系统稳定性与兼容性。"
tags: ["内核", "调试", "Debug"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201408/13/004057sc3n1gf5if5431iq.png)
