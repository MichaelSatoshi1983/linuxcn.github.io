...
pubDatetime: 2014-08-26 10:41:00
description: "修复'C++编译错误：未找到jsoncpp/json/json.h'，缺失JsonCpp开发文件(库及头文件)。JsonCpp是C++ JSON数据复制库。安装方法视Linux发行版而异。"
tags: ["错误", "修复", "Linux", "有问必答"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201408/26/104057xq3yfhfc0lwhfay8.jpg)
