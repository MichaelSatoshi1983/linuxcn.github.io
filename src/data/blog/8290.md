...
![](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/172808pim5iueyqwa5egww.jpg)
...
![地基](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173034wv1qodoavs7v11q1.jpg)
...
![一层（地面层）](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173228e3ehznhh5wzuwnhk.jpg)
...
![进程表](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173346wq87xgqp8kzk1up7.jpg)
...
![看门狗](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173448yl694u97ihh6sl9h.jpg)


瞧瞧，垫子（进程表）两旁有两只小狗，它会监控小企鹅的状态（监控进程），当小企鹅们不听话时，它就会汪汪地叫喊起来。


![http 进程](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173557n1i1xscsxiclue5s.jpg)
...
![apache logo](https://linuxcn.static.byte.beer/data/attachment/album/201703/11/181641irppc393zm96lcbw.jpg)


向右看，我们可以看到这里仍有一扇门，门上写着 21，但是，看起来这扇门似乎年久失修，上面的门牌号都歪了，门口也没人守着。看起来这个 21 端口的 FTP 协议有点老旧了，目前用的人也比以前少了，以至于这里都没人接待了。


![无人看守的 FTP 进程](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173801cijdj9iuqdzh4v2v.jpg)
...
![SSH 守护进程](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/173855y3zutv6w2bgwfg2u.jpg)


它的身上写着 52，说明它是第 52 个小企鹅。


![到达文件系统](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174017tl49c9ca4lh9wzur.jpg)


在图片的左上角，有一个向下台阶。这个台阶是底层（地基）的文件系统中的，进程们可以通过这个台阶，到文件系统中去读取文件，进行操作。


![Cron 任务](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174114ex2yjd282wewe2dj.jpg)


在这一层中，有一个身上写着 217 的小企鹅，他正满头大汗地看着自己的手表。这只小企鹅就是定时任务（Crontab），他会时刻关注时间，查看是否要去做某个工作。


![管道](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174204sqh4o4v94cwpvoib.jpg)


在图片的中部，有两个小企鹅扛着管道（PipeLine）在行走，一只小企鹅可以把自己手上的东西通过这个管道，传递给后面的小企鹅。不过怎么看起来前面这种（男？）企鹅累得满头大汗，而后面那只（女？）企鹅似乎游刃有余——喂喂，前面那个，裤子快掉了~


![Wine](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174246utkckjcfj4efbf8z.jpg)
...
![跃层](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174350fb4ugtub22yd193d.jpg)
...
![小丑？](https://linuxcn.static.byte.beer/data/attachment/album/201703/20/174437u57e34zke23nb2e7.jpg)
