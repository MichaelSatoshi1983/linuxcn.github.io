...
pubDatetime: 2015-07-22 15:48:00
description: "Linux From Scratch (LFS) 是一种独特的Linux发行版，用户需手工从源代码构建系统。基于同名手册的LFS及其衍生版本，需在已有Linux环境中使用宿主机系统编译软件。适用于寻求深入Linux内核理解的开发者与学习者。"
tags: ["发行版", "LFS"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201507/22/151834zfjmijjuh1drjwj9.png)
