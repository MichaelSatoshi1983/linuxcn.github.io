...
pubDatetime: 2015-03-03 13:53:00
description: "优化 Linux 功能与性能，远离臃肿的 Ubuntu 软件中心。转而采用 App Grid，一款轻量级应用管理工具，精准查找、高效安装 deb 文件，为 Ubuntu 及基于 Ubuntu 的系统如 Elementary OS 提升使用体验。"
tags: ["GDebi", "Ubuntu", "Linux"]
---
