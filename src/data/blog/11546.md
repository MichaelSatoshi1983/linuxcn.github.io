...
![](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001349rbbbswpeqnnteeee.jpg)
...
![Pipeline example](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/000903hxn0ngte5s3nsxir.jpg "Pipeline example")
...
![Final Result](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/000914a8gz1mxm4xt81tir.jpg "Final Result")
...
![Download Jenkins as Java WAR file](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/000930yi1pjh9ay7z9pj77.jpg "Download Jenkins as Java WAR file")
...
![Execute as an executable JAR binary](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001009d95m2m7a5l71a7mt.jpg "Execute as an executable JAR binary")
...
![Create New Job](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001016soymzmw6ijmlwlky.jpg "Create New Job")
...
![Create New Pipeline Job](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001031wg79r7whc8a7trrc.jpg "Create New Pipeline Job")
...
![Configure to Run as Jenkins Script](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001036ecn4kagkepd4rrka.jpg "Configure to Run as Jenkins Script")


要开始构建流水线的过程，请单击 “Build Now”。如果一切正常，你将看到第一个流水线（如下面的这个）。


![Click Build Now and See Result](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001043q82ept8gztjyygt1.jpg "Click Build Now and See Result")


要查看流水线脚本构建的输出，请单击任何阶段，然后单击 “Log”。你会看到这样的消息。


![Visit sample GitHub with Jenkins get clone link](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001050tc5goho54c7ho77l.jpg "Visit sample GitHub with Jenkins get clone link")
...
![Checkout from GitHub](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001103i1r17ko1ain74ig5.jpg "Checkout from GitHub")
...
![Change to Pipeline script from SCM](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001107uee117e4cebeglcv.jpg "Change to Pipeline script from SCM")


要构建流水线，回到 “Task Overview” 页面后，单击 “Build Now” 以再次执行作业。结果与之前相同，除了多了一个称为 “Declaration: Checkout SCM” 的阶段。


![Build again and verify](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001113pbowpfs5ik6wjjjt.jpg "Build again and verify")


要查看来自 SCM 构建的流水线的输出，请单击该阶段并查看 “Log” 以检查源代码控制克隆过程的进行情况。


![Verify Checkout Procedure](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001127igezne9kn444es4e.jpg "Verify Checkout Procedure")
...
![Manage Jenkins](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001137wiytv9i9dyoy9mg8.jpg "Manage Jenkins")
...
![Global Tools Configuration](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001154kyeubgymwzgcssqz.jpg "Global Tools Configuration")
...
![See Various Options for Plugin](https://linuxcn.static.byte.beer/data/attachment/album/201911/07/001201kkihb070nr7r67qm.jpg "See Various Options for Plugin")
