...
pubDatetime: 2015-07-24 10:20:00
description: "Syncthing是一款专业级免费开源文件同步工具，直接点对点传输数据，全开源，安全私密。掌控个人数据，无需第三方存储，自定义数据分享和传输方式，信息通讯加密传输确保数据安全。"
tags: ["Syncthing", "同步", "私有云"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/101943ylllh8chmzg96blj.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102010y1svi2zipuenku3v.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102011bd4sd8q5rdoqe4re.png)


输入管理员的帐户名/密码。我设置的是admin/Ubuntu。你应该使用一些更复杂的密码。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102013zwzcioiboq4m4666.png)


点击Save按钮，现在，你会被要求重启Syncthing使更改生效。点击Restart。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102013qnezvdgynifpoxze.png)


刷新你的网页浏览器。你可以看到一个像下面一样的SSL警告。点击显示**我了解风险(I understand the Risks)**的按钮。接着，点击“添加例外(Add Exception)“按钮把当前页面添加进浏览器的信任列表中。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102014lraffmmj7hvqj6ib.png)


输入前面几步设置的管理员用户和密码。我设置的是**admin/ubuntu**。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102015ufeqeovhbbj23o9e.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102017hbtbzx3wu83zbux6.png)


复制这个ID，然后到另外一个系统（系统2）的网页管理界面，在右边窗格点击Add Device按钮。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102019ot3luaxkkl3jllj3.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102021kvsdc0fncyi0hnss.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102021qbnyj8utnn4ejxtj.png)


接着重启系统１的Syncthing服务使更改生效。


![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102021rq00inf16rv1vi10.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/24/102022w3ni1vwwvdd1ln6n.png)


添加系统１后，系统２网页管理界面中的控制窗口如下：


![](https://linuxcn.img.undefined.todayhttps://linuxcn.img.undefined.today/data/attachment/album/201507/24/102023e2ntn0ggsin7vsg7.png)
