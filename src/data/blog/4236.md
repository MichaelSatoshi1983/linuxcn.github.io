...
pubDatetime: 2014-11-16 21:18:48
description: "命令行，早期界面，超强大工具，控制电脑基本功能，输入指令执行任务，误解为复杂无用，实则功能强大，掌握必提升技术能力。"
tags: ["命令行", "Mac OS", "终端"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211850v1ezox8z7x1c1gm7.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211852fgybtblq6tam5kzs.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211853b4olvjv9wlucjdvv.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211855jx2fskjsf1uh5hcg.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211856ndp8r6ad5o5sq77q.png)


现在我需要通过**cd**（改变路径）命令改变路径进入到~/experiments目录中


![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211858eyajyyj7yeywomhy.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211859cqf39qn9oq9qf83q.png)


哦不！我拼错“newfile”了。这经常会碰到。让我们用两个步骤来改正它。首先，我将创建一个拼写正确的文件...（LCTT 译注：完全不必创建新文件，直接 mv 即可，相当于改名。）


![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211900d3r1fjhbih0jbhf1.png)


然后，我讲使用**mv**（移动）命令把拼写错误的就文件替换成我的新文件。通常都是这样，“**mv 旧文件 新文件**”。


![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211901p2yw7zcfjvj0w7wi.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211903gcyz7x7if06y5i6e.png)


看到了没？只有一个。然后如果我在图形界面下看下这个目录的话，也可以看到这个文件。


![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211904yrx6jkjwwlkkbjkv.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211905jl3czcaho93hcch9.png)


写下你想说的话，然后通过CTRL + X退出。在它问你是否保存的时候，当然键入"Y"。


![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211906n230kbgzp32y723a.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201411/16/211908lxz8vzlroxzr2xz2.png)
