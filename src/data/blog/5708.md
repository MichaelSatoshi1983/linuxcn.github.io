...
pubDatetime: 2015-06-29 07:59:00
description: "集成虚拟桌面和远程访问解决方案，专为云环境优化，显著提高生产力和灵活性。适用于多设备无缝连接，适合于广泛的协议和服务器/客户端实现。X2Go在Linux领域脱颖而出，提供高效、安全的远程桌面体验，整合硬件资源，降低IT成本。"
tags: ["远程桌面", "X2Go"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220901ef8j6x8v55q03k5g.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220923le1bvv1bwv1kmkia.jpg)


如果需要的话，你可以自定义其它东西（通过点击其它的标签），例如连接速度、压缩、屏幕分辨率等等。


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220925zjyufyada5gnaxeg.jpg)


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220929zqqukaaazjqksczh.jpg)


当你初始化一个远程桌面连接的时候，会要求你登录。输入你的 SSH 登录名和密码。


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220931zsc3fc55z8mmcss3.jpg)


成功登陆后，你会看到远程桌面屏幕。


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220934yzr9fm73bj9uuibg.jpg)


如果你想测试 X2Go 的无缝窗口功能，选择 "Single application" 会话类型，然后指定远处主机上可执行文件的路径。在该例子中，我选择远程 KDE 主机上的 Dolphin 文件管理器。


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220943njwwyva3bwaybh31.jpg)


你成功连接后，你会在本地桌面上看到一个远程应用窗口，而不是完整的远程桌面屏幕。


![](https://linuxcn.img.undefined.today/data/attachment/album/201506/27/220944b8bqyltzx9xd9b5y.jpg)
