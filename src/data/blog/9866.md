...
pubDatetime: 2018-07-25 23:03:47
description: "在Ubuntu中，使用sudo apt update & upgrade仅更新APT包管理器安装的应用，不自动升级所有软件。"
tags: ["升级", "apt", "topgrade"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201807/25/230348s1oov6df4113v317.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201807/25/230350warhfjyjdayfsxdp.png)


好处是如果一个任务失败，它将自动运行下一个任务并完成所有其他后续任务。最后，它将显示摘要，其中包含运行的任务数量，成功的数量和失败的数量等详细信息。


![](https://linuxcn.img.undefined.today/data/attachment/album/201807/25/230351ug4w4wldl2bdkdkk.png)
