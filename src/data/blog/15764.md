...
pubDatetime: 2023-04-29 11:18:20
description: "精湛的Linux技术，即使是资深用户也无法熟记所有命令及选项，高效工具帮助记忆与应用Linux指令。"
tags: ["Linux", "命令", "AI"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111749dhzuflynyxw8w8uu.jpg)
...
![Shell Genie AI assistent in Linux terminal](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111820uq7cbz0cji67c0zq.png)
...
![Shell Genie explain commands](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111820dsvy19qqswnkhhqi.png)
...
![An SVG animation showing pipx Installation steps](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111821k49eodkw4kaaw9k4.svg)
...
![A dependency installation to install the shell-geie properly](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111821lj0pvckj9z9bgqqg.png)
...
![The steps showing the installation of shell-genie](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111821uxbxjh6m125gj1p5.svg)
...
![Run shell-genie init commad to set up the shell-genie properly](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111822da8dzaaviqhtjuic.svg)
...
![The working of shell-genie, that will print the required command from the provided plain text description. Also propt the user to execute the same or not](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111822cfg7ctg7ctvsgkt6.svg)
...
![The explain mode in shell-genie, where it will explain the command that was asked in the form of plain english and then prompts the user to execute it or not](https://linuxcn.img.undefined.today/data/attachment/album/202304/29/111822adj88ji2midafpdk.svg)
