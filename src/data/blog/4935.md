...
pubDatetime: 2015-02-25 08:41:00
description: "禁止IPv6方法：编辑`/etc/sysctl.conf`，添加`net.ipv6.conf.all.disable_ipv6 = 1`与`net.ipv6.conf.default.disable_ipv6 = 1`。为特定网卡如`enp0s3`操作同上，保存后运行`sysctl -p`生效。"
tags: ["IPv6"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201502/24/224745fkdfeg972z7rwett.jpg)
