...
pubDatetime: 2016-11-13 17:08:25
description: "学习高效文件清理技巧：使用rm、find与globignore命令精准移除指定目录内非目标文件类型，专注于指定扩展名。"
tags: ["文件", "删除"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170813l8e9l278tqa2we2w.jpg)
...
![删除 Linux 下除了一个文件之外的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170829j9ezheet19q9e3eq.png)
...
![在 Linux 下删除除了一些文件之外的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170830kbxc2b22jgagb2bj.png)
...
![在 Linux 下删除除了 Zip 文件之外的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170830dpaham5pphf6mdk7.png)
...
![删除除了指定文件扩展的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170830vk8nfm9dp3ncobfx.png)
...
![find 命令 —— 删除 .gz 之外的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170831phk3zvvnvpnnkbkk.png)
...
![使用 find 和 xargs 命令删除文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170831jv3qgi5oz35jmum4.png)
...
![删除除了指定扩展文件的所有文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170832nhod55zzo5002lbd.png)
...
![使用 bash 变量 GLOBIGNORE 删除文件](https://linuxcn.img.undefined.today/data/attachment/album/201611/13/170832qevf33o6onytybhe.png)
