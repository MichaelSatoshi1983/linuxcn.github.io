...
pubDatetime: 2015-10-16 07:41:00
description: "Linux中挂载SSD上的btrfs文件系统，使用优化参数（如ssd、discard、noatime、compress=lzo、subvol=@），提升性能，避免不当操作，适合SSD使用。通过确认SSD支持TRIM命令，启用discard优化SSD性能，适用于自定义配置。"
tags: ["SSD", "btrfs"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201510/15/230357ybnq0nw0bjyjni9i.jpg)
