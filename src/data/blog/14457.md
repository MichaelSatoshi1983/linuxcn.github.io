...
![](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151437wdzjaetardciedt1.jpg)
...
![Glow renders the Markdown file](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151453orewek5mb757gj9w.png)
...
![Markdown display with Glow](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151454gf2ydywey0yye4wx.png)
...
![Pager view similar to the less command](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151455hads6mzdhqrm6seq.png)
...
![With -a option, Glow finds and displays all Markdown files in current directory](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151456hrf8f1mrrwyuk3mk.png)


你可以查看显示在底部的帮助选项。在这个视图中，查找选项允许你根据文件名查找文件（不是它们的内容）。


![You can search files by their name](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151457pl3w39su93y1cerz.png)
...
![You can bookmark files by stashing them with s key](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151458x565js5s6yfcg3uv.png)


<ruby> 新闻 <rt>  news </rt></ruby>标签显示更新日志和来自 Glow 开发者（们）的其他消息。


![The news tab shows messages from the developers](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151459oaza3vfxjuhaddv9.png)


当你已经找到你想找的文件，你可以通过按下回车键来查看它们。因为你在终端用户界面模式，所以你这里会有额外的键盘选项。可以通过按下 `?` 键来显示选项。


![You can view keyboard shortcuts by pressing the ? key](https://linuxcn.static.byte.beer/data/attachment/album/202204/11/151500dv6w3vig0rgui1y6.png)
