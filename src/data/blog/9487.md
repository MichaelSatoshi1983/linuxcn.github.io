...
pubDatetime: 2018-03-28 17:40:45
description: "在Linux/类Unix系统上，借助awk的BEGIN模式打印文件名，只需执行awk '{print $NF}' 命令，此命令专门用于提取并显示每个文件的最后字段，效果等同于直观显示文件名。"
tags: ["awk"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201803/28/174032agfkbbta4bsfk4tt.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201803/28/174048z2335405iy03f7ly.jpg)
