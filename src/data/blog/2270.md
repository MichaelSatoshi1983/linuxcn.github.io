...
pubDatetime: 2013-11-23 21:13:00
description: "在Linux内核中配置x86架构随机数生成器（ARCH_RANDOM），适用于AMD64系统，确保系统随机性。"
tags: ["Linux", "内核", "配置", "x86", "随机数"]
---

Linux内核拥有许多可以配置的特性，接下来我们还有许多要配置。


![](https://linuxcn.img.undefined.today/data/attachment/album/201311/18/23195846v88vko4kqqxaca.jpeg)
