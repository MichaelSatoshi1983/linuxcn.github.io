...
pubDatetime: 2015-09-21 08:23:00
description: "在RHEL 7中，通过传统工具配置系统存储，引入SSM简化管理。利用parted处理分区，展示、调整大小，有效利用磁盘空间。了解更多敬请关注下期内容。"
tags: ["RHCSA", "分区", "SSM", "LVM"]
---

在本篇文章中，我们将讨论在 RHEL 7 中如何使用传统的工具来设置和配置本地系统存储，并介绍系统存储管理器（也称为 SSM），它将极大地简化上面的任务。


![配置和加密系统存储](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222535dftss9vstvvvz9hv.png)
...
![RHEL 7 急救模式](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222536ga4rzdrd44clekut.png)
...
![创建新的分区](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222537fcm60znwl4ezbep0.png)
...
![在 Linux 中设定分区名称](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222537umuaaa11qas9cams.png)
...
![在 Linux 中格式化分区](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222538w4y4dyy4cbu66dn4.png)
...
![在 Linux 中移除分区](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222539sdyyp6axrx06rrjv.png)
...
![LVM 的基本架构](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222541fqvz6iodih5u6vzv.png)
...
![创建新分区](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222542csrwq4trr3el34ls.png)
...
![创建两个物理卷](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222543h899swmaa0eawses.png)
...
![在 Linux 中创建卷组](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222543t5a5ak905jvati7j.png)
...
![在 LVM 中创建逻辑卷](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222544d48cggn8mij969my.png)
...
![检查有关物理卷、卷组或逻辑卷的信息](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222546da31bc7eajfma367.png)
...
![查看卷的大小](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222546cuavk7dkpbzld7dd.png)
...
![移除逻辑卷和卷组](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222548i31xxwxwnpnveqq8.png)
...
![找到逻辑卷的 UUID](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222549wxmfamamqv1gaawx.png)
...
![确保逻辑卷挂载点](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/222550nyirm2umiyeu4mdy.png)
