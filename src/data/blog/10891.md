...
pubDatetime: 2019-05-24 02:00:28
description: "人工智能与开源硬件工具结合，显著提升疟疾诊断效率与准确性。"
tags: ["AI", "深度学习", "疟疾"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020031gvej75e5rmu5qkz5.png)
...
![Python and TensorFlow](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020032sbtcaoncgn495557.png "Python and TensorFlow")
...
![疟疾热图](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020032i8it8lf4q2at5wzn.png "Malaria heat map")
...
![疟原虫检测的血涂片工作流程](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020033dmm6sm1pp6wskwwm.png "Blood smear workflow for Malaria detection")
...
![A typical CNN architecture](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020034xybcrznfbfrnlnbk.png "A typical CNN architecture")
...
![Installing dependencies](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020034txfwzh2g7943l999.png "Installing dependencies")


我使用的是云上的带有一个 GPU 的基于 Debian 的操作系统，这样我能更快的运行我的模型。为了查看目录结构，我们必须使用 `sudo apt install tree` 安装 `tree` 及其依赖（如果我们没有安装的话）。


![Installing the tree dependency](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020035atuk6kb6z75xbvkk.png "Installing the tree dependency")
...
![Datasets](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020035m15h5kk31qq3zq3k.png "Datasets")
...
![Malaria cell samples](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020035vmyssdy5d1p7nadz.png "Malaria cell samples")
...
![Learning curves for basic CNN](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020036c2li4aa0drahlh44.png "Learning curves for basic CNN")
...
![深度迁移学习的想法](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020036i4u47qb3rx4444nq.png "Ideas for deep transfer learning")
...
![VGG-19 模型架构](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020037i9eizi6dia3z2zdj.png "VGG-19 Model Architecture")
...
![Learning curves for frozen pre-trained CNN](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020038jh4u1ux6lqlqblh3.png "Learning curves for frozen pre-trained CNN")
...
![Sample augmented images](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020039y00h0eg6wxfgx6gn.png "Sample augmented images")
...
![Learning curves for fine-tuned pre-trained CNN](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020039t5t818u85u41pree.png "Learning curves for fine-tuned pre-trained CNN")
...
![Model accuracy](https://linuxcn.img.undefined.today/data/attachment/album/201905/24/020039pkgzie39gevrdfgy.png "Model accuracy")
