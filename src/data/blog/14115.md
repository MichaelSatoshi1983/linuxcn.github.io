...
![](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115842tf8jjgn4ttz7nf4m.jpg)


你可能已经注意到，当你在 GNOME 菜单/活动区搜索某样东西时，它也会显示名称与搜索词相匹配的文件，以及已安装的应用。


![Search in GNOME activities shows installed applications and matching files](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115909gci9w67cqq26ldri.png)
...
![Default locations for file search](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115910u0sgbfbs8s0ea8rh.png)
...
![Accessing recent files in GNOME file manager](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115911ulqql3igjxzqmt8i.png)
...
![Search for settings application](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115912t3zv63zsd40bwnex.jpg)


从左侧边栏进入 “搜索” 选项，点击顶部的“搜索位置”选项。在弹出的窗口中，进入 “其他” 标签，点击 “+” 符号。它将打开文件浏览器，你可以添加你想要的文件夹。


![Adding a custom folder content to search](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115913squbv3f20hrr33bo.png)
...
![Disable meta folders from the search](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115913my4toywqt45qmitb.png)


如果你只想让文档下的某个文件夹的内容不出现在搜索结果中，你只需要在该文件夹中创建一个名为 `.nomedia` 的新文件。你也可以将该文件命名为 `.git`、`.trackerignore` 或 `.hg`。


![Hide specific folder from search results by creating file named .nomedia or .hg or .git](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115914j4dg9ic350mu84il.png)
...
![Clear or disable file access history in GNOME](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115916mwbwa42b7kvv0uwq.png)
...
![Disable search results for all files](https://linuxcn.static.byte.beer/data/attachment/album/202112/25/115916o1p1fsalaxwwl51a.png)
