...
pubDatetime: 2017-04-11 08:50:00
description: "bmon：Unix系统下高效文本模式网络监控与调试工具，精准抓取并展现网络统计信息，提供友好用户界面，是信道带宽监控与网速估算的可靠选择。"
tags: ["网络", "监控", "bmon"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085007w2bsis5ppqbq34u5.jpg)
...
![bmon - Linux 带宽监视](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085016jylmypmkkzqz6yyq.gif)


按 `d` 键可以查看更详细的带宽使用情况的图形化统计信息，参考下面的截图。


![bmon - Detailed Bandwidth Statistics](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085016mg9nnfqoofjfye9k.gif)


按 `Shift + ?` 可以查看快速指南。再次按 `Shift + ?` 可以退出（指南）界面。


![bmon - 快速指南](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085016ounbhapno0d6jvmd.png)
...
![bmon - 监控以太网带宽](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085017hzx63gm2ixmxtwlm.png)
...
![bmon - Ascii 输出模式](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085017df7p2gyuy32yfg8x.png)
...
![bmon - Format 输出模式](https://linuxcn.img.undefined.today/data/attachment/album/201704/11/085018fxeo2hgsigissgt2.png)
