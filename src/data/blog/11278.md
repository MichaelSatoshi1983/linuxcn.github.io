...
pubDatetime: 2019-08-28 23:50:51
description: "KeePassXC：简单高效多平台开源数据库管理工具，采用本地文件储存。"
tags: ["密码"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235054p88cqs1n088qunuv.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235055l75s737xg5skazax.png)


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235056q8s8iedfmcdqs6my.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235056xq6mror77mpbp7do.png)


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235057e8zhb568qnlboa1b.png)


KeePassXC 还提供了一个很好的密码/口令生成器，你可以选择长度和复杂度，并检查对暴力攻击的抵抗程度：


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235058yvg15aax2u9yp5a6.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235059cox1m2xjrrr1qkhl.png)


安装扩展后，必须与数据库建立连接。要执行此操作，请按扩展按钮，然后按“连接”按钮：如果数据库已打开并解锁，那么扩展程序将创建关联密钥并将其保存在数据库中，该密钥对于浏览器是唯一的，因此我建议对它适当命名：


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235059fuvn8hblq7h4zbzn.png)


当你打开 URL 字段中的登录页并且数据库是解锁的，那么这个扩展程序将为你提供与该页面关联的所有凭据：


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235100d85z8c8w5m5wm8fm.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235100ev8ram8n85r4ybxq.png)


此时，你需要以附件方式上传你的 ssh 密钥对到条目中。然后在 “SSH 代理” 选项卡中选择附件下拉列表中的私钥，此时会自动填充公钥。不要忘记选择上面的两个复选框，以便在数据库打开/解锁时将密钥添加到代理，并在数据库关闭/锁定时删除：


![](https://linuxcn.img.undefined.today/data/attachment/album/201908/28/235101nwhbfbrl9xiifuun.png)
