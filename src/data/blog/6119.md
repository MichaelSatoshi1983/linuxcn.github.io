...
pubDatetime: 2015-08-31 10:06:52
description: "在Linux/类UNIX环境下，使用while..do..done循环与read命令协同，轻松实现文件逐行读取。语法示例：`while read -r line; do COMMAND; done input.file`。确保使用IFS=选项，避免转义符和首尾空白被忽略。"
tags: ["bash"]
---
...
![Fig.01: Bash shell scripting- read file line by line demo outputs](https://linuxcn.img.undefined.today/data/attachment/album/201508/31/100655ossrheluxqrrfhrr.jpg)
