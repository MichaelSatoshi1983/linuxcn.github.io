...
pubDatetime: 2015-09-21 10:49:00
description: "学习如何在Docker容器内运行支持OData的JBoss数据虚拟化6.0.0 GA。此解决方案平台集数据提供与集成，能统一处理分散数据源，适时为应用或用户传递所需数据，快速组合转换成便捷的商业级数据模型。通过开放标准接口实现全面数据抽取、联合、集成、转换与传输功能，整合单一数据来源。"
tags: ["JBoss", "Docker"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201509/20/195208f747orti44lu4q7n.png)
