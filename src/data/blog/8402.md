...
pubDatetime: 2017-04-14 16:15:01
description: "Meld是一款面向开发者与最终用户的可视化比较及合并工具，支持双向与三向文件及目录比较，适用于版本控制项目。"
tags: ["Meld", "比较"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161435odgyqg3kmskcqcdd.jpg)
...
![Meld started](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161507znfvhtnsao6w99i6.png)
...
![Meld file comparison](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161511j2o1s5n1bs9m6ohc.png)
...
![Compare files in Meld](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161513k1g9jpba9eq2grke.png)
...
![Meld advanced file comparison](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161518kx7a5zgoo65iio2u.png)


在讨论这些变化前，这里提一下， Meld 的界面中有几个区域，可以给出文件之间的差异，让概况变得直观。这里特别需要注意窗口的左右两边垂直的栏。比如下面这个截图：


![Visual Comparison](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161518hrv4hhk67y41s1z4.png)
...
![File changes visualized in Meld](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161521tama9fm53tyrm207.png)


![Meld Example 2](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161524mkg2mi2lk2s5hsis.png)


![Meld Example 3](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161528zny1rhihn212dhba.png)


接着，我们滑动文件，从一个改动跳到另一个。但是，当要比较的文件很大时，这会耗一点时间，当你想要滑动文件跳到一个改动的位置时，也会变得很困难。如果是这种情况的话，你可以用工具栏的橙色箭头，就在编辑区域的上方：


![Go to next change in Meld](https://linuxcn.img.undefined.today/data/attachment/album/201704/14/161530ehbmukhvhvlmlp9x.png)
