...
![How to set up a personal web server with a Raspberry Pi](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204010zy1j8yjjz30pv70v.png "How to set up a personal web server with a Raspberry Pi")
...
![Building your own web server with Raspberry Pi](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204012so6u3n67lb7ilin6.png "Building your own web server with Raspberry Pi")
...
![Pi Filler prompt](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204012phzyrqh3eqnbqw34.png "Pi Filler prompt")


确保 USB 读卡器这时还没有插上。如果已经插上了那就先弹出。点 “Continue” 继续下一步。你会看到一个让你选择文件的界面，选择你之前解压缩后的树莓派系统文件。然后你会看到另一个提示，如图所示：


![USB card reader prompt](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204013d47aa6nd8y1e7z7w.png "USB card reader")
...
![Raspberry Pi software configuration setup](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204013s38ype334yi3er3c.png "Raspberry Pi software configuration setup")
...
![Choose boot option](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204013iewsecnggt11zayy.png "Choose boot option")
...
![Raspberry Pi desktop](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204014p0fcbmfh10omfhup.png "Raspberry Pi desktop")
...
![Microsoft Remote Desktop](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204014aowhpgmvvhpnopou.png "Microsoft Remote Desktop")


点击 “New” 新建一个远程连接，在空白处填写如下配置。


![Setting up a remote connection](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204015fcjjci9jx2pr6cip.png "Setting up a remote connection")
...
![Raspberry Pi desktop](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204015wq3r020ryrqrk0mu.png "Raspberry Pi desktop")
...
![Setting up a local IP address](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204015it2dvpj7cig07pi2.png "Setting up a local IP address")
...
![Raspberry Pi desktop](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204016f1dj2m2z47da0271.png "Raspberry Pi desktop")
...
![PuTTY configuration](https://linuxcn.static.byte.beer/data/attachment/album/201705/14/204016l65kon533wpvqk5j.png "PuTTY configuration")
