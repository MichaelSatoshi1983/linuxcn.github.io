...
![](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220049aua9a6j8n110zkdz.jpg)
...
![Potfix Configurations](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220111ue0j30d2yr3y7o37.png)


随后您得选择邮件服务器名，这邮件服务器名也会被其它程序使用，所以它应该是一个完全合格域名/全称域名（FQDN）。


![Postfix Setup](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220113owntdpkwrupigriw.png)


一旦按下在 postfix 配置提示底端的 “OK”，安装进程就会用 Postfix 的默认配置来安装，并且完成 Logwatch 的整个安装。


![Logwatch Completion](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220114epcplbirbb9br797.png)
...
![Postfix Status](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220116bpd60obldlbbc5h9.png)
...
![Logwatch Report](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220117prmedmmrxgo1fdv6.png)
...
![Logwatch Cronjob](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220117n44tt4gtrssxa4lj.png)
...
![dpkg status](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220119vlell7x92w5lw6lu.png)


接下来的部分显示的日志信息是关于当前系统登录会话、rsyslogs 和当前及最近的 SSH 会话信息。


![logwatch report](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220120ivwjdv7yyiijyc9c.png)


Logwatch 报告最后显示的是安全方面的 sudo 日志及根目录磁盘使用情况，如下示：


![Logwatch end report](https://linuxcn.static.byte.beer/data/attachment/album/201508/30/220121czhyubunzqhi5u65.png)
