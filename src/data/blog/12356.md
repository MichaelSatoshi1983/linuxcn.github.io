...
pubDatetime: 2020-06-27 21:55:00
description: "Plotly是一个专业数据绘图库，提供简洁API，让你轻松构建个性化图表。"
tags: []
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/215314y0rkrz0e9zw7wd2o.jpg)
...
![A multi-bar plot made using Graph Objects](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220635m0z77gix5ng54ruj.png "A multi-bar plot made using Graph Objects")
...
![A multi-bar plot made using JSON-like data structures](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220357gzmp42az66lzfr28.png "A multi-bar plot made using JSON-like data structures")
...
![使用 Plotly Express 制作的柱状图](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220359jpuczmusc201213z.png "A multi-bar plot made using Plotly Express")
...
![Ployly 使用 JavaScript 库创建图形，由其它语言库通过 JSON 使用](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220404xa9aqqfa1zofa0ak.png "Plotly uses a JavaScript library to create plots, driven by libraries in other languages via JSON")
...
![The election plot on the web using Anvil's client-side-Python Plotly library](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220617vd9q7m2rmrx7q8dq.gif "The election plot on the web using Anvil's client-side-Python Plotly library")
...
![A multi-bar plot with custom tool-tips](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220621qazmrfcinon9pxpj.png "A multi-bar plot with custom tool-tips")
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202006/27/220325vspffby3w7wjzwjz.gif)
