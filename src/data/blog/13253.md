...
pubDatetime: 2021-03-30 23:04:00
description: "VizTracer无缝跟踪并发Python程序，高效记录、调试与剖析代码。"
tags: ["Python", "可视化"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230404xi9pox38ookk8xe2.jpg "Colorful sound wave graph")
...
![Running code in a single thread](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230415lj0240f06fg55gzn.png "Running code in a single thread")


调用堆栈报告显示，耗时约 140ms，大部分时间花在 `get_prime_arr` 上。


![call-stack report](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230415zrncqnret3c3n4cn.png "call-stack report")
...
![Multi-thread program](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230416z8c51yczar1vz404.png "Multi-thread program")


如果你熟悉 Python 的全局解释器锁（GIL），就会想到，它不会再快了。由于开销太大，花了 140ms 多一点的时间。不过，你可以观察到多线程的并发性：


![Concurrency of multiple threads](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230416b34bz4432lijolic.png "Concurrency of multiple threads")
...
![Running with extra argument](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230416lxge66sj92swi4xh.png "Running with extra argument")
...
![Multi-process version](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230417u0qcft0wdzll0txv.png "Multi-process version")
...
![I/O-bound single-thread, single-task program](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230417srr3b4uilu3rxwdh.png "I/O-bound single-thread, single-task program")
...
![I/O-bound multi-thread program](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230417njm8fmm81btmrn1p.png "I/O-bound multi-thread program")
...
![VizTracer with asyncio](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230417x7c9czc6cchw37c6.png "VizTracer with asyncio")
...
![Using --log_async to separate tasks](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230418t09ppy9z0ugcy6go.png "Using --log_async to separate tasks")


现在，用户任务更加清晰了。在大部分时间里，没有任务在运行（因为它唯一做的事情就是睡觉）。有趣的部分是这里：


![Graph of task creation and execution](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230418ittkkcr6dfzrqrkk.png "Graph of task creation and execution")
...
![time.sleep call](https://linuxcn.img.undefined.today/data/attachment/album/202103/30/230418xbg4kzw9ccayayab.png "time.sleep call")
