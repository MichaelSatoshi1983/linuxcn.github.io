...
![](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232158l3slzxx33kezcc5x.jpg)


在本系列的前两篇文章中，我们[开始使用 Git](/article-9319-1.html)，学会如何[克隆项目，修改、增加和删除内容](/article-9517-1.html)。在这第三篇文章中，我将介绍 Git 分支，为何以及如何使用分支。


![树枝](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232258bokj2oqrqh5ior0i.jpg "tree branches")
...
![终端输出](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232259fulowhuxc3vmyuyv.png "Terminal output")
...
![终端输出](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232307zypoojs93o2zjgt9.png "Terminal output")
...
![Gitk 输出](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232308luoexoj2j3lo22l3.png "Gitk output")
...
![终端输出](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232318mp3a74p35nnl9ztt.png "Terminal output")
...
![终端输出](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232321zg9070fg08c9cnft.png "Terminal output")


当你访问 GitHub 时，在分支选择的下拉列表中可以发现两个可供选择的分支。


![GitHub](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232339fb7lfez7jnkzbele.png "GitHub")


点击 `myBranch` 切换到 `myBranch` 分支，你可以看到在此分支上新增的文件。


![GitHub](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232350w3c7phg2cswcbvs7.png "GitHub")
...
![](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232356sfpovd4o9cjjnsps.png)
...
![Terminal output](https://linuxcn.static.byte.beer/data/attachment/album/201806/07/232357g7s9vioukdh729k2.png "Terminal output")
