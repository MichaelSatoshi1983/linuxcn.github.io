...
pubDatetime: 2022-07-12 12:05:36
description: "掌握将多个C目标文件整合成单一可执行文件，通过静态链接库实现高效代码重用与管理。"
tags: ["编译", "静态链接"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202207/12/120441y0q5a5abfyjyy7ug.jpg)
