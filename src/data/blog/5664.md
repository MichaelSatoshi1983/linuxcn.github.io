...
![](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075824msdd31c1gfgs5tls.png)
...
![Starting Redis Server](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075838ysbolgbkodhzslbj.png)
...
![Starting Ntopng](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075839c7bwzll129blwb44.png)
...
![Ntop Login page](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075840ku9ne4fxtuzufuv4.png)


仪表盘相当简洁。当你登入后，你将看到关于最高流量通信者页面。


![Ntopng Flow Talker](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075840dsxvksg6ipkv6igv.png)


如果你点击右侧顶部的**流量菜单**，ntopng将会显示活动流量的更多细节。


![Ntopng Flows](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075841ghzddw978uhtg3uz.png)


在**主机菜单**上，你可以看到连接到流的所有主机。


![Ntopng Hosts List](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075841m8l8h3738khy73pk.png)


如果你点击**主机 > 交互**，ntop将显示一个漂亮的主机间的交互信息图表。


![Ntopng Hosts Interaction](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075842nsgnffltsrrzcioi.png)
...
![Ntopng Hosts](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075843j1cd8c4819w989rd.png)


#### 顶级应用协议


![Ntopng Apps](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075843a9qzb2b4lu4zjp0u.png)


**界面菜单**将引领你进入更多内部菜单。包菜单将给你显示包的大小分布。


![Ntopng packets](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075844f4qyukj42jmjkaqk.png)


**协议菜单**将为你显示使用了多少协议及其使用百分比。


![Ntopng protocol](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075845c50nc945yx425xy2.png)


![Ntopng protocols - detail](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075845lnqqc94v75xz1t27.png)


你也可以通过使用**历史活跃度菜单**查看活跃度。


![Ntopng Historical Activity](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075846okphh8wek9wpetpw.png)


![Ntopng Historical Activity detail](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075846xne0vbx0u0ulbnvt.png)


最后一项要点是，你也可以通过顶部右侧区域的**设置菜单**（齿轮图标的那一个）管理哪些用户可以访问ntopng。


![Ntopng Users](https://linuxcn.static.byte.beer/data/attachment/album/201506/20/075846izpkjksjk5ryb81d.png)
