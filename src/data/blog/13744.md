...
![](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233417ryy87hyza7jmgy33.jpg "Brain on a computer screen")
...
![深度学习模型训练 loss 图](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233430j0jnjf92hfnr2iss.png "Deep learning model training plot")
...
![查看容器的运行状态](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233430nszyaz0pklym7jay.png "Checking the container's status")
...
![给镜像打上 tag](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233430h5uahx4vevfhxxjf.png "Tagging the image")
3. 使用
...
![创建一个 Kubernetes 集群](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233431qsg5vryf74zppyp7.png "Create a Kubernetes cluster")
2. 下载用于访问你的集群的 `kubeconfig`，将它放置在下载目录中，并记得设置合适的环境变量，使得你的环境能找到它：


![Kubernetes 集群示例](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233431wyjdooviaf75135f.png "Kubernetes cluster example")
3. 使用 `kubectl` 命令检查集群信息，例如，需要检查 `kube-system` 是否在你的集群正常启动了就可以使用命令 `kubectl cluster-info`


![查看集群信息](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233431u78i7ir88x485at4.png "Checking the cluster info")
...
![获取请求图像识别 API 的 IP 地址](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233431e2v0f0n0v8ffwmnv.png "Get the IP address to call your image recognition API")
7. 最后根据你的外部 IP 使用以下两张图片对你的图像识别服务进行测试：


![马](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233432r9655dyqhq666gzf.jpg "Horse")


![狗](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233432x63iiam0fy2li665.jpg "Dog")


![测试 API](https://linuxcn.static.byte.beer/data/attachment/album/202109/01/233432eiiihhililliri3i.png "Testing the API")
