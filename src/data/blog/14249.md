...
pubDatetime: 2022-02-07 11:10:39
description: "构建高效、兼容性强的CMake配置文件，让项目轻松构建、使用与贡献。"
tags: ["CMake", "构建", "VSCodium"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111033gqa36hy5hzvhjxd0.jpg "young woman working on a laptop")
...
![Searching extensions](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111041ibqjo1dibv3n7i6n.png "Searching extensions")


如果尚未完成，通过单击起始页的 “<ruby> 克隆 Git 存储库 <rt>  Clone Git Repository </rt></ruby>” 来克隆存储库。


![Clone Git repository](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111041d72a7vj6d7uz7xel.png "Clone Git repository")
...
![Select devops_1 tag](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111042u77bed5l4axy6lty.png "Select devops_1 tag")
...
![Build compiler](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111042svrzzha9wigwpehv.png "Build compiler")


要开始调试 `Producer` 可执行文件，单击调试器符号（黄色框）并从下拉菜单中选择 “<ruby> 调试 <rt>  Debug </rt></ruby> Producer”（绿色框）。


![Starting the debugger](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111042u9cqmszcc0ijnjmg.png "Starting the debugger")


如上所述，`Producer` 可执行文件要求将元素的数量作为一个命令行的参数。命令行参数可以在 `.vscode/launch.json` 中具体指定。


![Command-line arguments](https://linuxcn.img.undefined.today/data/attachment/album/202202/07/111043pv4ehvv2eq4ehe86.png "Command-line arguments")
