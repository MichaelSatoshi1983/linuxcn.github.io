...
pubDatetime: 2015-05-25 11:34:36
description: "使用inxi命令行工具一键获取Linux系统及硬件详情，适用于论坛调试。包含CPU、磁盘、Xorg、桌面环境、内核、GCC版本、进程、内存等信息。轻松安装，多数现代GNU/Linux系统软件仓库内提供。"
tags: ["inxi"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/25/113438f9lk9hf9xl32puwv.png)
