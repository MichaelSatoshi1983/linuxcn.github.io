...
pubDatetime: 2020-11-13 22:56:48
description: "VizTracer工具通过可视化和跟踪Python代码，提供深入理解代码运行机制的途径。"
tags: ["Python", "可视化"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202011/13/225531g64gdav22n6d6va9.jpg)
...
![Monte Carlo tree search visualization](https://linuxcn.img.undefined.today/data/attachment/album/202011/13/225708ar0qp1zh6qxiyh09.png "Monte Carlo tree search visualization")


每个函数都在时间线上以堆栈的形式记录和可视化，这样你就可以看到在运行程序时发生了什么。你可以放大查看任意特定点的详细信息：


![Zooming in on VizTracer visualization](https://linuxcn.img.undefined.today/data/attachment/album/202011/13/225755ccitzrirru8n7ect.png "Zooming in on VizTracer visualization")


VizTracer 还可以自动记录函数参数和返回值。你可以单击函数条目并查看详细信息：


![Viewing VizTracer details](https://linuxcn.img.undefined.today/data/attachment/album/202011/13/225756i4nzednx7en17117.png "Viewing VizTracer details")


或者你可以创建一个全新的信号，并用它来记录变量。例如，这显示了执行梯度下降时的成本值：


![VizTracer gradient descent](https://linuxcn.img.undefined.today/data/attachment/album/202011/13/225818bmmamppcsac0piv9.png "VizTracer gradient descent")
