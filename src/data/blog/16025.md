...
![](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144250ljc3zwgjt7llznxj.jpg)
...
![use cat command in Linux](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144319gwxm9geewzmgljee.png)
...
![Using cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144320ch9z023h2u09h5s3.svg)


这就好了！现在，你可以使用 `ls` 命令来显示 [当前工作目录的内容](https://itsfoss.com/list-directory-content/)：


![use the ls command to list the contents of the current working directory](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144320hy5jrl3zweldypy0.png)
...
![check the file contents using the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144320upm3vsf6gm3vw2s3.png)
...
![redirect the file content using the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144320w9ahxhru9lgrzvae.png)
...
![redirect file content of multiple files using the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144321p7radd7aizihexaa.png)
...
![redirect file content without overriding using the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144321dt6w0im6jvj4z77o.png)
...
![get the number of the lines in the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144321lc0fsffcmkiuu0ai.png)
...
![remove blank lines with the cat command](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144321nhgq81j184wqi5i5.png)
...
![remove all the blank lines in text files using the cat command piped with grep regular expression](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144322eblzl0fzq48bs888.png)
...
![save output of cat command by redirection](https://linuxcn.static.byte.beer/data/attachment/album/202307/23/144322iv8l75ms8p3pzm8j.png)
