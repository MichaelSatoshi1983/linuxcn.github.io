...
![](https://linuxcn.static.byte.beer/data/attachment/album/202108/21/104418yg111cba52caalc5.jpg "Linux keys on the keyboard for a desktop computer")
...
![Creating a boot partition](https://linuxcn.static.byte.beer/data/attachment/album/202108/21/104426refnjtym0b0mhe9h.png "Creating a boot partition")


接下来，在磁盘的其余部分创建一个 `lvm2 pv` 类型（LVM 2 物理卷）的分区（这是你的 LVM 的位置）。


![Partition layout](https://linuxcn.static.byte.beer/data/attachment/album/202108/21/104426genv9v9yy906b9do.png "Partition layout")
