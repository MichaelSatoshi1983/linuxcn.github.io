...
pubDatetime: 2015-05-22 13:00:00
description: "创建数据库重复版本，复制过程包含主节点到从节点的更改同步，支持配置为局部复制保障对象一致性。用于备份与扩展，如主节点数据丢失，可从从节点恢复数据库；大型查询优化选择备份从节点作为解决方案。"
tags: ["Mariadb", "数据库复制", "主从"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201505/22/130103gzr8t9iuus1vshw1.jpg)


### 复制的简单图解示范


![mysql 复制原理](https://linuxcn.img.undefined.today/data/attachment/album/201505/22/130107jzfatvl4uclzcytt.png)
...
![mariadb 配置主节点](https://linuxcn.img.undefined.today/data/attachment/album/201505/22/130108yld2d6hmt2iditts.png)
...
![mariadb 启用复制](https://linuxcn.img.undefined.today/data/attachment/album/201505/22/130108g8474sk8oiwymmnk.png)
