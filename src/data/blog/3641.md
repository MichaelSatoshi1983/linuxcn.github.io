...
pubDatetime: 2014-08-20 11:05:54
description: "控制计算机进程，通过CLI直接输入程序名称启动，如'dolphin'，管理文件。进程运行中终端失去命令响应，重启进程恢复CLI操作。掌握进程控制技巧，提升终端使用效率。"
tags: ["命令行", "命令行星期二"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201408/20/110555t23qq2o7ubfl9lf8.jpg)


kill的存在，不仅仅是为了终止进程，它最初是设计用来发送信号给进程。当然，有许多kill信号可以使用，根据你使用的应用程序不同而不同。请看下面的表：


![](https://linuxcn.img.undefined.today/data/attachment/album/201408/20/110558asxscxkoaenswzek.png)
