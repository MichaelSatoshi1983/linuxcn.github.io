...
pubDatetime: 2020-04-14 18:36:38
description: "Linux中的点文件是存储配置设置的隐藏文本文件，广泛应用于Bash、Git、i3及VSCode等程序。"
tags: ["点文件"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202004/14/183618dwkhe4ehx1kthxvw.jpg)
...
你可以使用这些客户端，也可以使用[通用客户端](https://www.chezmoi.io/docs/how-to/#use-a-generic-tool-to-keep-your-secrets)，也可以使用系统的[密钥环](https://www.chezmoi.io/docs/how-to/#use-a-keyring-to-keep-your-secrets)。
