...
pubDatetime: 2013-10-08 12:55:00
description: "计算机文件系统负责存储、检索和管理文件，记录文件及其相关属性，优化数据访问，确保数据安全，支持多种文件存储设备。"
tags: ["日志文件系统"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201507/30/161454dl1ulplbt7g1lcot.jpg)
