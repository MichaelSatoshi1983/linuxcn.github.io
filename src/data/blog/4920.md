...
pubDatetime: 2015-02-22 10:00:00
description: "dupeGuru，一个用Python编写的高效重复文件查找及清理工具，现已切换GPLv3许可证。一键解决多版本、复制或目录重构带来的文件拥堵问题，节省时间，优化磁盘空间。适用于Ubuntu环境，安装简便。"
tags: ["dupeGuru", "重复文件", "删除"]
---
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230553ho4kveh8weiamxgv.png)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230558msg2gyjrr992zqf9.jpg)


一旦你选择完文件夹并启动扫描后，dupeFuru会以列表的形式显示重复文件的组：


![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230600gi7hj4qn447wlzqt.jpg)


注意的是默认上dupeGuru基于文件的内容匹配，而不是他们的名字。为了防止意外地删除了重要的文件，匹配列列出了其使用的匹配算法。在这里，你可以选择你想要删除的匹配文件，并按下“Action” 按钮来看到可用的操作。


![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230605xcl25e2e7x44lxe2.jpg)


可用的选项相当广泛。简而言之，你可以删除重复、移动到另外的位置、忽略它们、打开它们、重命名它们甚至用自定义命令运行它们。如果你希望删除重复文件，你可能会像我一样非常意外竟然有这么多种删除方式。


![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230607zeerk34em96m23f6.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/201502/21/230609ig10dumv0z0fub3g.jpg)
