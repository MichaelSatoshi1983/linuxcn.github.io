...
pubDatetime: 2015-02-24 22:02:00
description: "探索15个apt-get与apt-cache命令实例，涵盖包列表与关键字搜索，高效管理Ubuntu Linux包。"
tags: ["apt", "apt-get", "apt-cache"]
---

apt-get和apt-cache是**Ubuntu Linux**中的命令行下的**包管理**工具。 apt-get的GUI版本是Synaptic包管理器。本篇中我们会展示apt-get和apt-cache命令的15个不同例子。


![](https://linuxcn.img.undefined.today/data/attachment/album/201502/24/220223sgmr8mpxopz4u44x.jpg)
