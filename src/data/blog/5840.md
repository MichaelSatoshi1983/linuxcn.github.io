...
pubDatetime: 2015-07-20 07:31:00
description: "PHP 7.0.0 beta1发布，引入显著性能提升与语言特性变革，如变量处理方式调整，采用左到右语义解析间接引用，需显式使用括号恢复原有行为。"
tags: ["PHP", "PHP 7"]
---
...
PHP 7.0.0 beta1 发布了，在带来了引人注目的性能提升的同时，也带来了不少语言特性方面的改变。以下由 LCTT 翻译自对官方的[升级备注](https://github.com/php/php-src/blob/php-7.0.0beta1/UPGRADING)，虽然目前还不是正式发布版，不过想必距离正式发布的特性已经差别不大了。（本文会持续追踪更新）
 ...
 ![](https://linuxcn.img.undefined.today/data/attachment/album/201507/18/180247oz05zwm8py7mw8zq.png)
