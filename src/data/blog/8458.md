...
pubDatetime: 2017-04-29 08:12:00
description: "使用Meld轻松比较文件，仅需稍时学习创建文件过滤器以满足个性化需求。"
tags: ["Meld", "比较"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231515nzyxjbufhebuj1kb.jpg)
...
![Compare directories using Meld](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231528qpi82ckquy5s977c.png)


选择你要比较的文件夹：


![select the directories](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231528o33klzbunoizrfrd.png)


然后单击<ruby> 比较 <rt>  Compare </rt></ruby>按钮，你会看到 Meld 像图中这样分成两栏比较目录，就像文件比较一样。


![Compare directories visually](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231531ovcpz0c00j550y8v.png)
...
Meld 默认会列出比较文件夹中的所有内容，即使这些内容没有任何不同。当然，你也可以在工具栏中单击<ruby> 相同 <rt>  Same </rt></ruby>按钮设置 Meld 不显示这些相同的文件/文件夹 —— 单击这个按钮使其不可用。
 ...
 [![same button](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231531ggxzqp3lt9f9v6qq.png)](https://www.howtoforge.com/images/beginners-guide-to-visual-merge-tool-meld-on-linux-part-3/big/meld-same-button.png) 


![Meld compare buttons](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231532j1zjx6j2x6mu416s.png)


下面是单击 <ruby> 相同 <rt>  Same </rt></ruby> 按钮使其不可用的截图：


![Directory Comparison without same files](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231535gffzmprrtyzhsrfn.png)
...
![meld compare arrow keys](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231535o9t9ge5jr525g255.png)
...
![meld copy right part](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231537a4k1d4bibwc3w340.png)
...
![Meld filters](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231538x11mw86mu7z3ydff.png)


前面提到的条目也可以通过这样的方式找到：*浏览->文件过滤*。你可以通过 *编辑->首选项->文件过滤* 为这个条目增加新元素（也可以删除已经存在的元素）。


![Meld preferences](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231542z7isshswzws2sfi2.png)
...
幸运的是，你可以关掉 Meld 的大小写敏感。只需要打开 *浏览* 菜单然后选择 <ruby> 忽略文件名大小写 <rt>  Ignore Filename Case </rt></ruby> 选项。 ![Meld ignore filename case](https://linuxcn.img.undefined.today/data/attachment/album/201704/28/231543f07f226ctyzc09e4.png)
