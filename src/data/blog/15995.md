...
pubDatetime: 2023-07-13 16:25:00
description: "在Linux终端用定制ASCII动画为特别日子增添独特魅力。"
tags: ["生日", "ASCII 艺术"]
---

![](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162413kvclclvgvhj8qqbz.jpg)
...
![](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162515r8emeo8izzeh8doo.png)


![](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162516wmqbr0a6w14c6rxr.png)
...
![arts 目录的内容，其中包含默认和用户创建的 art 文件](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162516rf0fzqdcf009hfrx.png)
...
![在配置文件中将动画设计文件更改为 "art with stars"](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162517xz2pddghuyp5yn4b.png)
...
![复制了一个现有的设计文件，并添加了一个新的文字 "Friend"](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162517so44o9hld8llrl49.png)
...
![在配置文件中更改设计文件以反映我们所做的更改](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162518g760971sqmq0zdm0.png)
...
![自定义的音乐文件被复制到克隆的目录中](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162518i64qvqqv9scy9qm5.png)


编辑 `config.py` 文件以添加新的音乐，如下面的截图所示：


![在配置文件中添加自定义音乐文件以在动画中播放](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162519eb04pfdx66zgfibb.png)
...
![程序创建的自定义可执行文件在文件管理器中显示](https://linuxcn.img.undefined.today/data/attachment/album/202307/13/162520baszqvd0mfdiqqql.png)
